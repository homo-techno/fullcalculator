...
const newImports = fs.readFileSync(path.join(__dirname, 'new-imports-batch11.txt'), 'utf8').trim();
const newRegs = fs.readFileSync(path.join(__dirname, 'new-regs-batch11.txt'), 'utf8').trim();
