...
const newImports = fs.readFileSync(path.join(__dirname, 'new-imports-batch8.txt'), 'utf8').trim();
const newRegs = fs.readFileSync(path.join(__dirname, 'new-regs-batch8.txt'), 'utf8').trim();
