...
const newImports = fs.readFileSync(path.join(__dirname, 'new-imports-batch14.txt'), 'utf8').trim();
const newRegs = fs.readFileSync(path.join(__dirname, 'new-regs-batch14.txt'), 'utf8').trim();
...
console.log('Last import:', lastImportIdx, 'Closing ]:', closingIdx);
...
console.log('Inserted', importLines.length, 'imports and registrations');
