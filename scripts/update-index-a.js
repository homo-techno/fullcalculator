...
const newImports = fs.readFileSync(path.join(__dirname, 'new-imports-a.txt'), 'utf8').trim();
const newRegs = fs.readFileSync(path.join(__dirname, 'new-regs-a.txt'), 'utf8').trim();
