...
// === BATCH 4: 50 NEW CALCULATORS ===

// GROUP A - MORTGAGE (10)

// #1 Mortgage Refinance Break-Even
add('mortgage-refinance-break-even-calculator', 'Mortgage Refinance Break-Even Calculator',
  'Calculate how many months it takes to recoup refinancing costs.',
  'Finance', 'finance', '$',
  ['mortgage refinance break even', 'refinance payback period', 'refinance calculator'],
  [
  ...
  [{ q: 'How long does it take to break even on a refinance?', a: 'It typically takes 2 to 5 years depending on the rate reduction and closing costs.' },
   { q: 'Is refinancing worth it if I plan to move soon?', a: 'If you will move before reaching the break-even point, refinancing may not save you money.' }],
  'Break-Even Months = Closing Costs / (Old Payment - New Payment)',
  ['biweekly-mortgage-payment-calculator', 'mortgage-payoff-calculator']
);

// #2 Biweekly Mortgage Payment
add('biweekly-mortgage-payment-calculator', 'Biweekly Mortgage Payment Calculator',
  'Compare biweekly versus monthly mortgage payments and see interest savings.',
  'Finance', 'finance', '$',
  ['biweekly mortgage', 'biweekly payment savings', 'mortgage biweekly calculator'],
  [
  ...
  [{ q: 'How does biweekly mortgage payment work?', a: 'You pay half your monthly payment every two weeks, resulting in 26 half-payments or 13 full payments per year instead of 12.' },
   { q: 'How much can biweekly payments save?', a: 'Biweekly payments can shave 4 to 6 years off a 30-year mortgage and save tens of thousands in interest.' }],
  'Biweekly Payment = Monthly Payment / 2; 26 payments per year vs 12',
  ['mortgage-extra-payments-calculator', 'mortgage-payoff-calculator']
);

// #3 Mortgage Extra Payments
add('mortgage-extra-payments-calculator', 'Mortgage Extra Payments Calculator',
  'See how extra monthly payments reduce your mortgage term and total interest.',
  'Finance', 'finance', '$',
  ['mortgage extra payments', 'extra payment calculator', 'pay off mortgage early'],
  [
  ...
  [{ q: 'How much do extra mortgage payments save?', a: 'Even $100 extra per month can save thousands in interest and shorten your loan by several years.' },
   { q: 'Should I make extra payments or invest?', a: 'If your mortgage rate is higher than your expected investment return after taxes, extra payments may be better.' }],
  'New Payoff = Amortize(Balance, Rate, Base Payment + Extra)',
  ['mortgage-payoff-calculator', 'biweekly-mortgage-payment-calculator']
);

// #4 Mortgage Payoff
add('mortgage-payoff-calculator', 'Mortgage Payoff Calculator',
  'Calculate your mortgage payoff timeline and total interest paid.',
  'Finance', 'finance', '$',
  ['mortgage payoff', 'payoff calculator', 'mortgage payoff date'],
  [
  ...
  [{ q: 'How do I pay off my mortgage faster?', a: 'Make extra payments toward principal, switch to biweekly payments, or refinance to a shorter term.' },
   { q: 'What happens when I pay off my mortgage?', a: 'Your lender releases the lien and you receive full ownership. You will still owe property taxes and insurance.' }],
  'Months = iterative amortization until balance reaches zero',
  ['mortgage-extra-payments-calculator', 'mortgage-refinance-break-even-calculator']
);

// #5 Mortgage DTI
add('mortgage-qualification-dti-calculator', 'Mortgage DTI Calculator',
  'Calculate your debt-to-income ratio for mortgage qualification.',
  'Finance', 'finance', '$',
  ['dti calculator', 'debt to income ratio', 'mortgage qualification'],
  [
  ...
  [{ q: 'What is a good DTI ratio for a mortgage?', a: 'Most lenders prefer a back-end DTI of 43% or lower, though some programs allow up to 50%.' },
   { q: 'What is front-end vs back-end DTI?', a: 'Front-end DTI includes only housing costs while back-end DTI includes all monthly debt obligations.' }],
  'DTI = (Monthly Debts + Housing Payment) / Gross Monthly Income x 100',
  ['mortgage-payoff-calculator', 'home-value-estimator']
);

// #6 Net Operating Income
add('net-operating-income-calculator', 'Net Operating Income Calculator',
  'Calculate net operating income for a rental investment property.',
  'Finance', 'finance', '$',
  ['net operating income', 'NOI calculator', 'rental property NOI'],
  [
  ...
  [{ q: 'What is net operating income?', a: 'NOI is the annual income from a property after subtracting vacancy losses and operating expenses, but before mortgage payments.' },
   { q: 'What is a good NOI for rental property?', a: 'A good NOI depends on the purchase price. Most investors target a cap rate (NOI divided by price) of 5% to 10%.' }],
  'NOI = (Gross Rent x 12) x (1 - Vacancy Rate) - Annual Operating Expenses',
  ['cash-on-cash-return-calculator', 'home-value-estimator']
);

// #7 Home Value Estimator
add('home-value-estimator', 'Home Value Estimator',
  'Estimate home value based on square footage, bedrooms, and local price per square foot.',
  'Finance', 'finance', '$',
  ['home value estimate', 'house value calculator', 'property value estimator'],
  [
  ...
  [{ q: 'How is home value estimated?', a: 'Home value is commonly estimated using comparable sales, price per square foot, and adjustments for features like bedrooms and bathrooms.' },
   { q: 'What increases home value the most?', a: 'Kitchen and bathroom remodels, added square footage, and energy efficiency upgrades typically offer the highest return.' }],
  'Estimated Value = (Sq Ft x Price/SqFt) + Bedroom Adj + Bathroom Adj',
  ['net-operating-income-calculator', 'homeowners-insurance-estimate-calculator']
);

// #8 Cash on Cash Return
add('cash-on-cash-return-calculator', 'Cash on Cash Return Calculator',
  'Calculate the cash-on-cash return percentage for a real estate investment.',
  'Finance', 'finance', '$',
  ['cash on cash return', 'CoCR calculator', 'real estate return'],
  [
  ...
  [{ q: 'What is a good cash-on-cash return?', a: 'Most real estate investors consider 8% to 12% a good cash-on-cash return, though this varies by market.' },
   { q: 'How is cash-on-cash return different from cap rate?', a: 'Cash-on-cash return measures return on actual cash invested while cap rate measures return on the full property value.' }],
  'Cash-on-Cash Return = Annual Net Cashflow / Total Cash Invested x 100',
  ['net-operating-income-calculator', 'home-value-estimator']
);

// #9 50/30/20 Budget
add('50-30-20-calculator', '50/30/20 Budget Calculator',
  'Split your income into needs, wants, and savings using the 50/30/20 rule.',
  'Finance', 'finance', '$',
  ['50 30 20 rule', 'budget calculator', '50 30 20 budget'],
  [
  ...
  [{ q: 'What is the 50/30/20 rule?', a: 'The 50/30/20 rule allocates 50% of after-tax income to needs, 30% to wants, and 20% to savings and debt repayment.' },
   { q: 'What counts as needs vs wants?', a: 'Needs include housing, food, utilities, and insurance. Wants include dining out, entertainment, and subscriptions.' }],
  'Needs = Income x 0.50; Wants = Income x 0.30; Savings = Income x 0.20',
  ['monthly-budget-calculator', 'mortgage-qualification-dti-calculator']
);

// #10 Monthly Budget
add('monthly-budget-calculator', 'Monthly Budget Calculator',
  'Plan your monthly budget and calculate remaining income after expenses.',
  'Finance', 'finance', '$',
  ['monthly budget', 'budget planner', 'expense calculator'],
  [
  ...
  [{ q: 'What percentage of income should go to housing?', a: 'Financial experts recommend spending no more than 28% to 30% of gross income on housing.' },
   { q: 'How much should I save each month?', a: 'Aim to save at least 20% of your after-tax income, including retirement contributions and emergency funds.' }],
  'Remaining = Income - (Housing + Transport + Food)',
  ['50-30-20-calculator', 'mortgage-qualification-dti-calculator']
);

// GROUP B - INSURANCE (10)

// #11 SR-22 Insurance Cost
add('sr22-insurance-cost-calculator', 'SR-22 Insurance Cost Calculator',
  'Estimate the cost increase for SR-22 insurance based on state and violation type.',
  'Finance', 'finance', '$',
  ['sr22 insurance cost', 'sr22 filing cost', 'sr22 premium increase'],
  [
  ...
  [{ q: 'How much does SR-22 insurance cost?', a: 'SR-22 filing itself costs $15-$50, but the associated premium increase can be 30% to 100% or more depending on the violation.' },
   { q: 'How long do you need SR-22 insurance?', a: 'Most states require SR-22 filing for 3 years, though some require it for up to 5 years.' }],
  'New Premium = Current Premium + (Current Premium x Violation Surcharge x State Multiplier)',
  ['auto-insurance-deductible-comparison-calculator', 'umbrella-insurance-coverage-calculator']
);

// #12 Medicare Part B Premium
add('medicare-part-b-premium-calculator', 'Medicare Part B Premium Calculator',
  'Calculate your Medicare Part B premium including any IRMAA surcharge based on income.',
  'Finance', 'finance', '$',
  ['medicare part b premium', 'IRMAA calculator', 'medicare cost'],
  [
  ...
  [{ q: 'What is the Medicare Part B IRMAA surcharge?', a: 'IRMAA is an extra charge added to your Part B premium if your income exceeds certain thresholds, based on your tax return from two years ago.' },
   { q: 'How can I reduce my Medicare premium?', a: 'You can file a life-changing event appeal if your income has dropped since the tax year used for the IRMAA determination.' }],
  'Monthly Premium = Base Premium ($174.70) + IRMAA Surcharge based on income bracket',
  ['medicare-part-d-coverage-gap-calculator', 'medigap-plan-comparison-calculator']
);

// #13 Medicare Part D Coverage Gap
add('medicare-part-d-coverage-gap-calculator', 'Medicare Part D Coverage Gap Calculator',
  'Estimate your Medicare Part D out-of-pocket costs including the coverage gap.',
  'Finance', 'finance', '$',
  ['medicare part d', 'donut hole calculator', 'prescription coverage gap'],
  [
  ...
  [{ q: 'What is the Medicare Part D coverage gap?', a: 'The coverage gap (donut hole) begins after you and your plan have spent a combined amount on drugs, and you pay 25% of costs until reaching the catastrophic threshold.' },
   { q: 'When does catastrophic coverage begin?', a: 'Catastrophic coverage starts after your true out-of-pocket spending reaches approximately $8,000, after which you pay minimal costs.' }],
  'Out-of-Pocket = Deductible + Copays in Initial Period + 25% in Gap + 5% in Catastrophic',
  ['medicare-part-b-premium-calculator', 'medigap-plan-comparison-calculator']
);

// #14 Medigap Plan Comparison
add('medigap-plan-comparison-calculator', 'Medigap Plan Comparison Calculator',
  'Compare costs of Medigap supplement plans F, G, and N by age and base premium.',
  'Finance', 'finance', '$',
  ['medigap comparison', 'medicare supplement plans', 'medigap cost'],
  [
  ...
  [{ q: 'Which Medigap plan is the best value?', a: 'Plan G is often the best value because it covers nearly everything Plan F does at a lower premium.' },
   { q: 'Do Medigap premiums increase with age?', a: 'Yes, most Medigap policies use attained-age pricing, meaning premiums increase as you get older.' }],
  'Monthly Premium = Base Premium x Age Adjustment x Plan Type Factor',
  ['medicare-part-b-premium-calculator', 'medicare-part-d-coverage-gap-calculator']
);

// #15 LTC Insurance Cost
add('long-term-care-insurance-cost-calculator', 'LTC Insurance Cost Calculator',
  'Estimate annual long-term care insurance premiums based on age and benefit options.',
  'Finance', 'finance', '$',
  ['long term care insurance cost', 'LTC insurance premium', 'long term care calculator'],
  [
  ...
  [{ q: 'When should I buy long-term care insurance?', a: 'The ideal age is between 50 and 65 when premiums are more affordable and you are more likely to qualify medically.' },
   { q: 'What does long-term care insurance cover?', a: 'It covers nursing home care, assisted living, home health aides, and adult day care services.' }],
  'Annual Premium = Base Rate x 12 x Age Factor x Benefit Period Factor x Inflation Factor',
  ['disability-insurance-benefit-calculator', 'medicare-part-b-premium-calculator']
);

// #16 Auto Insurance Deductible Comparison
add('auto-insurance-deductible-comparison-calculator', 'Auto Insurance Deductible Calculator',
  'Compare auto insurance deductibles and find the break-even claim frequency.',
  'Finance', 'finance', '$',
  ['auto insurance deductible', 'deductible comparison', 'insurance deductible calculator'],
  [
  ...
  [{ q: 'Should I raise my auto insurance deductible?', a: 'Raising your deductible saves on premiums but increases your cost per claim. It is best if you rarely file claims and can cover the higher deductible.' },
   { q: 'What is the most common auto insurance deductible?', a: 'The most common deductible is $500, though $1,000 deductibles are increasingly popular for the premium savings.' }],
  'Break-Even Years = (New Deductible - Current Deductible) / Annual Premium Savings',
  ['sr22-insurance-cost-calculator', 'homeowners-insurance-estimate-calculator']
);

// #17 Umbrella Insurance Coverage
add('umbrella-insurance-coverage-calculator', 'Umbrella Insurance Coverage Calculator',
  'Determine how much umbrella insurance coverage you need based on your assets and risk.',
  'Finance', 'finance', '$',
  ['umbrella insurance', 'umbrella policy calculator', 'liability coverage'],
  [
  ...
  [{ q: 'How much umbrella insurance do I need?', a: 'A common guideline is to have umbrella coverage equal to your net worth or at least 5 times your annual income.' },
   { q: 'How much does umbrella insurance cost?', a: 'Umbrella policies typically cost $150 to $300 per year for the first million in coverage.' }],
  'Recommended = max(Net Worth rounded up to nearest million, Income x 5 rounded up)',
  ['homeowners-insurance-estimate-calculator', 'auto-insurance-deductible-comparison-calculator']
);

// #18 Homeowners Insurance Estimate
add('homeowners-insurance-estimate-calculator', 'Homeowners Insurance Estimate Calculator',
  'Estimate your annual homeowners insurance premium based on home value and coverage.',
  'Finance', 'finance', '$',
  ['homeowners insurance estimate', 'home insurance cost', 'dwelling coverage calculator'],
  [
  ...
  [{ q: 'How much homeowners insurance do I need?', a: 'You should insure your dwelling for its full replacement cost, which is the cost to rebuild it, not the market value.' },
   { q: 'What affects homeowners insurance cost?', a: 'Location, home age, construction type, coverage amounts, deductible, and claims history all affect your premium.' }],
  'Annual Premium = Dwelling Coverage x Base Rate x Deductible Discount',
  ['umbrella-insurance-coverage-calculator', 'home-value-estimator']
);

// #19 Health Insurance Premium Tax Credit
add('health-insurance-premium-tax-credit-calculator', 'Health Insurance Tax Credit Calculator',
  'Estimate your ACA premium tax credit based on household size and income.',
  'Finance', 'finance', '$',
  ['ACA tax credit', 'premium tax credit', 'health insurance subsidy'],
  [
  ...
  [{ q: 'Who qualifies for ACA premium tax credits?', a: 'Households with income between 100% and 400% of the federal poverty level may qualify, though expanded subsidies may extend eligibility.' },
   { q: 'How is the premium tax credit calculated?', a: 'The credit equals the benchmark plan premium minus your expected contribution, which is a percentage of income based on your FPL level.' }],
  'Monthly Credit = Benchmark Premium - (Income x Expected Contribution % / 12)',
  ['disability-insurance-benefit-calculator', 'medicare-part-b-premium-calculator']
);

// #20 Disability Insurance Benefit
add('disability-insurance-benefit-calculator', 'Disability Insurance Benefit Calculator',
  'Calculate your monthly disability insurance benefit based on income and policy terms.',
  'Finance', 'finance', '$',
  ['disability insurance benefit', 'disability coverage', 'income replacement insurance'],
  [
  ...
  [{ q: 'How much disability insurance do I need?', a: 'Most policies replace 60% to 70% of your gross income, and you should have enough savings to cover the elimination period.' },
   { q: 'What is an elimination period?', a: 'The elimination period is the waiting time after becoming disabled before benefits begin, typically 30 to 180 days.' }],
  'Monthly Benefit = (Annual Income / 12) x Benefit Percentage',
  ['health-insurance-premium-tax-credit-calculator', 'long-term-care-insurance-cost-calculator']
);

// GROUP C - LEGAL (10)

// #21 Spousal Support Duration
add('spousal-support-duration-calculator', 'Spousal Support Duration Calculator',
  'Estimate the duration and amount of spousal support based on marriage length and income.',
  'Finance', 'finance', '$',
  ['spousal support duration', 'alimony calculator', 'spousal maintenance'],
  [
  ...
  [{ q: 'How long does spousal support last?', a: 'Duration generally depends on the length of marriage, often lasting half the number of years married for shorter marriages.' },
   { q: 'How is spousal support amount determined?', a: 'Courts typically consider the income difference between spouses, length of marriage, and each party ability to be self-supporting.' }],
  'Monthly Support = (Payer Income - Payee Income) x 30% / 12; Duration = Marriage Years x 0.5',
  ['back-pay-calculator', 'attorney-contingency-fee-calculator']
);

// #22 Time and a Half
add('time-and-a-half-calculator', 'Time and a Half Calculator',
  'Calculate overtime pay at 1.5 times your regular hourly rate.',
  'Finance', 'finance', '$',
  ['time and a half', 'overtime pay calculator', '1.5x pay'],
  [
  ...
  [{ q: 'When do I get time and a half?', a: 'Under federal law, non-exempt employees earn 1.5x their regular rate for hours worked beyond 40 in a workweek.' },
   { q: 'Is overtime pay mandatory?', a: 'Yes, the Fair Labor Standards Act requires employers to pay overtime to non-exempt employees. Some salaried positions are exempt.' }],
  'Overtime Pay = Hourly Rate x 1.5 x Overtime Hours; Total = Regular Pay + Overtime Pay',
  ['double-time-pay-calculator', 'back-pay-calculator']
);

// #23 Double Time Pay
add('double-time-pay-calculator', 'Double Time Pay Calculator',
  'Calculate double time pay for holidays or extended overtime hours.',
  'Finance', 'finance', '$',
  ['double time pay', 'holiday pay calculator', '2x pay rate'],
  [
    '{ name: "hourlyRate", label: "Regular Hourly Rate", type: "number", prefix: "$", min: 1, max: 1000, defaultValue: 25 }',
  ...
  [{ q: 'When do employees get double time?', a: 'Double time is not federally mandated but some states like California require it after 12 hours in a day or on the 7th consecutive workday.' },
   { q: 'Is holiday pay always double time?', a: 'There is no federal requirement for holiday pay. Double time on holidays is typically an employer policy or union agreement.' }],
  'Double Time Pay = Hourly Rate x 2 x Double Time Hours; Total = Regular + Double Time',
  ['time-and-a-half-calculator', 'back-pay-calculator']
);

// #24 Truck Accident Settlement
add('truck-accident-settlement-calculator', 'Truck Accident Settlement Calculator',
  'Estimate a truck accident settlement based on medical bills, lost wages, and damages.',
  'Finance', 'finance', '$',
  ['truck accident settlement', 'trucking accident compensation', 'truck crash settlement'],
  [
  ...
  [{ q: 'How much is a truck accident settlement?', a: 'Truck accident settlements are often larger than car accidents, ranging from $50,000 for minor injuries to millions for catastrophic injuries.' },
   { q: 'What makes truck accident claims different?', a: 'Truck accidents involve federal regulations, multiple liable parties, and commercial insurance policies with higher limits.' }],
  'Settlement = Medical Bills + Lost Wages + (Medical Bills x Severity Multiplier)',
  ['whiplash-settlement-calculator', 'pain-and-suffering-multiplier-calculator']
);

// #25 Whiplash Settlement
add('whiplash-settlement-calculator', 'Whiplash Settlement Calculator',
  'Estimate a whiplash injury settlement value based on treatment costs and recovery time.',
  'Finance', 'finance', '$',
  ['whiplash settlement', 'whiplash claim value', 'neck injury settlement'],
  [
  ...
  [{ q: 'How much is a whiplash settlement worth?', a: 'Whiplash settlements typically range from $10,000 to $50,000, but severe cases with long recovery can exceed $100,000.' },
   { q: 'How long does a whiplash claim take?', a: 'Most whiplash claims settle within 6 to 12 months, though complex cases may take longer if litigation is needed.' }],
  'Settlement = Medical Costs + Lost Wages + (Medical Costs x Recovery Multiplier)',
  ['pain-and-suffering-multiplier-calculator', 'truck-accident-settlement-calculator']
);

// #26 Pain and Suffering Multiplier
add('pain-and-suffering-multiplier-calculator', 'Pain and Suffering Multiplier Calculator',
  'Estimate pain and suffering damages using the multiplier method.',
  'Finance', 'finance', '$',
  ['pain and suffering multiplier', 'general damages calculator', 'non-economic damages'],
  [
  ...
  [{ q: 'What is the pain and suffering multiplier method?', a: 'The multiplier method calculates non-economic damages by multiplying total medical bills by a factor of 1.5 to 7 based on injury severity.' },
   { q: 'What multiplier do insurance companies use?', a: 'Insurance companies typically start with a 1.5 to 3x multiplier for minor injuries and may go higher for severe or permanent injuries.' }],
  'Pain and Suffering = Medical Bills x Severity Multiplier (1.5 to 7)',
  ['whiplash-settlement-calculator', 'truck-accident-settlement-calculator']
);

// #27 Attorney Contingency Fee
add('attorney-contingency-fee-calculator', 'Attorney Contingency Fee Calculator',
  'Calculate attorney fees and your net recovery under a contingency fee agreement.',
  'Finance', 'finance', '$',
  ['contingency fee calculator', 'attorney fee calculator', 'lawyer percentage fee'],
  [
  ...
  [{ q: 'What is a typical contingency fee?', a: 'Most personal injury attorneys charge 33% if settled before trial and 40% if the case goes to trial.' },
   { q: 'Are case expenses separate from the contingency fee?', a: 'Yes, case expenses like filing fees, expert witnesses, and medical records are usually deducted separately from the settlement.' }],
  'Net to Client = Settlement - (Settlement x Fee %) - Case Expenses',
  ['pain-and-suffering-multiplier-calculator', 'structured-settlement-payout-calculator']
);

// #28 Structured Settlement Payout
add('structured-settlement-payout-calculator', 'Structured Settlement Payout Calculator',
  'Calculate the present value and total payout of a structured settlement.',
  'Finance', 'finance', '$',
  ['structured settlement payout', 'annuity payout calculator', 'settlement annuity value'],
  [
  ...
  [{ q: 'What is a structured settlement?', a: 'A structured settlement pays damages over time through periodic payments instead of a single lump sum.' },
   { q: 'Can you sell a structured settlement?', a: 'Yes, you can sell future payments to a factoring company for a lump sum, but you will typically receive less than the total value.' }],
  'Present Value = Payment x (1 - (1 + r)^-n) / r; Total = Payment x n',
  ['attorney-contingency-fee-calculator', 'pain-and-suffering-multiplier-calculator']
);

// #29 Back Pay
add('back-pay-calculator', 'Back Pay Calculator',
  'Calculate back pay owed for wrongful termination or unpaid wages.',
  'Finance', 'finance', '$',
  ['back pay calculator', 'unpaid wages', 'wrongful termination pay'],
  [
  ...
  [{ q: 'What is back pay?', a: 'Back pay is compensation owed to an employee for work already performed or wages lost due to wrongful termination or pay violations.' },
   { q: 'Is back pay taxable?', a: 'Yes, back pay is subject to federal and state income taxes as well as Social Security and Medicare taxes.' }],
  'Total Back Pay = (Hourly Rate x Hours/Week x Weeks) + (Weekly Benefits x Weeks)',
  ['wage-theft-recovery-calculator', 'time-and-a-half-calculator']
);

// #30 Wage Theft Recovery
add('wage-theft-recovery-calculator', 'Wage Theft Recovery Calculator',
  'Estimate the amount recoverable in a wage theft claim including penalties.',
  'Finance', 'finance', '$',
  ['wage theft recovery', 'unpaid wages claim', 'wage theft calculator'],
  [
  ...
  [{ q: 'What is wage theft?', a: 'Wage theft includes unpaid overtime, minimum wage violations, tip theft, misclassification, and failure to pay for all hours worked.' },
   { q: 'Can I recover more than just unpaid wages?', a: 'Yes, you may recover liquidated damages (often equal to unpaid wages), interest, and attorney fees in addition to the owed wages.' }],
  'Recovery = Unpaid Wages + Liquidated Damages + Interest',
  ['back-pay-calculator', 'time-and-a-half-calculator']
);

// GROUP D - CRYPTO/FOREX (10)

// #31 Forex Position Size
add('forex-position-size-calculator', 'Forex Position Size Calculator',
  'Calculate the optimal position size for a forex trade based on risk tolerance.',
  'Finance', 'finance', '$',
  ['forex position size', 'lot size calculator', 'forex risk management'],
  [
  ...
  [{ q: 'What is a good risk per trade?', a: 'Most professional traders risk 1% to 2% of their account per trade to protect against drawdowns.' },
   { q: 'What is a standard lot in forex?', a: 'A standard lot is 100,000 units of the base currency. Mini lots are 10,000 and micro lots are 1,000 units.' }],
  'Position Size (lots) = (Account Balance x Risk %) / (Stop Loss Pips x Pip Value)',
  ['forex-pip-value-calculator', 'forex-margin-calculator']
);

// #32 Forex Pip Value
add('forex-pip-value-calculator', 'Forex Pip Value Calculator',
  'Calculate the value of a pip for any forex currency pair and position size.',
  'Finance', 'finance', '$',
  ['pip value calculator', 'forex pip calculator', 'pip worth'],
  [
  ...
  [{ q: 'What is a pip in forex?', a: 'A pip is the smallest standard price move in a currency pair, typically 0.0001 for most pairs or 0.01 for JPY pairs.' },
   { q: 'How do you calculate pip value?', a: 'Pip value equals the pip size divided by the exchange rate, multiplied by the position size in units.' }],
  'Pip Value = (Pip Size / Exchange Rate) x Position Size',
  ['forex-position-size-calculator', 'forex-profit-loss-calculator']
);

// #33 Forex Margin
add('forex-margin-calculator', 'Forex Margin Calculator',
  'Calculate the required margin for a forex position based on leverage.',
  'Finance', 'finance', '$',
  ['forex margin calculator', 'margin requirement', 'forex leverage margin'],
  [
    '{ name: "positionSize", label: "Position Size (units)", type: "number", min: 100, max: 10000000, defaultValue: 100000 }',
  ...
  [{ q: 'What is margin in forex trading?', a: 'Margin is the amount of money required in your account to open and maintain a leveraged position.' },
   { q: 'What happens if margin runs out?', a: 'If your account equity falls below the maintenance margin, you will receive a margin call and positions may be liquidated automatically.' }],
  'Required Margin = (Position Size x Exchange Rate) / Leverage',
  ['forex-position-size-calculator', 'forex-profit-loss-calculator']
);

// #34 Forex Profit/Loss
add('forex-profit-loss-calculator', 'Forex Profit Loss Calculator',
  'Calculate the profit or loss of a forex trade based on entry and exit prices.',
  'Finance', 'finance', '$',
  ['forex profit loss', 'forex P&L', 'trade profit calculator'],
  [
  ...
  [{ q: 'How is forex profit calculated?', a: 'Profit equals the price difference multiplied by the position size. For long trades, profit comes from price increases.' },
   { q: 'What is a pip worth in dollars?', a: 'For a standard lot of 100,000 units on most USD pairs, one pip is worth approximately $10.' }],
  'P/L = (Exit Price - Entry Price) x Position Size (adjusted for direction)',
  ['forex-pip-value-calculator', 'forex-position-size-calculator']
);

// #35 Forex Swap
add('forex-swap-calculator', 'Forex Swap Calculator',
  'Calculate overnight swap or rollover fees for holding a forex position.',
  'Finance', 'finance', '$',
  ['forex swap calculator', 'rollover fee', 'overnight interest forex'],
  [
    '{ name: "positionSize", label: "Position Size (units)", type: "number", min: 100, max: 10000000, defaultValue: 100000 }',
  ...
  [{ q: 'What is a forex swap?', a: 'A swap is the interest rate differential charged or credited for holding a forex position overnight, based on the two currencies interest rates.' },
   { q: 'Why is the Wednesday swap tripled?', a: 'Wednesday swaps are tripled to account for the weekend settlement period since forex trades settle two days later.' }],
  'Daily Swap = (Swap Rate x Position Size) / 100,000; Total = Daily x Nights + Wednesday Adjustments',
  ['forex-margin-calculator', 'forex-profit-loss-calculator']
);

// #36 Crypto Leverage Liquidation
add('crypto-leverage-liquidation-calculator', 'Crypto Leverage Liquidation Calculator',
  'Calculate the liquidation price for a leveraged cryptocurrency position.',
  'Finance', 'finance', '$',
  ['crypto liquidation price', 'leverage liquidation', 'margin call crypto'],
  [
  ...
  [{ q: 'What is liquidation in crypto trading?', a: 'Liquidation occurs when your margin balance can no longer support the leveraged position, and the exchange closes it automatically.' },
   { q: 'How can I avoid liquidation?', a: 'Use lower leverage, set stop-loss orders, and maintain extra margin in your account to buffer against price swings.' }],
  'Liquidation Price (Long) = Entry x (1 - 1/Leverage + Maintenance Margin)',
  ['forex-margin-calculator', 'crypto-portfolio-rebalancing-calculator']
);

// #37 Ethereum Gas Fee
add('ethereum-gas-fee-calculator', 'Ethereum Gas Fee Calculator',
  'Estimate Ethereum transaction fees based on gas limit and gas price.',
  'Finance', 'finance', '$',
  ['ethereum gas fee', 'ETH gas calculator', 'gwei to usd'],
  [
  ...
  [{ q: 'What determines Ethereum gas fees?', a: 'Gas fees depend on network congestion, transaction complexity (gas limit), and the gas price you are willing to pay in gwei.' },
   { q: 'How can I reduce gas fees?', a: 'Transact during off-peak hours, use Layer 2 solutions, or batch transactions to reduce total gas consumption.' }],
  'Fee = (Gas Limit x Gas Price in Gwei) / 1,000,000,000 x ETH Price',
  ['crypto-leverage-liquidation-calculator', 'crypto-yield-farming-apy-calculator']
);

// #38 Iron Condor
add('iron-condor-calculator', 'Iron Condor Calculator',
  'Calculate the max profit, max loss, and breakeven points for an iron condor options strategy.',
  'Finance', 'finance', '$',
  ['iron condor calculator', 'options iron condor', 'iron condor profit'],
  [
  ...
  [{ q: 'What is an iron condor?', a: 'An iron condor is an options strategy that combines a bull put spread and a bear call spread to profit from low volatility within a price range.' },
   { q: 'When is an iron condor profitable?', a: 'An iron condor is profitable when the underlying price stays between the two breakeven points at expiration.' }],
  'Max Profit = Net Credit x Contracts x 100; Max Loss = (Wing Width - Net Credit) x Contracts x 100',
  ['forex-profit-loss-calculator', 'crypto-leverage-liquidation-calculator']
);

// #39 Crypto Portfolio Rebalancing
add('crypto-portfolio-rebalancing-calculator', 'Crypto Portfolio Rebalancing Calculator',
  'Calculate the trades needed to rebalance a crypto portfolio to target allocations.',
  'Finance', 'finance', '$',
  ['crypto rebalancing', 'portfolio rebalance', 'crypto allocation'],
  [
  ...
  [{ q: 'How often should I rebalance my crypto portfolio?', a: 'Most investors rebalance monthly or quarterly, or when allocations drift more than 5% from targets.' },
   { q: 'What are the tax implications of rebalancing?', a: 'Each trade during rebalancing is a taxable event that may trigger capital gains or losses.' }],
  'Trade Needed = (Target Allocation - Current Allocation) x Total Portfolio Value',
  ['crypto-yield-farming-apy-calculator', 'crypto-leverage-liquidation-calculator']
);

// #40 Crypto Yield Farming APY
add('crypto-yield-farming-apy-calculator', 'Crypto Yield Farming APY Calculator',
  'Calculate the annual percentage yield for a crypto yield farming or staking position.',
  'Finance', 'finance', '$',
  ['yield farming APY', 'crypto staking calculator', 'DeFi APY'],
  [
  ...
  [{ q: 'What is APY in crypto yield farming?', a: 'APY (Annual Percentage Yield) reflects the total return including compound interest over one year from staking or providing liquidity.' },
   { q: 'Are high APY rates sustainable?', a: 'Extremely high APY rates are often temporary and may decrease as more capital enters the pool or token prices decline.' }],
  'APY = (1 + Daily Rate x Compound Period)^(365/Period) - 1',
  ['crypto-portfolio-rebalancing-calculator', 'crypto-leverage-liquidation-calculator']
);

// GROUP E - TAX (10)

// #41 Capital Gains Tax
add('capital-gains-tax-calculator', 'Capital Gains Tax Calculator',
  'Estimate federal capital gains tax on investment profits based on holding period and income.',
  'Finance', 'finance', '$',
  ['capital gains tax', 'investment tax calculator', 'long term capital gains'],
  [
  ...
  [{ q: 'What is the long-term capital gains tax rate?', a: 'Long-term capital gains (held over 1 year) are taxed at 0%, 15%, or 20% depending on your taxable income.' },
   { q: 'Can capital losses offset gains?', a: 'Yes, capital losses offset gains dollar for dollar, and you can deduct up to $3,000 of excess losses against ordinary income per year.' }],
  'Tax = Capital Gain x Tax Rate (based on holding period and income bracket)',
  ['estimated-tax-calculator', 'effective-tax-rate-calculator']
);

// #42 Estimated Tax
add('estimated-tax-calculator', 'Estimated Tax Calculator',
  'Calculate quarterly estimated tax payments for self-employed or investment income.',
  'Finance', 'finance', '$',
  ['estimated tax payments', 'quarterly tax calculator', 'self-employment tax'],
  [
  ...
  [{ q: 'When are estimated tax payments due?', a: 'Quarterly estimated taxes are due April 15, June 15, September 15, and January 15 of the following year.' },
   { q: 'Who needs to make estimated tax payments?', a: 'You should make estimated payments if you expect to owe $1,000 or more in tax after subtracting withholding and credits.' }],
  'Quarterly Payment = (Total Tax - Withholding) / 4',
  ['capital-gains-tax-calculator', 'marginal-tax-rate-calculator']
);

// #43 Marginal Tax Rate
add('marginal-tax-rate-calculator', 'Marginal Tax Rate Calculator',
  'Determine your marginal and effective federal income tax rate by bracket.',
  'Finance', 'finance', '$',
  ['marginal tax rate', 'tax bracket calculator', 'federal income tax rate'],
  [
  ...
  [{ q: 'What is the difference between marginal and effective tax rate?', a: 'Your marginal rate is the tax on your last dollar of income, while your effective rate is the total tax divided by total income.' },
   { q: 'How do tax brackets work?', a: 'Each bracket taxes only the income within that range. Moving into a higher bracket does not increase the rate on all your income.' }],
  'Marginal Rate = Rate of the bracket containing your last dollar of income',
  ['effective-tax-rate-calculator', 'estimated-tax-calculator']
);

// #44 Effective Tax Rate
add('effective-tax-rate-calculator', 'Effective Tax Rate Calculator',
  'Calculate your overall effective tax rate including federal, state, and FICA taxes.',
  'Finance', 'finance', '$',
  ['effective tax rate', 'total tax rate', 'all-in tax rate'],
  [
  ...
  [{ q: 'What is a good effective tax rate?', a: 'The average effective federal tax rate for most Americans is between 10% and 22%, depending on income level and deductions.' },
   { q: 'How can I lower my effective tax rate?', a: 'Maximize retirement contributions, use tax-advantaged accounts, itemize deductions, and harvest capital losses to reduce your rate.' }],
  'Effective Rate = (Federal + State + FICA) / Gross Income x 100',
  ['marginal-tax-rate-calculator', 'itemized-deduction-calculator']
);

// #45 Itemized Deduction
add('itemized-deduction-calculator', 'Itemized Deduction Calculator',
  'Compare your itemized deductions to the standard deduction to find the best option.',
  'Finance', 'finance', '$',
  ['itemized deduction calculator', 'standard vs itemized', 'tax deduction calculator'],
  [
  ...
  [{ q: 'Should I itemize or take the standard deduction?', a: 'Itemize if your total deductions exceed the standard deduction, otherwise the standard deduction gives you a larger tax benefit.' },
   { q: 'What is the SALT deduction cap?', a: 'The state and local tax deduction is capped at $10,000 ($5,000 if married filing separately) under current tax law.' }],
  'Comparison: Itemized (Mortgage + SALT + Charity) vs Standard Deduction',
  ['charitable-donation-calculator', 'effective-tax-rate-calculator']
);

// #46 Charitable Donation
add('charitable-donation-calculator', 'Charitable Donation Calculator',
  'Calculate the tax savings from charitable donations based on your tax bracket.',
  'Finance', 'finance', '$',
  ['charitable donation tax savings', 'donation deduction', 'charity tax benefit'],
  [
  ...
  [{ q: 'How much can I deduct for charitable donations?', a: 'Cash donations to qualifying charities are deductible up to 60% of your adjusted gross income, with excess carrying forward 5 years.' },
   { q: 'Do I need a receipt for charitable donations?', a: 'You need written acknowledgment from the charity for donations of $250 or more, and records for all donations you claim.' }],
  'Tax Savings = min(Donation, AGI x 60%) x Tax Bracket Rate',
  ['itemized-deduction-calculator', 'effective-tax-rate-calculator']
);

// #47 IRA Contribution
add('ira-contribution-calculator', 'IRA Contribution Calculator',
  'Calculate the tax benefit of traditional IRA contributions and compare to Roth IRA.',
  'Finance', 'finance', '$',
  ['IRA contribution calculator', 'traditional IRA tax benefit', 'IRA deduction'],
  [
  ...
  [{ q: 'What is the IRA contribution limit?', a: 'The annual IRA contribution limit is $7,000 for 2024, or $8,000 if you are age 50 or older with the catch-up contribution.' },
   { q: 'Should I choose traditional or Roth IRA?', a: 'Choose traditional if you expect a lower tax bracket in retirement. Choose Roth if you expect the same or higher bracket.' }],
  'Tax Savings = Contribution x Tax Bracket; Future Value = Contribution x (1 + Return)^Years',
  ['catch-up-contribution-calculator', 'roth-ira-income-limit-calculator']
);

// #48 Catch-Up Contribution
add('catch-up-contribution-calculator', 'Catch-Up Contribution Calculator',
  'Calculate additional retirement savings from catch-up contributions for those 50 and older.',
  'Finance', 'finance', '$',
  ['catch-up contribution', '401k catch-up', 'IRA catch-up over 50'],
  [
  ...
  [{ q: 'What are catch-up contributions?', a: 'Catch-up contributions allow workers age 50 and older to contribute extra to retirement accounts beyond the standard limit.' },
   { q: 'How much is the 401(k) catch-up contribution?', a: 'The 401(k) catch-up contribution is $7,500 for 2024, bringing the total limit to $30,500 for those 50 and older.' }],
  'Total Limit = Regular Limit + Catch-Up Amount; FV = Annual x ((1+r)^n - 1) / r',
  ['ira-contribution-calculator', 'solo-401k-calculator']
);

// #49 Solo 401(k)
add('solo-401k-calculator', 'Solo 401(k) Calculator',
  'Calculate maximum solo 401(k) contributions for self-employed individuals.',
  'Finance', 'finance', '$',
  ['solo 401k calculator', 'self employed 401k', 'individual 401k contribution'],
  [
  ...
  [{ q: 'Who can open a solo 401(k)?', a: 'Any self-employed individual with no full-time employees other than a spouse can open a solo 401(k).' },
   { q: 'What is the solo 401(k) contribution limit?', a: 'The total limit is $69,000 for 2024 ($76,500 if 50 or older), combining employee deferrals and employer profit sharing.' }],
  'Total = Employee Deferral (up to $23,000) + Employer Contribution (20-25% of income)',
  ['catch-up-contribution-calculator', 'ira-contribution-calculator']
);

// #50 Roth IRA Income Limit
add('roth-ira-income-limit-calculator', 'Roth IRA Income Limit Calculator',
  'Determine your Roth IRA contribution limit based on modified adjusted gross income.',
  'Finance', 'finance', '$',
  ['Roth IRA income limit', 'Roth IRA eligibility', 'Roth IRA phaseout'],
  [
  ...
  [{ q: 'What is the Roth IRA income limit?', a: 'For 2024, single filers phase out between $146,000 and $161,000, and married filing jointly phase out between $230,000 and $240,000.' },
   { q: 'What is a backdoor Roth IRA?', a: 'A backdoor Roth involves contributing to a traditional IRA and then converting it to a Roth, which is a strategy for high earners above the income limit.' }],
  'Contribution = Max Limit x ((Upper Threshold - MAGI) / Phaseout Range)',
  ['ira-contribution-calculator', 'catch-up-contribution-calculator']
);
...
fs.writeFileSync(path.join(__dirname, 'new-imports-batch4.txt'), imports.join('\n'));
fs.writeFileSync(path.join(__dirname, 'new-regs-batch4.txt'), regs.join('\n'));
console.log(`\nGenerated: ${generated} | Skipped: ${skipped}`);
console.log(`Total definitions: ${calcs.length}`);
console.log(`Imports saved to: scripts/new-imports-batch4.txt`);
console.log(`Registry saved to: scripts/new-regs-batch4.txt`);
