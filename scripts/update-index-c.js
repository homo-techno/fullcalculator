...
const newImports = fs.readFileSync(path.join(__dirname, 'new-imports-c.txt'), 'utf8').trim();
const newRegs = fs.readFileSync(path.join(__dirname, 'new-regs-c.txt'), 'utf8').trim();
