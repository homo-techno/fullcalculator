...
const newImports = fs.readFileSync(path.join(__dirname, 'new-imports-batch10.txt'), 'utf8').trim();
const newRegs = fs.readFileSync(path.join(__dirname, 'new-regs-batch10.txt'), 'utf8').trim();
