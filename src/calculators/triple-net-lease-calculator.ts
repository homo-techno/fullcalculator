...
export const tripleNetLeaseCalculator: CalculatorDefinition = {
  slug: "triple-net-lease-calculator",
  title: "Triple Net Lease Calculator",
  description: "Free triple net lease calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["triple net lease calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Triple Net Lease",
      description: "Calculate triple net lease",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the triple net lease calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
