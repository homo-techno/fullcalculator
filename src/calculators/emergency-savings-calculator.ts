...
export const emergencySavingsCalculator: CalculatorDefinition = {
  slug: "emergency-savings-calculator",
  title: "Emergency Savings Calculator",
  description: "Free emergency savings calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["emergency savings calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Emergency Savings",
      description: "Calculate emergency savings",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the emergency savings calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
