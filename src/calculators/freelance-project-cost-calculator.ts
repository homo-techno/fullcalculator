...
export const freelanceProjectCostCalculator: CalculatorDefinition = {
  slug: "freelance-project-cost-calculator",
  title: "Freelance Project Cost Calculator",
  description: "Free freelance project cost calculator. Quickly calculate and plan your freelance project cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["freelance project cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Freelance Project Cost",
      description: "Free freelance project cost calculator. Quickly calculate and plan your freelanc",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the freelance project cost work?",
