...
export const condoInsuranceCalculator: CalculatorDefinition = {
  slug: "condo-insurance-calculator",
  title: "Condo Insurance Calculator",
  description: "Free condo insurance calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["condo insurance calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
