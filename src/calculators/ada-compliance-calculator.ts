...
export const adaComplianceCalculator: CalculatorDefinition = {
  slug: "ada-compliance-calculator",
  title: "Ada Compliance Calculator",
  description: "Free ada compliance calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["ada compliance calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Ada Compliance",
      description: "Free ada compliance calculator. Get personalized health insights based on your p",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the ada compliance work?",
