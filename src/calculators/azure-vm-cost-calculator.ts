...
export const azureVmCostCalculator: CalculatorDefinition = {
  slug: "azure-vm-cost-calculator",
  title: "Azure Vm Cost Calculator",
  description: "Free azure vm cost calculator. Quickly calculate and plan your azure vm cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["azure vm cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Azure Vm Cost",
      description: "Free azure vm cost calculator. Quickly calculate and plan your azure vm cost nee",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the azure vm cost work?",
