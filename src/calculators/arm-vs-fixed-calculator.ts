...
export const armVsFixedCalculator: CalculatorDefinition = {
  slug: "arm-vs-fixed-calculator",
  title: "ARM vs Fixed Calculator",
  description: "Free arm vs fixed calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["arm vs fixed calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "ARM vs Fixed",
      description: "Free arm vs fixed calculator. Plan your finances with accurate calculations and ",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the ARM vs Fixed Calculator calculate?",
      answer: "This calculator helps you estimate arm vs fixed based on your specific financial situation and inputs.",
    },
    {
