...
export const dimensionalAnalysisCalculator: CalculatorDefinition = {
  slug: "dimensional-analysis-calculator",
  title: "Dimensional Analysis Calculator",
  description: "Free dimensional analysis calculator. Advanced math and computation tool.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["dimensional analysis calculator", "math calculator", "computation tool"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "What is dimensional analysis?", answer: "A mathematical concept used in computation and analysis. This calculator helps you solve related problems." },
