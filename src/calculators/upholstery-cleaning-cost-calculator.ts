...
export const upholsteryCleaningCostCalculator: CalculatorDefinition = {
  slug: "upholstery-cleaning-cost-calculator",
  title: "Upholstery Cleaning Cost Calculator",
  description: "Free upholstery cleaning cost calculator. Quickly calculate and plan your upholstery cleaning cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["upholstery cleaning cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Upholstery Cleaning Cost",
      description: "Free upholstery cleaning cost calculator. Quickly calculate and plan your uphols",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the upholstery cleaning cost work?",
