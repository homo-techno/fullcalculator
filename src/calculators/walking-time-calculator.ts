...
export const walkingTimeCalculator: CalculatorDefinition = {
  slug: "walking-time-calculator",
  title: "Walking Time Calculator",
  description: "Free walking time calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["walking time calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Walking Time",
      description: "Calculate walking time",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the walking time calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
