...
export const daysSalesOutstandingCalculator: CalculatorDefinition = {
  slug: "days-sales-outstanding-calculator",
  title: "Days Sales Outstanding Calculator",
  description: "Free days sales outstanding calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["days sales outstanding calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the days sales outstanding calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
