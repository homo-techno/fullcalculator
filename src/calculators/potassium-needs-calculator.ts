...
export const potassiumNeedsCalculator: CalculatorDefinition = {
  slug: "potassium-needs-calculator",
  title: "Potassium Needs Calculator",
  description: "Free potassium needs calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["potassium needs calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Potassium Needs",
      description: "Calculate potassium needs",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the potassium needs calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
