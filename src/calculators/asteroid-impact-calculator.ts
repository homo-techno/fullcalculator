...
export const asteroidImpactCalculator: CalculatorDefinition = {
  slug: "asteroid-impact-calculator",
  title: "Asteroid Impact Calculator",
  description: "Free asteroid impact calculator. Calculate asteroid impact values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["asteroid impact calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Asteroid Impact",
      description: "Free asteroid impact calculator. Calculate asteroid impact values for research a",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Asteroid Impact?",
      answer: "Asteroid Impact is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
