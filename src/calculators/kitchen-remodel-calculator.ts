...
export const kitchenRemodelCalculator: CalculatorDefinition = {
  slug: "kitchen-remodel-calculator",
  title: "Kitchen Remodel Calculator",
  description: "Free kitchen remodel calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["kitchen remodel calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate kitchen remodel costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does kitchen remodel cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
