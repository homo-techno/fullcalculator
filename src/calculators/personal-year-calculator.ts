...
export const personalYearCalculator: CalculatorDefinition = {
  slug: "personal-year-calculator",
  title: "Personal Year Calculator",
  description: "Free personal year calculator. Calculate your numerology personal year",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["personal year calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Personal Year",
    description: "Calculate your numerology personal year",
    fields: [
