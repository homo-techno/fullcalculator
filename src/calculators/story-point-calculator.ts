...
export const storyPointCalculator: CalculatorDefinition = {
  slug: "story-point-calculator",
  title: "Story Point Calculator",
  description: "Free story point calculator. Quickly calculate and plan your story point needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["story point calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Story Point",
  ...
  faq: [
    {
      question: "How does the story point work?",
