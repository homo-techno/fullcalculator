...
export const kidneyFunctionCalculator: CalculatorDefinition = {
  slug: "kidney-function-calculator",
  title: "Kidney Function Calculator",
  description: "Free kidney function calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["kidney function calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Kidney Function",
      description: "Free kidney function calculator. Get personalized health insights based on your ",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the kidney function work?",
