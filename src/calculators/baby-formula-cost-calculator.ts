...
export const babyFormulaCostCalculator: CalculatorDefinition = {
  slug: "baby-formula-cost-calculator",
  title: "Baby Formula Cost Calculator",
  description: "Free baby formula cost calculator. Quickly calculate and plan your baby formula cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["baby formula cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Baby Formula Cost",
      description: "Free baby formula cost calculator. Quickly calculate and plan your baby formula ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the baby formula cost work?",
