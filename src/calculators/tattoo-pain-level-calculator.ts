...
export const tattooPainLevelCalculator: CalculatorDefinition = {
  slug: "tattoo-pain-level-calculator",
  title: "Tattoo Pain Level Calculator",
  description: "Free tattoo pain level calculator. Estimate pain by body location.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo pain level calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Pain Level",
    description: "Estimate pain by body location",
    fields: [
