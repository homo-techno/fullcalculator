...
export const heatIndexExerciseCalculator: CalculatorDefinition = {
  slug: "heat-index-exercise-calculator",
  title: "Heat Index Exercise Calculator",
  description: "Free heat index exercise calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["heat index exercise calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Heat Index Exercise",
      description: "Free heat index exercise calculator. Get personalized health insights based on y",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the heat index exercise work?",
