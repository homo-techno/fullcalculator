...
export const spousalSupportCalculator: CalculatorDefinition = {
  slug: "spousal-support-calculator",
  title: "Spousal Support Calculator",
  description: "Free spousal support calculator. Estimate spousal maintenance",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["spousal support calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Spousal Support",
    description: "Estimate spousal maintenance",
    fields: [
