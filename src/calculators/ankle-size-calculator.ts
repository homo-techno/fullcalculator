...
export const ankleSizeCalculator: CalculatorDefinition = {
  slug: "ankle-size-calculator",
  title: "Ankle Size Calculator",
  description: "Free ankle size calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["ankle size calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Ankle Size",
      description: "Calculate ankle size",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the ankle size calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
