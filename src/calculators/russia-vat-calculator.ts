...
export const russiaVatCalculator: CalculatorDefinition = {
  slug: "russia-vat-calculator",
  title: "Russia VAT Calculator",
  description: "Free Russia VAT calculator at 20%. Calculate VAT amount and total price including tax.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["russia vat calculator", "russia vat calculator", "russia tax calculator"],
  variants: [{
    id: "standard",
    name: "Russia VAT",
    description: "Free Russia VAT calculator at 20%",
    fields: [
  ...
  faq: [
    { question: "What is the VAT rate in Russia?", answer: "The standard VAT rate in Russia is 20%." },
