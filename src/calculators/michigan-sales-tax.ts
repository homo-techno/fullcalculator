...
export const michiganSalesTaxCalculator: CalculatorDefinition = {
  slug: "michigan-sales-tax-calculator",
  title: "Michigan Sales Tax Calculator",
  description: "Free Michigan sales tax calculator. Calculate Michigan sales tax on any purchase with state rate of 6% plus optional local taxes.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["michigan sales tax", "michigan tax calculator", "michigan sales tax rate", "MI sales tax"],
  variants: [{
    id: "calc",
    name: "Calculate Michigan Sales Tax",
    fields: [
  ...
  faq: [
    { question: "What is the Michigan sales tax rate?", answer: "The Michigan state sales tax rate is 6%. Local jurisdictions may add additional taxes." },
  ],
  formula: "Michigan Sales Tax = Purchase Amount × (State Rate + Local Rate)",
};
