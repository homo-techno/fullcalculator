...
export const etsyProfitCalculator: CalculatorDefinition = {
  ...
  description: "Free etsy profit calculator. Calculate your Etsy selling profit after fees, shipping, and cost of goods.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["etsy profit", "etsy fees", "etsy calculator", "profit calculator"],
  variants: [
    {
      id: "standard",
      name: "Etsy Profit",
      description: "Free etsy profit calculator. Calculate your Etsy selling profit after fees, ship",
      fields: [
        {
          name: "salePrice",
          label: "Sale Price",
      ...
      calculate: (inputs) => {
        ...
        const platformFee = revenue * 0.065;
        const ccFee = revenue * 0.03 + 0.2;
  ...
  faq: [
    {
      question: "How are Etsy fees calculated?",
      answer: "Etsy charges approximately 6.5% in seller fees plus payment processing fees. The exact structure may vary.",
    },
    {
      question: "What is a good profit margin on Etsy?",
      answer: "A healthy profit margin on Etsy is typically 30-50% after all fees. Margins below 20% may not be sustainable long-term.",
    }
  ],
