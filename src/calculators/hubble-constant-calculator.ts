...
export const hubbleConstantCalculator: CalculatorDefinition = {
  slug: "hubble-constant-calculator",
  title: "Hubble Constant Calculator",
  description: "Free hubble constant calculator. Calculate hubble constant values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["hubble constant calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Hubble Constant",
      description: "Free hubble constant calculator. Calculate hubble constant values for research a",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Hubble Constant?",
      answer: "Hubble Constant is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
