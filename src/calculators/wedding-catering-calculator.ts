...
export const weddingCateringCalculator: CalculatorDefinition = {
  slug: "wedding-catering-calculator",
  title: "Wedding Catering Calculator",
  description: "Free wedding catering calculator. Quickly calculate and plan your wedding catering needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["wedding catering calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Wedding Catering",
      description: "Free wedding catering calculator. Quickly calculate and plan your wedding cateri",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the wedding catering work?",
