...
export const airPurifierSizeCalculator: CalculatorDefinition = {
  slug: "air-purifier-size-calculator",
  title: "Air Purifier Size Calculator",
  description: "Free air purifier size calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["air purifier size calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate air purifier size costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does air purifier size cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
