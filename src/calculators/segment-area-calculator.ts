...
export const segmentAreaCalculator: CalculatorDefinition = {
  slug: "segment-area-calculator",
  title: "Segment Area Calculator",
  description: "Free segment area calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["segment area calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Segment Area",
      description: "Calculate segment area",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the segment area calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
