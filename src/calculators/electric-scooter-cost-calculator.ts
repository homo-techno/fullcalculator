...
export const electricScooterCostCalculator: CalculatorDefinition = {
  slug: "electric-scooter-cost-calculator",
  title: "Electric Scooter Cost Calculator",
  description: "Free electric scooter cost calculator. Quickly calculate and plan your electric scooter cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["electric scooter cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Electric Scooter Cost",
      description: "Free electric scooter cost calculator. Quickly calculate and plan your electric ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the electric scooter cost work?",
