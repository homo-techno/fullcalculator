...
export const cryptoMiningElectricityCalculator: CalculatorDefinition = {
  slug: "crypto-mining-electricity-calculator",
  title: "Crypto Mining Electricity Calculator",
  description: "Free crypto mining electricity calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["crypto mining electricity calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Crypto Mining Electricity",
      description: "Calculate crypto mining electricity",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the crypto mining electricity calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
