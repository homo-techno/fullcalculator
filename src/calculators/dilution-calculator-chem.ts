...
export const dilutionCalculatorChemCalculator: CalculatorDefinition = {
  slug: "dilution-calculator-chem",
  title: "Dilution Calculator Chem",
  description: "Free dilution calculator chem. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["dilution calculator chem", "chemistry calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Dilution Chem",
      description: "Calculate dilution chem",
      fields: [
        {
          name: "mass",
          label: "Mass / Amount",
  ...
  faq: [
    { question: "How does the dilution calculator chem work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
