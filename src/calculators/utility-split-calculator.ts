...
export const utilitySplitCalculator: CalculatorDefinition = {
  slug: "utility-split-calculator",
  title: "Utility Split Calculator",
  description: "Free utility split calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["utility split calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Utility Split",
      description: "Calculate utility split",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    { question: "How does the utility split calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
