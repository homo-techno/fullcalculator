...
export const vpnCostCalculator: CalculatorDefinition = {
  slug: "vpn-cost-calculator",
  title: "Vpn Cost Calculator",
  description: "Free vpn cost calculator. Quickly calculate and plan your vpn cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["vpn cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Vpn Cost",
  ...
  faq: [
    {
      question: "How does the vpn cost work?",
