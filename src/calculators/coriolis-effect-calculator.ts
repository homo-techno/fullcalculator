...
export const coriolisEffectCalculator: CalculatorDefinition = {
  slug: "coriolis-effect-calculator",
  title: "Coriolis Effect Calculator",
  description: "Free coriolis effect calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["coriolis effect calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Coriolis Effect",
      description: "Calculate coriolis effect",
      fields: [
        {
          name: "v1",
          label: "Value 1",
  ...
  faq: [
    { question: "How does the coriolis effect calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
