...
export const muniBondCalculator: CalculatorDefinition = {
  slug: "muni-bond-calculator",
  title: "Muni Bond Calculator",
  description: "Free muni bond calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["muni bond calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Muni Bond",
      description: "Calculate muni bond",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the muni bond calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
