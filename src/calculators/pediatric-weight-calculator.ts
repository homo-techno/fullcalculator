...
export const pediatricWeightCalculator: CalculatorDefinition = {
  slug: "pediatric-weight-calculator",
  title: "Pediatric Weight Calculator",
  description: "Free pediatric weight calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["pediatric weight calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Pediatric Weight",
      description: "Free pediatric weight calculator. Get personalized health insights based on your",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the pediatric weight work?",
