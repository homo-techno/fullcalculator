...
export const woodGlueCalculator: CalculatorDefinition = {
  slug: "wood-glue-calculator",
  title: "Wood Glue Calculator",
  description: "Free wood glue calculator. Woodworking planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["wood glue calculator", "woodworking calculator", "carpentry tool"],
  variants: [{
    id: "standard",
    name: "Wood Glue",
