...
export const childGrowthPercentileCalculator: CalculatorDefinition = {
  slug: "child-growth-percentile-calculator",
  title: "Child Growth Percentile Calculator",
  description: "Free child growth percentile calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["child growth percentile calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Child Growth Percentile",
      description: "Free child growth percentile calculator. Get personalized health insights based ",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the child growth percentile work?",
