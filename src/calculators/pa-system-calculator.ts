...
export const paSystemCalculator: CalculatorDefinition = {
  slug: "pa-system-calculator",
  title: "PA System Calculator",
  description: "Free pa system calculator. Size a PA system for a venue",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pa system calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "PA System",
    description: "Size a PA system for a venue",
    fields: [
