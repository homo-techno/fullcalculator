...
export const leanBulkCalculator: CalculatorDefinition = {
  slug: "lean-bulk-calculator",
  title: "Lean Bulk Calculator",
  description: "Free lean bulk calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["lean bulk calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Lean Bulk",
      description: "Calculate lean bulk",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the lean bulk calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
