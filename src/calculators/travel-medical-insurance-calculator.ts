...
export const travelMedicalInsuranceCalculator: CalculatorDefinition = {
  slug: "travel-medical-insurance-calculator",
  title: "Travel Medical Insurance Calculator",
  description: "Free travel medical insurance calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["travel medical insurance calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
