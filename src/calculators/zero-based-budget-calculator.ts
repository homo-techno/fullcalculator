...
export const zeroBasedBudgetCalculator: CalculatorDefinition = {
  slug: "zero-based-budget-calculator",
  title: "Zero Based Budget Calculator",
  description: "Free zero based budget calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["zero based budget calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Zero Based Budget",
      description: "Calculate zero based budget",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the zero based budget calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
