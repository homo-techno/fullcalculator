...
export const tanklessWaterHeaterCalculator: CalculatorDefinition = {
  slug: "tankless-water-heater-calculator",
  title: "Tankless Water Heater Calculator",
  description: "Free tankless water heater calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tankless water heater calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate tankless water heater costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does tankless water heater cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
