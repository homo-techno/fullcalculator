...
export const terrariumSizeCalculator: CalculatorDefinition = {
  slug: "terrarium-size-calculator",
  title: "Terrarium Size Calculator",
  description: "Free terrarium size calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["terrarium size calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Terrarium Size",
      description: "Calculate terrarium size",
      fields: [
        {
          name: "size",
          label: "Size / Weight",
  ...
  faq: [
    { question: "How does the terrarium size calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
