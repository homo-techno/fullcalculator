...
export const pantryInventoryCalculator: CalculatorDefinition = {
  slug: "pantry-inventory-calculator",
  title: "Pantry Inventory Calculator",
  description: "Free pantry inventory calculator. Quickly calculate and plan your pantry inventory needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pantry inventory calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Pantry Inventory",
      description: "Free pantry inventory calculator. Quickly calculate and plan your pantry invento",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the pantry inventory work?",
