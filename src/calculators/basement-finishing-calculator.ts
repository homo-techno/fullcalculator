...
export const basementFinishingCalculator: CalculatorDefinition = {
  slug: "basement-finishing-calculator",
  title: "Basement Finishing Calculator",
  description: "Free basement finishing calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["basement finishing calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate basement finishing costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does basement finishing cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
