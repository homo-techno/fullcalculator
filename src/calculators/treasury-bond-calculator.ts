...
export const treasuryBondCalculator: CalculatorDefinition = {
  slug: "treasury-bond-calculator",
  title: "Treasury Bond Calculator",
  description: "Free treasury bond calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["treasury bond calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Treasury Bond",
      description: "Calculate treasury bond",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the treasury bond calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
