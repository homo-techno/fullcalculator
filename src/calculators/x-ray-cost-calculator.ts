...
export const xRayCostCalculator: CalculatorDefinition = {
  slug: "x-ray-cost-calculator",
  title: "X Ray Cost Calculator",
  description: "Free x ray cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["x ray cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "X Ray Cost",
  ...
  faq: [
    { question: "How much does x ray cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
