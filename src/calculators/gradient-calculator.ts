...
export const gradientCalculator: CalculatorDefinition = {
  slug: "gradient-calculator",
  title: "Gradient Calculator",
  description: "Free gradient calculator. Solve gradient problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["gradient calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Gradient",
  ...
  faq: [
    {
      ...
      answer: "Gradient is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
