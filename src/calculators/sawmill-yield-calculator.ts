...
export const sawmillYieldCalculator: CalculatorDefinition = {
  slug: "sawmill-yield-calculator",
  title: "Sawmill Yield Calculator",
  description: "Free sawmill yield calculator. Woodworking planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["sawmill yield calculator", "woodworking calculator", "carpentry tool"],
  variants: [{
    id: "standard",
    name: "Sawmill Yield",
