...
export const costPerWearCalculator: CalculatorDefinition = {
  slug: "cost-per-wear-calculator",
  title: "Cost Per Wear Calculator",
  description: "Free cost per wear calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cost per wear calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cost Per Wear",
      description: "Calculate cost per wear",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    { question: "How does the cost per wear calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
