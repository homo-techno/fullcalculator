...
export const concealerShadeCalculator: CalculatorDefinition = {
  slug: "concealer-shade-calculator",
  title: "Concealer Shade Calculator",
  description: "Free concealer shade calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["concealer shade calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
    name: "Concealer Shade",
    description: "",
    fields: [
  ...
  faq: [
    { question: "How much does concealer shade cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
