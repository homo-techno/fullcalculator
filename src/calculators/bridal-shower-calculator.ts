...
export const bridalShowerCalculator: CalculatorDefinition = {
  slug: "bridal-shower-calculator",
  title: "Bridal Shower Calculator",
  description: "Free bridal shower calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bridal shower calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate bridal shower costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does bridal shower cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
