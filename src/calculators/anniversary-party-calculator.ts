...
export const anniversaryPartyCalculator: CalculatorDefinition = {
  slug: "anniversary-party-calculator",
  title: "Anniversary Party Calculator",
  description: "Free anniversary party calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["anniversary party calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate anniversary party costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does anniversary party cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
