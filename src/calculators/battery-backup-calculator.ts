...
export const batteryBackupCalculator: CalculatorDefinition = {
  ...
  description: "Free battery backup calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["battery backup calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate battery backup costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does battery backup cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
