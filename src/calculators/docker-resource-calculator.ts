...
export const dockerResourceCalculator: CalculatorDefinition = {
  slug: "docker-resource-calculator",
  title: "Docker Resource Calculator",
  description: "Free docker resource calculator. Quickly calculate and plan your docker resource needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["docker resource calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Docker Resource",
      description: "Free docker resource calculator. Quickly calculate and plan your docker resource",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the docker resource work?",
