...
export const grahamsLawCalculator: CalculatorDefinition = {
  slug: "grahams-law-calculator",
  title: "Grahams Law Calculator",
  description: "Free grahams law calculator. Calculate grahams law values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["grahams law calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Grahams Law",
      description: "Free grahams law calculator. Calculate grahams law values for research and educa",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Grahams Law?",
      answer: "Grahams Law is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
