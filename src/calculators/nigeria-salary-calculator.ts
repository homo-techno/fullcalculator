...
export const nigeriaSalaryCalculator: CalculatorDefinition = {
  slug: "nigeria-salary-calculator",
  title: "Nigeria Salary Calculator",
  description: "Free Nigeria gross to net salary calculator. Calculate take-home pay after tax and social contributions.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["nigeria salary calculator", "nigeria gross to net calculator", "nigeria take home pay"],
  variants: [{
    id: "standard",
    name: "Nigeria Salary",
    description: "Free Nigeria gross to net salary calculator",
    fields: [
  ...
  faq: [
    { question: "How much tax do I pay on my salary in Nigeria?", answer: "Your total deductions include social contributions (8.0% employee share) plus progressive income tax." },
    { question: "What is the take-home pay in Nigeria?", answer: "Take-home pay = Gross salary minus social contributions minus income tax. Use this calculator for an estimate." },
  ],
