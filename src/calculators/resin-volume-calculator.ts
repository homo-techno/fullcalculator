...
export const resinVolumeCalculator: CalculatorDefinition = {
  slug: "resin-volume-calculator",
  title: "Resin Volume Calculator",
  description: "Free resin volume calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["resin volume calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
    name: "Resin Volume",
