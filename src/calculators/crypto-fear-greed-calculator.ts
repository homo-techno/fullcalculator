...
export const cryptoFearGreedCalculator: CalculatorDefinition = {
  slug: "crypto-fear-greed-calculator",
  title: "Crypto Fear Greed Calculator",
  description: "Free crypto fear greed calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["crypto fear greed calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Crypto Fear Greed",
      description: "Calculate crypto fear greed",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the crypto fear greed calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
