...
export const doubleIntegralCalculator: CalculatorDefinition = {
  slug: "double-integral-calculator",
  title: "Double Integral Calculator",
  description: "Free double integral calculator. Solve double integral problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["double integral calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Double Integral",
      description: "Free double integral calculator. Solve double integral problems with step-by-ste",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Double Integral?",
      answer: "Double Integral is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
