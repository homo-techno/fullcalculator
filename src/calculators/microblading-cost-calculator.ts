...
export const microbladingCostCalculator: CalculatorDefinition = {
  slug: "microblading-cost-calculator",
  title: "Microblading Cost Calculator",
  description: "Free microblading cost calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["microblading cost calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
    name: "Microblading Cost",
    description: "",
    fields: [
  ...
  faq: [
    { question: "How much does microblading cost cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
