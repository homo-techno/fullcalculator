...
export const horseOwnershipCostCalculator: CalculatorDefinition = {
  slug: "horse-ownership-cost-calculator",
  title: "Horse Ownership Cost Calculator",
  description: "Free horse ownership cost calculator. Quickly calculate and plan your horse ownership cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["horse ownership cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Horse Ownership Cost",
      description: "Free horse ownership cost calculator. Quickly calculate and plan your horse owne",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the horse ownership cost work?",
