...
export const megaBackdoorRothCalculator: CalculatorDefinition = {
  slug: "mega-backdoor-roth-calculator",
  title: "Mega Backdoor Roth Calculator",
  description: "Free mega backdoor roth calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["mega backdoor roth calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Mega Backdoor Roth",
      description: "Free mega backdoor roth calculator. Plan your finances with accurate calculation",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Mega Backdoor Roth Calculator calculate?",
      answer: "This calculator helps you estimate mega backdoor roth based on your specific financial situation and inputs.",
    },
    {
