...
export const sellerClosingCostCalculator: CalculatorDefinition = {
  slug: "seller-closing-cost-calculator",
  title: "Seller Closing Cost Calculator",
  description: "Free seller closing cost calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["seller closing cost calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Seller Closing Cost",
      description: "Free seller closing cost calculator. Plan your finances with accurate calculatio",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Seller Closing Cost Calculator calculate?",
      answer: "This calculator helps you estimate seller closing cost based on your specific financial situation and inputs.",
    },
    {
