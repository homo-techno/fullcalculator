...
export const differentialEquationCalculator: CalculatorDefinition = {
  slug: "differential-equation-calculator",
  title: "Differential Equation Calculator",
  description: "Free differential equation calculator. Solve differential equation problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["differential equation calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Differential Equation",
      description: "Free differential equation calculator. Solve differential equation problems with",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Differential Equation?",
      answer: "Differential Equation is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
