...
export const marineBatteryCalculator: CalculatorDefinition = {
  slug: "marine-battery-calculator",
  title: "Marine Battery Calculator",
  description: "Free marine battery calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["marine battery calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Marine Battery",
    description: "",
