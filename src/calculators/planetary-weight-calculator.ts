...
export const planetaryWeightCalculator: CalculatorDefinition = {
  slug: "planetary-weight-calculator",
  title: "Planetary Weight Calculator",
  description: "Free planetary weight calculator. Calculate planetary weight values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["planetary weight calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Planetary Weight",
      description: "Free planetary weight calculator. Calculate planetary weight values for research",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Planetary Weight?",
      answer: "Planetary Weight is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
