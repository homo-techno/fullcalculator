...
export const financialHealthScoreCalculator: CalculatorDefinition = {
  slug: "financial-health-score-calculator",
  title: "Financial Health Score Calculator",
  description: "Free financial health score calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["financial health score calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the financial health score calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
