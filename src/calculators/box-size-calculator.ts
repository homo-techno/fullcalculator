...
export const boxSizeCalculator: CalculatorDefinition = {
  slug: "box-size-calculator",
  title: "Box Size Calculator",
  description: "Free box size calculator. Quickly calculate and plan your box size needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["box size calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Box Size",
  ...
  faq: [
    {
      question: "How does the box size work?",
