...
export const tollCostCalculator: CalculatorDefinition = {
  slug: "toll-cost-calculator",
  title: "Toll Cost Calculator",
  description: "Free toll cost calculator. Quickly calculate and plan your toll cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["toll cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Toll Cost",
  ...
  faq: [
    {
      question: "How does the toll cost work?",
