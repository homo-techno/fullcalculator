...
export const cosmicMicrowaveBackgroundCalculator: CalculatorDefinition = {
  slug: "cosmic-microwave-background-calculator",
  title: "Cosmic Microwave Background Calculator",
  description: "Free cosmic microwave background calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["cosmic microwave background calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cosmic Microwave Background",
      description: "Calculate cosmic microwave background",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the cosmic microwave background calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
