...
export const campingCostCalculator: CalculatorDefinition = {
  slug: "camping-cost-calculator",
  title: "Camping Cost Calculator",
  description: "Free camping cost calculator. Quickly calculate and plan your camping cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["camping cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Camping Cost",
  ...
  faq: [
    {
      question: "How does the camping cost work?",
