...
export const lightYearCalculator: CalculatorDefinition = {
  slug: "light-year-calculator",
  title: "Light Year Calculator",
  description: "Free light year calculator. Calculate light year values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["light year calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Light Year",
      description: "Free light year calculator. Calculate light year values for research and educati",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Light Year?",
      answer: "Light Year is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
