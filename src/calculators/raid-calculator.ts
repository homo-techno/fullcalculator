...
export const raidCalculator: CalculatorDefinition = {
  slug: "raid-calculator",
  title: "Raid Calculator",
  description: "Free raid calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["raid calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Raid",
      description: "Calculate raid",
      fields: [
        {
          name: "value",
          label: "Primary Value",
  ...
  faq: [
    { question: "How does the raid calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
