...
export const reverseDietCalculator: CalculatorDefinition = {
  slug: "reverse-diet-calculator",
  title: "Reverse Diet Calculator",
  description: "Free reverse diet calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["reverse diet calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Reverse Diet",
      description: "Free reverse diet calculator. Get personalized health insights based on your pro",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the reverse diet work?",
