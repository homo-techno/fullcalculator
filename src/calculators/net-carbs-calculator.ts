...
export const netCarbsCalculator: CalculatorDefinition = {
  slug: "net-carbs-calculator",
  title: "Net Carbs Calculator",
  description: "Free net carbs calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["net carbs calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Net Carbs",
      description: "Calculate net carbs",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the net carbs calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
