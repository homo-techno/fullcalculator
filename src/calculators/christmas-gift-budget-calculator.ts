...
export const christmasGiftBudgetCalculator: CalculatorDefinition = {
  slug: "christmas-gift-budget-calculator",
  title: "Christmas Gift Budget Calculator",
  description: "Free christmas gift budget calculator. Quickly calculate and plan your christmas gift budget needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["christmas gift budget calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Christmas Gift Budget",
      description: "Free christmas gift budget calculator. Quickly calculate and plan your christmas",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the christmas gift budget work?",
