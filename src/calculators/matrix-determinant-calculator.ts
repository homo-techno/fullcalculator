...
export const matrixDeterminantCalculator: CalculatorDefinition = {
  slug: "matrix-determinant-calculator",
  title: "Matrix Determinant Calculator",
  description: "Free matrix determinant calculator. Solve matrix determinant problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["matrix determinant calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Matrix Determinant",
      description: "Free matrix determinant calculator. Solve matrix determinant problems with step-",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Matrix Determinant?",
      answer: "Matrix Determinant is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
