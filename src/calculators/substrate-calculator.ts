...
export const substrateCalculator: CalculatorDefinition = {
  slug: "substrate-calculator",
  title: "Substrate Calculator",
  description: "Free substrate calculator. Aquarium planning and maintenance calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["substrate calculator", "aquarium calculator", "fishkeeping tool"],
  variants: [{
    id: "standard",
    name: "Substrate",
