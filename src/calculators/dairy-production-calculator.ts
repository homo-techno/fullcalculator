...
export const dairyProductionCalculator: CalculatorDefinition = {
  slug: "dairy-production-calculator",
  title: "Dairy Production Calculator",
  description: "Free dairy production calculator. Estimate milk production output",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["dairy production calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Dairy Production",
    description: "Estimate milk production output",
    fields: [
