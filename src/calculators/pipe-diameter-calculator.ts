...
export const pipeDiameterCalculator: CalculatorDefinition = {
  slug: "pipe-diameter-calculator",
  title: "Pipe Diameter Calculator",
  description: "Free pipe diameter calculator. Plumbing sizing and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pipe diameter calculator", "plumbing calculator", "sizing tool"],
  variants: [{
    id: "standard",
    name: "Pipe Diameter",
    description: "",
