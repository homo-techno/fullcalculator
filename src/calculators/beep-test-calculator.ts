...
export const beepTestCalculator: CalculatorDefinition = {
  slug: "beep-test-calculator",
  title: "Beep Test Calculator",
  description: "Free beep test calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["beep test calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Beep Test",
      description: "Calculate beep test",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the beep test calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
