...
export const frustumCalculator: CalculatorDefinition = {
  slug: "frustum-calculator",
  title: "Frustum Calculator",
  description: "Free frustum calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["frustum calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Frustum",
      description: "Calculate frustum",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the frustum calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
