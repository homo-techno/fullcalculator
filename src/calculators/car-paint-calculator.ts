...
export const carPaintCalculator: CalculatorDefinition = {
  slug: "car-paint-calculator",
  title: "Car Paint Calculator",
  description: "Free car paint calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["car paint calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
    name: "Car Paint",
    description: "",
