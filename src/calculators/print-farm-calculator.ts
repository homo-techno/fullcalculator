...
export const printFarmCalculator: CalculatorDefinition = {
  slug: "print-farm-calculator",
  title: "Print Farm Calculator",
  description: "Free print farm calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["print farm calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
    name: "Print Farm",
