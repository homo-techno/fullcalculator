...
export const prescriptionCostCalculator: CalculatorDefinition = {
  slug: "prescription-cost-calculator",
  title: "Prescription Cost Calculator",
  description: "Free prescription cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["prescription cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "How much does prescription cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
