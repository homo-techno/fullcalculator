...
export const medicalBillNegotiationCalculator: CalculatorDefinition = {
  slug: "medical-bill-negotiation-calculator",
  title: "Medical Bill Negotiation Calculator",
  description: "Free medical bill negotiation calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["medical bill negotiation calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "How much does medical bill negotiation cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
