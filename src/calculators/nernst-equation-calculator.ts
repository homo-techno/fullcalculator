...
export const nernstEquationCalculator: CalculatorDefinition = {
  slug: "nernst-equation-calculator",
  title: "Nernst Equation Calculator",
  description: "Free nernst equation calculator. Calculate nernst equation values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["nernst equation calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Nernst Equation",
      description: "Free nernst equation calculator. Calculate nernst equation values for research a",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Nernst Equation?",
      answer: "Nernst Equation is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
