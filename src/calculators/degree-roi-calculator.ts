...
export const degreeRoiCalculator: CalculatorDefinition = {
  slug: "degree-roi-calculator",
  title: "Degree Roi Calculator",
  description: "Free degree roi calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["degree roi calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Degree Roi",
      description: "Calculate degree roi",
      fields: [
        {
          name: "salary",
          label: "Annual Salary",
  ...
  faq: [
    { question: "How does the degree roi calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
