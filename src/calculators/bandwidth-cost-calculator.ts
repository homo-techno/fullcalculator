...
export const bandwidthCostCalculator: CalculatorDefinition = {
  slug: "bandwidth-cost-calculator",
  title: "Bandwidth Cost Calculator",
  description: "Free bandwidth cost calculator. Quickly calculate and plan your bandwidth cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bandwidth cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Bandwidth Cost",
      description: "Free bandwidth cost calculator. Quickly calculate and plan your bandwidth cost n",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the bandwidth cost work?",
