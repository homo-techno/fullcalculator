...
export const massEnergyCalculator: CalculatorDefinition = {
  slug: "mass-energy-calculator",
  title: "Mass Energy Calculator",
  description: "Free mass energy calculator. Calculate mass energy values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["mass energy calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Mass Energy",
      description: "Free mass energy calculator. Calculate mass energy values for research and educa",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Mass Energy?",
      answer: "Mass Energy is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
