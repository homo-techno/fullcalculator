...
export const enzymeKineticsCalculator: CalculatorDefinition = {
  slug: "enzyme-kinetics-calculator",
  title: "Enzyme Kinetics Calculator",
  description: "Free enzyme kinetics calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["enzyme kinetics calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "What is enzyme kinetics?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
