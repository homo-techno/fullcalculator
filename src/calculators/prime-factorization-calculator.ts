...
export const primeFactorizationCalculator: CalculatorDefinition = {
  slug: "prime-factorization-calculator",
  title: "Prime Factorization Calculator",
  description: "Free prime factorization calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["prime factorization calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Prime Factorization",
      description: "Calculate prime factorization",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the prime factorization calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
