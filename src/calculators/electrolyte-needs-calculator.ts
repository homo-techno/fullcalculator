...
export const electrolyteNeedsCalculator: CalculatorDefinition = {
  slug: "electrolyte-needs-calculator",
  title: "Electrolyte Needs Calculator",
  description: "Free electrolyte needs calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["electrolyte needs calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Electrolyte Needs",
      description: "Free electrolyte needs calculator. Get personalized health insights based on you",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How does the electrolyte needs work?",
