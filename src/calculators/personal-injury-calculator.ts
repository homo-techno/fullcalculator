...
export const personalInjuryCalculator: CalculatorDefinition = {
  slug: "personal-injury-calculator",
  title: "Personal Injury Calculator",
  description: "Free personal injury calculator. Estimate personal injury claim value",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["personal injury calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Personal Injury",
    description: "Estimate personal injury claim value",
    fields: [
