...
export const tattooHealingTimeCalculator: CalculatorDefinition = {
  slug: "tattoo-healing-time-calculator",
  title: "Tattoo Healing Time Calculator",
  description: "Free tattoo healing time calculator. Track tattoo healing timeline.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo healing time calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Healing Time",
    description: "Track tattoo healing timeline",
    fields: [
