...
export const doublingTimeCalculator: CalculatorDefinition = {
  ...
  description: "Free doubling time calculator. Calculate doubling time values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["doubling time calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Doubling Time",
      description: "Free doubling time calculator. Calculate doubling time values for research and e",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Doubling Time?",
      answer: "Doubling Time is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
