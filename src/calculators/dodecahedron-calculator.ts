...
export const dodecahedronCalculator: CalculatorDefinition = {
  slug: "dodecahedron-calculator",
  title: "Dodecahedron Calculator",
  description: "Free dodecahedron calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["dodecahedron calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Dodecahedron",
      description: "Calculate dodecahedron",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the dodecahedron calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
