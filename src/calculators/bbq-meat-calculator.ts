...
export const bbqMeatCalculator: CalculatorDefinition = {
  slug: "bbq-meat-calculator",
  title: "Bbq Meat Calculator",
  description: "Free bbq meat calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bbq meat calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Bbq Meat",
      description: "Calculate bbq meat",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the bbq meat calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
