...
export const pastaPortionCalculator: CalculatorDefinition = {
  slug: "pasta-portion-calculator",
  title: "Pasta Portion Calculator",
  description: "Free pasta portion calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pasta portion calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Pasta Portion",
      description: "Calculate pasta portion",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the pasta portion calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
