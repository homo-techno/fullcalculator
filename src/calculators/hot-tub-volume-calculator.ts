...
export const hotTubVolumeCalculator: CalculatorDefinition = {
  slug: "hot-tub-volume-calculator",
  title: "Hot Tub Volume Calculator",
  description: "Free hot tub volume calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hot tub volume calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Hot Tub Volume",
      description: "Calculate hot tub volume",
      fields: [
        {
          name: "size",
          label: "Size / Weight",
  ...
  faq: [
    { question: "How does the hot tub volume calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
