...
export const buttonSpacingCalculator: CalculatorDefinition = {
  slug: "button-spacing-calculator",
  title: "Button Spacing Calculator",
  description: "Free button spacing calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["button spacing calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Button Spacing",
