...
export const curveFittingCalculator: CalculatorDefinition = {
  slug: "curve-fitting-calculator",
  title: "Curve Fitting Calculator",
  description: "Free curve fitting calculator. Advanced math and computation tool.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["curve fitting calculator", "math calculator", "computation tool"],
  variants: [{
    id: "standard",
    name: "Curve Fitting",
    description: "",
  ...
  faq: [
    { question: "What is curve fitting?", answer: "A mathematical concept used in computation and analysis. This calculator helps you solve related problems." },
