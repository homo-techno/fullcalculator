...
export const tribonacciCalculator: CalculatorDefinition = {
  slug: "tribonacci-calculator",
  title: "Tribonacci Calculator",
  description: "Free tribonacci calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["tribonacci calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Tribonacci",
      description: "Calculate tribonacci",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the tribonacci calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
