...
export const shutterSpeedCalculator: CalculatorDefinition = {
  slug: "shutter-speed-calculator",
  title: "Shutter Speed Calculator",
  description: "Free shutter speed calculator. Photography exposure and settings calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["shutter speed calculator", "photography calculator", "camera settings"],
  variants: [{
    id: "standard",
    name: "Shutter Speed",
