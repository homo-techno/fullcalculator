...
export const parsecCalculator: CalculatorDefinition = {
  slug: "parsec-calculator",
  title: "Parsec Calculator",
  description: "Free parsec calculator. Calculate parsec values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["parsec calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Parsec",
  ...
  faq: [
    {
      ...
      answer: "Parsec is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
