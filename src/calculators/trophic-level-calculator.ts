...
export const trophicLevelCalculator: CalculatorDefinition = {
  slug: "trophic-level-calculator",
  title: "Trophic Level Calculator",
  description: "Free trophic level calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["trophic level calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
    name: "Trophic Level",
    description: "",
  ...
  faq: [
    { question: "What is trophic level?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
