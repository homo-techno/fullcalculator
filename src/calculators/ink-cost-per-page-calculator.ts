...
export const inkCostPerPageCalculator: CalculatorDefinition = {
  slug: "ink-cost-per-page-calculator",
  title: "Ink Cost Per Page Calculator",
  description: "Free ink cost per page calculator. Quickly calculate and plan your ink cost per page needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["ink cost per page calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Ink Cost Per Page",
      description: "Free ink cost per page calculator. Quickly calculate and plan your ink cost per ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the ink cost per page work?",
