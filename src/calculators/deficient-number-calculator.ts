...
export const deficientNumberCalculator: CalculatorDefinition = {
  slug: "deficient-number-calculator",
  title: "Deficient Number Calculator",
  description: "Free deficient number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["deficient number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Deficient Number",
      description: "Calculate deficient number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the deficient number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
