...
export const washSaleCalculator: CalculatorDefinition = {
  slug: "wash-sale-calculator",
  title: "Wash Sale Calculator",
  description: "Free wash sale calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["wash sale calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Wash Sale",
      description: "Free wash sale calculator. Plan your finances with accurate calculations and pro",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Wash Sale Calculator calculate?",
      answer: "This calculator helps you estimate wash sale based on your specific financial situation and inputs.",
    },
    {
