...
export const bathroomRemodelCalculator: CalculatorDefinition = {
  slug: "bathroom-remodel-calculator",
  title: "Bathroom Remodel Calculator",
  description: "Free bathroom remodel calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bathroom remodel calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate bathroom remodel costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does bathroom remodel cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
