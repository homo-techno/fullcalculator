...
export const wristSizeCalculator: CalculatorDefinition = {
  slug: "wrist-size-calculator",
  title: "Wrist Size Calculator",
  description: "Free wrist size calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["wrist size calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Wrist Size",
      description: "Calculate wrist size",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the wrist size calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
