...
export const internetPlanCalculator: CalculatorDefinition = {
  slug: "internet-plan-calculator",
  title: "Internet Plan Calculator",
  description: "Free internet plan calculator. Quickly calculate and plan your internet plan needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["internet plan calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Internet Plan",
      description: "Free internet plan calculator. Quickly calculate and plan your internet plan nee",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the internet plan work?",
