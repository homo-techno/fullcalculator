...
export const sampleRateCalculator: CalculatorDefinition = {
  slug: "sample-rate-calculator",
  title: "Sample Rate Calculator",
  description: "Free sample rate calculator. Convert and calculate sample rate values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["sample rate calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Sample Rate",
  ...
  faq: [
    {
      question: "How does sample rate conversion work?",
