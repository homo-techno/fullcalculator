...
export const eulersTotientCalculator: CalculatorDefinition = {
  slug: "eulers-totient-calculator",
  title: "Eulers Totient Calculator",
  description: "Free eulers totient calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["eulers totient calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Eulers Totient",
      description: "Calculate eulers totient",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the eulers totient calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
