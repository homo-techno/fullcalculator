...
export const stairClimbingCalorieCalculator: CalculatorDefinition = {
  slug: "stair-climbing-calorie-calculator",
  title: "Stair Climbing Calorie Calculator",
  description: "Free stair climbing calorie calculator. Calculate calories burned during stair climbing based on your weight and duration.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["stair climbing calorie calculator", "calories burned", "exercise calculator"],
  variants: [
    {
      id: "standard",
      name: "Calories Burned",
      description: "Calculate calories burned during stair climbing",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How many calories does stair climbing burn?",
      answer: "A 70kg person burns approximately 315 calories in 30 minutes of moderate stair climbing.",
    },
    {
