...
export const lightPollutionCalculator: CalculatorDefinition = {
  slug: "light-pollution-calculator",
  title: "Light Pollution Calculator",
  description: "Free light pollution calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["light pollution calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Light Pollution",
      description: "Calculate light pollution",
      fields: [
        {
          name: "input1",
          label: "Primary Input",
  ...
  faq: [
    { question: "How does the light pollution calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
