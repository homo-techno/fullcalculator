...
export const electricBikeRangeCalculator: CalculatorDefinition = {
  slug: "electric-bike-range-calculator",
  title: "Electric Bike Range Calculator",
  description: "Free electric bike range calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["electric bike range calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Electric Bike Range",
      description: "Calculate electric bike range",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the electric bike range calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
