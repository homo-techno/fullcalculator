...
export const bodyTypeCalculator: CalculatorDefinition = {
  slug: "body-type-calculator",
  title: "Body Type Calculator",
  description: "Free body type calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["body type calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Body Type",
      description: "Calculate body type",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the body type calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
