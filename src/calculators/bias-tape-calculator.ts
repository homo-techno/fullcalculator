...
export const biasTapeCalculator: CalculatorDefinition = {
  slug: "bias-tape-calculator",
  title: "Bias Tape Calculator",
  description: "Free bias tape calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bias tape calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Bias Tape",
