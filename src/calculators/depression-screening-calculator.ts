...
export const depressionScreeningCalculator: CalculatorDefinition = {
  slug: "depression-screening-calculator",
  title: "Depression Screening Calculator",
  description: "Free depression screening calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["depression screening calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Depression Screening",
      description: "Free depression screening calculator. Get personalized health insights based on ",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the depression screening work?",
