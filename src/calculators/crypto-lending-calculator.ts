...
export const cryptoLendingCalculator: CalculatorDefinition = {
  slug: "crypto-lending-calculator",
  title: "Crypto Lending Calculator",
  description: "Free crypto lending calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["crypto lending calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Crypto Lending",
      description: "Calculate crypto lending",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the crypto lending calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
