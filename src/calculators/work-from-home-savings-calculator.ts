...
export const workFromHomeSavingsCalculator: CalculatorDefinition = {
  slug: "work-from-home-savings-calculator",
  title: "Work From Home Savings Calculator",
  description: "Free work from home savings calculator. Quickly calculate and plan your work from home savings needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["work from home savings calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Work From Home Savings",
      description: "Free work from home savings calculator. Quickly calculate and plan your work fro",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the work from home savings work?",
