...
export const networkThroughputCalculator: CalculatorDefinition = {
  slug: "network-throughput-calculator",
  title: "Network Throughput Calculator",
  description: "Free network throughput calculator. Quickly calculate and plan your network throughput needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["network throughput calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Network Throughput",
      description: "Free network throughput calculator. Quickly calculate and plan your network thro",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the network throughput work?",
