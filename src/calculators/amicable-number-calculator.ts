...
export const amicableNumberCalculator: CalculatorDefinition = {
  slug: "amicable-number-calculator",
  title: "Amicable Number Calculator",
  description: "Free amicable number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["amicable number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Amicable Number",
      description: "Calculate amicable number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the amicable number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
