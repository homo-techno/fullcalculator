...
export const cloudStorageCostCalculator: CalculatorDefinition = {
  slug: "cloud-storage-cost-calculator",
  title: "Cloud Storage Cost Calculator",
  description: "Free cloud storage cost calculator. Quickly calculate and plan your cloud storage cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cloud storage cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Cloud Storage Cost",
      description: "Free cloud storage cost calculator. Quickly calculate and plan your cloud storag",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the cloud storage cost work?",
