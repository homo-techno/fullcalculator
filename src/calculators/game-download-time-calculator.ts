...
export const gameDownloadTimeCalculator: CalculatorDefinition = {
  slug: "game-download-time-calculator",
  title: "Game Download Time Calculator",
  description: "Free game download time calculator. Estimate game download duration",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["game download time calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "Game Download Time",
    description: "Estimate game download duration",
    fields: [
