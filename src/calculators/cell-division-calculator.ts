...
export const cellDivisionCalculator: CalculatorDefinition = {
  slug: "cell-division-calculator",
  title: "Cell Division Calculator",
  description: "Free cell division calculator. Calculate cell division values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["cell division calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Cell Division",
      description: "Free cell division calculator. Calculate cell division values for research and e",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      ...
      answer: "Cell Division is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
