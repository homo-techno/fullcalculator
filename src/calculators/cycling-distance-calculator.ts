...
export const cyclingDistanceCalculator: CalculatorDefinition = {
  slug: "cycling-distance-calculator",
  title: "Cycling Distance Calculator",
  description: "Free cycling distance calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cycling distance calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cycling Distance",
      description: "Calculate cycling distance",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the cycling distance calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
