...
export const groundRodCalculator: CalculatorDefinition = {
  slug: "ground-rod-calculator",
  title: "Ground Rod Calculator",
  description: "Free ground rod calculator. Electrical sizing and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["ground rod calculator", "electrical calculator", "sizing tool"],
  variants: [{
    id: "standard",
    name: "Ground Rod",
    description: "",
