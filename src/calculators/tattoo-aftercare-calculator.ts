...
export const tattooAftercareCalculator: CalculatorDefinition = {
  slug: "tattoo-aftercare-calculator",
  title: "Tattoo Aftercare Calculator",
  description: "Free tattoo aftercare calculator. Calculate aftercare product needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo aftercare calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Aftercare",
    description: "Calculate aftercare product needs",
    fields: [
