...
export const polygonStakingCalculator: CalculatorDefinition = {
  slug: "polygon-staking-calculator",
  title: "Polygon Staking Calculator",
  description: "Free polygon staking calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["polygon staking calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Polygon Staking",
      description: "Calculate polygon staking",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the polygon staking calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
