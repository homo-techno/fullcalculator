...
export const dogWalkingCostCalculator: CalculatorDefinition = {
  slug: "dog-walking-cost-calculator",
  title: "Dog Walking Cost Calculator",
  description: "Free dog walking cost calculator. Quickly calculate and plan your dog walking cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["dog walking cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Dog Walking Cost",
      description: "Free dog walking cost calculator. Quickly calculate and plan your dog walking co",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the dog walking cost work?",
