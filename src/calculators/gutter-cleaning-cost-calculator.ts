...
export const gutterCleaningCostCalculator: CalculatorDefinition = {
  slug: "gutter-cleaning-cost-calculator",
  title: "Gutter Cleaning Cost Calculator",
  description: "Free gutter cleaning cost calculator. Quickly calculate and plan your gutter cleaning cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["gutter cleaning cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Gutter Cleaning Cost",
      description: "Free gutter cleaning cost calculator. Quickly calculate and plan your gutter cle",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the gutter cleaning cost work?",
