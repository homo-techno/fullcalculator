...
export const hairDyeAmountCalculator: CalculatorDefinition = {
  slug: "hair-dye-amount-calculator",
  title: "Hair Dye Amount Calculator",
  description: "Free hair dye amount calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hair dye amount calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
    name: "Hair Dye Amount",
    description: "",
    fields: [
  ...
  faq: [
    { question: "How much does hair dye amount cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
