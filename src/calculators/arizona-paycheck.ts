...
export const arizonaPaycheckCalculator: CalculatorDefinition = {
  slug: "arizona-paycheck-calculator",
  title: "Arizona Paycheck Calculator",
  description:
    "Free Arizona paycheck calculator. Estimate your take-home pay after federal taxes, Arizona flat state income tax (2.5%), and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["arizona paycheck calculator", "arizona take home pay", "AZ paycheck calculator", "arizona state tax", "arizona salary calculator", "arizona income tax calculator"],
  variants: [
    {
      id: "arizona-paycheck",
      name: "Arizona Paycheck Calculator",
      description: "Calculate your Arizona take-home pay after federal, state (2.5% flat), and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        const stateTaxAnnual = annualIncome * 0.025;
        ...
        return {
          ...
          details: [
            ...
            { label: "Arizona State Tax (2.5%)", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["california-paycheck-calculator", "colorado-paycheck-calculator", "texas-paycheck-calculator"],
  faq: [
    {
      question: "What is the Arizona state income tax rate?",
      answer:
        "Arizona has a flat state income tax rate of 2.5% as of 2023, one of the lowest flat rates in the nation.",
    },
    {
      question: "Does Arizona have local income taxes?",
      answer:
        "No. Arizona does not levy local or municipal income taxes.",
    },
    {
      question: "How did Arizonas tax rate change?",
      answer:
        "Arizona transitioned to a flat 2.5% rate in 2023 from a progressive system that went up to 4.5%.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - Arizona Flat Tax (2.5%) - Social Security (6.2%) - Medicare (1.45%)",
};
