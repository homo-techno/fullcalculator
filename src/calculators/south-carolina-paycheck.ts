...
export const southCarolinaPaycheckCalculator: CalculatorDefinition = {
  slug: "south-carolina-paycheck-calculator",
  title: "South Carolina Paycheck Calculator",
  description:
    "Free South Carolina paycheck calculator. Estimate your take-home pay after federal taxes, South Carolina state income tax, and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["south carolina paycheck calculator", "south carolina take home pay", "SC paycheck calculator", "south carolina state tax", "south carolina salary calculator", "SC income tax calculator"],
  variants: [
    {
      id: "south-carolina-paycheck",
      name: "South Carolina Paycheck Calculator",
      description: "Calculate your South Carolina take-home pay after federal, state, and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        return {
          ...
          details: [
            ...
            { label: "South Carolina State Tax", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["north-carolina-paycheck-calculator", "georgia-paycheck-calculator", "virginia-paycheck-calculator"],
  faq: [
    {
      question: "What is the South Carolina state income tax rate?",
      answer:
        "South Carolina has a 0% rate on the first ,460, 3% on ,460-7,330, and a top rate of 6.4% on income above 7,330.",
    },
    {
      question: "Does South Carolina have local income taxes?",
      answer:
        "No. South Carolina does not levy local income taxes.",
    },
    {
      question: "How does South Carolina compare to North Carolina?",
      answer:
        "South Carolinas top 6.4% is higher than North Carolinas flat 4.5%, but SC offers more generous deductions, especially for retirees.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - South Carolina State Tax - Social Security (6.2%) - Medicare (1.45%)",
};
