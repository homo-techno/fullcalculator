...
export const anxietyScoreCalculator: CalculatorDefinition = {
  slug: "anxiety-score-calculator",
  title: "Anxiety Score Calculator",
  description: "Free anxiety score calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["anxiety score calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Anxiety Score",
      description: "Free anxiety score calculator. Get personalized health insights based on your pr",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the anxiety score work?",
