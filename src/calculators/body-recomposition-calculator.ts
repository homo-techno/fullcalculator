...
export const bodyRecompositionCalculator: CalculatorDefinition = {
  slug: "body-recomposition-calculator",
  title: "Body Recomposition Calculator",
  description: "Free body recomposition calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["body recomposition calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Body Recomposition",
      description: "Calculate body recomposition",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the body recomposition calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
