...
export const vacationBudgetCalculator: CalculatorDefinition = {
  slug: "vacation-budget-calculator",
  title: "Vacation Budget Calculator",
  description: "Free vacation budget calculator. Quickly calculate and plan your vacation budget needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["vacation budget calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Vacation Budget",
      description: "Free vacation budget calculator. Quickly calculate and plan your vacation budget",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the vacation budget work?",
