...
export const vo2maxFitnessCalculator: CalculatorDefinition = {
  slug: "vo2max-fitness-calculator",
  title: "Vo2max Fitness Calculator",
  description: "Free vo2max fitness calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["vo2max fitness calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Vo2max Fitness",
      description: "Free vo2max fitness calculator. Get personalized health insights based on your p",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the vo2max fitness work?",
