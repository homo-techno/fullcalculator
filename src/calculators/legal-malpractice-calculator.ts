...
export const legalMalpracticeCalculator: CalculatorDefinition = {
  slug: "legal-malpractice-calculator",
  title: "Legal Malpractice Calculator",
  description: "Free legal malpractice calculator. Estimate malpractice claim value",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["legal malpractice calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Legal Malpractice",
    description: "Estimate malpractice claim value",
    fields: [
