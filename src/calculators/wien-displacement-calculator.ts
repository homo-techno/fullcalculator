...
export const wienDisplacementCalculator: CalculatorDefinition = {
  slug: "wien-displacement-calculator",
  title: "Wien Displacement Calculator",
  description: "Free wien displacement calculator. Calculate wien displacement values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["wien displacement calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Wien Displacement",
      description: "Free wien displacement calculator. Calculate wien displacement values for resear",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Wien Displacement?",
      answer: "Wien Displacement is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
