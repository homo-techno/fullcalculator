...
export const solanaStakingCalculator: CalculatorDefinition = {
  slug: "solana-staking-calculator",
  title: "Solana Staking Calculator",
  description: "Free solana staking calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["solana staking calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Solana Staking",
      description: "Calculate solana staking",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the solana staking calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
