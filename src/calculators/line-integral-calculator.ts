...
export const lineIntegralCalculator: CalculatorDefinition = {
  slug: "line-integral-calculator",
  title: "Line Integral Calculator",
  description: "Free line integral calculator. Solve line integral problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["line integral calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Line Integral",
      description: "Free line integral calculator. Solve line integral problems with step-by-step ca",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Line Integral?",
      answer: "Line Integral is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
