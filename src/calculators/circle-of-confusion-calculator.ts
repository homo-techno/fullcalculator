...
export const circleOfConfusionCalculator: CalculatorDefinition = {
  slug: "circle-of-confusion-calculator",
  title: "Circle Of Confusion Calculator",
  description: "Free circle of confusion calculator. Photography exposure and settings calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["circle of confusion calculator", "photography calculator", "camera settings"],
  variants: [{
    id: "standard",
