...
export const roomPaintCalculator: CalculatorDefinition = {
  slug: "room-paint-calculator",
  title: "Room Paint Calculator",
  description: "Free room paint calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["room paint calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate room paint costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does room paint cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
