...
export const tetrahedronCalculator: CalculatorDefinition = {
  slug: "tetrahedron-calculator",
  title: "Tetrahedron Calculator",
  description: "Free tetrahedron calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["tetrahedron calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Tetrahedron",
      description: "Calculate tetrahedron",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the tetrahedron calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
