...
export const printVsDigitalCalculator: CalculatorDefinition = {
  slug: "print-vs-digital-calculator",
  title: "Print Vs Digital Calculator",
  description: "Free print vs digital calculator. Quickly calculate and plan your print vs digital needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["print vs digital calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Print Vs Digital",
      description: "Free print vs digital calculator. Quickly calculate and plan your print vs digit",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the print vs digital work?",
