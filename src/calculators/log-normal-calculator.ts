...
export const logNormalCalculator: CalculatorDefinition = {
  slug: "log-normal-calculator",
  title: "Log Normal Calculator",
  description: "Free log normal calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["log normal calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Log Normal",
      description: "Calculate log normal",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the log normal calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
