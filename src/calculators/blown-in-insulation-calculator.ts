...
export const blownInInsulationCalculator: CalculatorDefinition = {
  slug: "blown-in-insulation-calculator",
  title: "Blown In Insulation Calculator",
  description: "Free blown in insulation calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["blown in insulation calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate blown in insulation costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does blown in insulation cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
