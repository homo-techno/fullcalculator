...
export const respirationRateCalculator: CalculatorDefinition = {
  slug: "respiration-rate-calculator",
  title: "Respiration Rate Calculator",
  description: "Free respiration rate calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["respiration rate calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "What is respiration rate?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
