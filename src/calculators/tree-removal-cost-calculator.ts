...
export const treeRemovalCostCalculator: CalculatorDefinition = {
  slug: "tree-removal-cost-calculator",
  title: "Tree Removal Cost Calculator",
  description: "Free tree removal cost calculator. Quickly calculate and plan your tree removal cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tree removal cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Tree Removal Cost",
      description: "Free tree removal cost calculator. Quickly calculate and plan your tree removal ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the tree removal cost work?",
