...
export const greatCircleCalculator: CalculatorDefinition = {
  slug: "great-circle-calculator",
  title: "Great Circle Calculator",
  description: "Free great circle calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["great circle calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Great Circle",
      description: "Calculate great circle",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the great circle calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
