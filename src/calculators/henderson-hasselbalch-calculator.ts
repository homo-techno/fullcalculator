...
export const hendersonHasselbalchCalculator: CalculatorDefinition = {
  slug: "henderson-hasselbalch-calculator",
  title: "Henderson Hasselbalch Calculator",
  description: "Free henderson hasselbalch calculator. Calculate henderson hasselbalch values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["henderson hasselbalch calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Henderson Hasselbalch",
      description: "Free henderson hasselbalch calculator. Calculate henderson hasselbalch values fo",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Henderson Hasselbalch?",
      answer: "Henderson Hasselbalch is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
