...
export const irregularPolygonCalculator: CalculatorDefinition = {
  slug: "irregular-polygon-calculator",
  title: "Irregular Polygon Calculator",
  description: "Free irregular polygon calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["irregular polygon calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Irregular Polygon",
      description: "Calculate irregular polygon",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the irregular polygon calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
