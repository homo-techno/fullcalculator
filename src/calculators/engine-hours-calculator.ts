...
export const engineHoursCalculator: CalculatorDefinition = {
  slug: "engine-hours-calculator",
  title: "Engine Hours Calculator",
  description: "Free engine hours calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["engine hours calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Engine Hours",
    description: "",
