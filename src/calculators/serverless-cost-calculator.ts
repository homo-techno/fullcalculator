...
export const serverlessCostCalculator: CalculatorDefinition = {
  slug: "serverless-cost-calculator",
  title: "Serverless Cost Calculator",
  description: "Free serverless cost calculator. Quickly calculate and plan your serverless cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["serverless cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Serverless Cost",
      description: "Free serverless cost calculator. Quickly calculate and plan your serverless cost",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the serverless cost work?",
