...
export const hullSpeedCalculator: CalculatorDefinition = {
  slug: "hull-speed-calculator",
  title: "Hull Speed Calculator",
  description: "Free hull speed calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hull speed calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Hull Speed",
    description: "",
