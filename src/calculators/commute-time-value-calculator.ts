...
export const commuteTimeValueCalculator: CalculatorDefinition = {
  slug: "commute-time-value-calculator",
  title: "Commute Time Value Calculator",
  description: "Free commute time value calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["commute time value calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Commute Time Value",
      description: "Calculate commute time value",
      fields: [
        {
          name: "salary",
          label: "Annual Salary",
  ...
  faq: [
    { question: "How does the commute time value calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
