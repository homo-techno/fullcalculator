...
export const tTestCalculator: CalculatorDefinition = {
  slug: "t-test-calculator",
  title: "T Test Calculator",
  description: "Free t test calculator. Solve t test problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["t test calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "T Test",
  ...
  faq: [
    {
      ...
      answer: "T Test is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
