...
export const interfacingCalculator: CalculatorDefinition = {
  slug: "interfacing-calculator",
  title: "Interfacing Calculator",
  description: "Free interfacing calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["interfacing calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Interfacing",
