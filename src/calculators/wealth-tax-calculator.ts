...
export const wealthTaxCalculator: CalculatorDefinition = {
  slug: "wealth-tax-calculator",
  title: "Wealth Tax Calculator",
  description: "Free wealth tax calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["wealth tax calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Wealth Tax",
      description: "Calculate wealth tax",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the wealth tax calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
