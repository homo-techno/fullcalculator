...
export const sensorSizeCalculator: CalculatorDefinition = {
  slug: "sensor-size-calculator",
  title: "Sensor Size Calculator",
  description: "Free sensor size calculator. Photography exposure and settings calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["sensor size calculator", "photography calculator", "camera settings"],
  variants: [{
    id: "standard",
    name: "Sensor Size",
