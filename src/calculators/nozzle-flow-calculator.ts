...
export const nozzleFlowCalculator: CalculatorDefinition = {
  slug: "nozzle-flow-calculator",
  title: "Nozzle Flow Calculator",
  description: "Free nozzle flow calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["nozzle flow calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
    name: "Nozzle Flow",
