...
export const cashbackCalculator: CalculatorDefinition = {
  slug: "cashback-calculator",
  title: "Cashback Calculator",
  description: "Free cashback calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cashback calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cashback",
      description: "Calculate cashback",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    { question: "How does the cashback calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
