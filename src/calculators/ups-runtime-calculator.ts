...
export const upsRuntimeCalculator: CalculatorDefinition = {
  slug: "ups-runtime-calculator",
  title: "Ups Runtime Calculator",
  description: "Free ups runtime calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["ups runtime calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Ups Runtime",
      description: "Calculate ups runtime",
      fields: [
        {
          name: "value",
          label: "Primary Value",
  ...
  faq: [
    { question: "How does the ups runtime calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
