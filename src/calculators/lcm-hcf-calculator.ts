...
export const lcmHcfCalculator: CalculatorDefinition = {
  slug: "lcm-hcf-calculator",
  title: "Lcm Hcf Calculator",
  description: "Free lcm hcf calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["lcm hcf calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Lcm Hcf",
      description: "Calculate lcm hcf",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the lcm hcf calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
