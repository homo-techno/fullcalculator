...
export const ambulanceCostCalculator: CalculatorDefinition = {
  slug: "ambulance-cost-calculator",
  title: "Ambulance Cost Calculator",
  description: "Free ambulance cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["ambulance cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Ambulance Cost",
  ...
  faq: [
    { question: "How much does ambulance cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
