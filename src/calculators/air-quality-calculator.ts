...
export const airQualityCalculator: CalculatorDefinition = {
  slug: "air-quality-calculator",
  title: "Air Quality Calculator",
  description: "Free air quality calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["air quality calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Air Quality",
  ...
  faq: [
    { question: "How does the air quality calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
