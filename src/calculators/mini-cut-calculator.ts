...
export const miniCutCalculator: CalculatorDefinition = {
  slug: "mini-cut-calculator",
  title: "Mini Cut Calculator",
  description: "Free mini cut calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["mini cut calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Mini Cut",
      description: "Calculate mini cut",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the mini cut calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
