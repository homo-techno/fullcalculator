...
export const moneyMarketCalculator: CalculatorDefinition = {
  slug: "money-market-calculator",
  title: "Money Market Calculator",
  description: "Free money market calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["money market calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Money Market",
      description: "Calculate money market",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the money market calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
