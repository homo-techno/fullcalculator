...
export const printTimeEstimatorCalculator: CalculatorDefinition = {
  slug: "print-time-estimator-calculator",
  title: "Print Time Estimator Calculator",
  description: "Free print time estimator calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["print time estimator calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
