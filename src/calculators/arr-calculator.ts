...
export const arrCalculator: CalculatorDefinition = {
  slug: "arr-calculator",
  title: "Arr Calculator",
  description: "Free arr calculator. Quickly calculate and plan your arr needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["arr calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Arr",
  ...
  faq: [
    {
      question: "How does the arr work?",
