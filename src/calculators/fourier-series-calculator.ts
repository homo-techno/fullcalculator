...
export const fourierSeriesCalculator: CalculatorDefinition = {
  slug: "fourier-series-calculator",
  title: "Fourier Series Calculator",
  description: "Free fourier series calculator. Solve fourier series problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["fourier series calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Fourier Series",
      description: "Free fourier series calculator. Solve fourier series problems with step-by-step ",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      ...
      answer: "Fourier Series is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
