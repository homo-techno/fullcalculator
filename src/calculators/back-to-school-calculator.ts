...
export const backToSchoolCalculator: CalculatorDefinition = {
  slug: "back-to-school-calculator",
  title: "Back To School Calculator",
  description: "Free back to school calculator. Quickly calculate and plan your back to school needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["back to school calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Back To School",
      description: "Free back to school calculator. Quickly calculate and plan your back to school n",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the back to school work?",
