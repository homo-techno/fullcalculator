...
export const ellipseCalculator: CalculatorDefinition = {
  slug: "ellipse-calculator",
  title: "Ellipse Calculator",
  description: "Free ellipse calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["ellipse calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Ellipse",
      description: "Calculate ellipse",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the ellipse calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
