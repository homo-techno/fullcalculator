...
export const schoolSupplyCostCalculator: CalculatorDefinition = {
  slug: "school-supply-cost-calculator",
  title: "School Supply Cost Calculator",
  description: "Free school supply cost calculator. Quickly calculate and plan your school supply cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["school supply cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "School Supply Cost",
      description: "Free school supply cost calculator. Quickly calculate and plan your school suppl",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the school supply cost work?",
