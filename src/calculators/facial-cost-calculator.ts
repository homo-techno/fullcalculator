...
export const facialCostCalculator: CalculatorDefinition = {
  slug: "facial-cost-calculator",
  title: "Facial Cost Calculator",
  description: "Free facial cost calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["facial cost calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
    name: "Facial Cost",
    description: "",
  ...
  faq: [
    { question: "How much does facial cost cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
