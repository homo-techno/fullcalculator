...
export const farmLoanCalculator: CalculatorDefinition = {
  slug: "farm-loan-calculator",
  title: "Farm Loan Calculator",
  description: "Free farm loan calculator. Calculate agricultural loan payments",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["farm loan calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Farm Loan",
    description: "Calculate agricultural loan payments",
    fields: [
