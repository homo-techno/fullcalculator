...
export const hatSizeConverterCalculator: CalculatorDefinition = {
  slug: "hat-size-converter-calculator",
  title: "Hat Size Converter Calculator",
  description: "Free hat size converter calculator. Convert and calculate hat size converter values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["hat size converter calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Hat Size Converter",
      description: "Free hat size converter calculator. Convert and calculate hat size converter val",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does hat size converter conversion work?",
