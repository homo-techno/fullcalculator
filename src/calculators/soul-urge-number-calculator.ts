...
export const soulUrgeNumberCalculator: CalculatorDefinition = {
  slug: "soul-urge-number-calculator",
  title: "Soul Urge Number Calculator",
  description: "Free soul urge number calculator. Find your hearts desire number",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["soul urge number calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Soul Urge Number",
    description: "Find your hearts desire number",
    fields: [
