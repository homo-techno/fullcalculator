...
export const negativeBinomialCalculator: CalculatorDefinition = {
  slug: "negative-binomial-calculator",
  title: "Negative Binomial Calculator",
  description: "Free negative binomial calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["negative binomial calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Negative Binomial",
      description: "Calculate negative binomial",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the negative binomial calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
