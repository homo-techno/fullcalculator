...
export const modularExponentiationCalculator: CalculatorDefinition = {
  slug: "modular-exponentiation-calculator",
  title: "Modular Exponentiation Calculator",
  description: "Free modular exponentiation calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["modular exponentiation calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Modular Exponentiation",
      description: "Calculate modular exponentiation",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the modular exponentiation calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
