...
export const quarterlyEstimatedTaxCalculator: CalculatorDefinition = {
  slug: "quarterly-estimated-tax-calculator",
  title: "Quarterly Estimated Tax Calculator",
  description: "Free quarterly estimated tax calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["quarterly estimated tax calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Quarterly Estimated Tax",
      description: "Free quarterly estimated tax calculator. Plan your finances with accurate calcul",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Quarterly Estimated Tax Calculator calculate?",
      answer: "This calculator helps you estimate quarterly estimated tax based on your specific financial situation and inputs.",
    },
    {
