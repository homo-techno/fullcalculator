...
export const groundSpeedCalculator: CalculatorDefinition = {
  slug: "ground-speed-calculator",
  title: "Ground Speed Calculator",
  description: "Free ground speed calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["ground speed calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
    name: "Ground Speed",
