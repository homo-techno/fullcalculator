...
export const neatCalculator: CalculatorDefinition = {
  slug: "neat-calculator",
  title: "Neat Calculator",
  description: "Free neat calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["neat calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Neat",
      description: "Calculate neat",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the neat calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
