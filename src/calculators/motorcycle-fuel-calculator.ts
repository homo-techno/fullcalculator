...
export const motorcycleFuelCalculator: CalculatorDefinition = {
  slug: "motorcycle-fuel-calculator",
  title: "Motorcycle Fuel Calculator",
  description: "Free motorcycle fuel calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["motorcycle fuel calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Motorcycle Fuel",
      description: "Calculate motorcycle fuel",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the motorcycle fuel calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
