...
export const giftTaxCalculator: CalculatorDefinition = {
  slug: "gift-tax-calculator",
  title: "Gift Tax Calculator",
  description: "Free gift tax calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["gift tax calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Gift Tax",
      description: "Free gift tax calculator. Plan your finances with accurate calculations and proj",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Gift Tax Calculator calculate?",
      answer: "This calculator helps you estimate gift tax based on your specific financial situation and inputs.",
    },
    {
