...
export const planetTransitCalculator: CalculatorDefinition = {
  slug: "planet-transit-calculator",
  title: "Planet Transit Calculator",
  description: "Free planet transit calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["planet transit calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Planet Transit",
      description: "Calculate planet transit",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the planet transit calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
