...
export const sphericalTriangleCalculator: CalculatorDefinition = {
  slug: "spherical-triangle-calculator",
  title: "Spherical Triangle Calculator",
  description: "Free spherical triangle calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["spherical triangle calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Spherical Triangle",
      description: "Calculate spherical triangle",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the spherical triangle calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
