...
export const cheatMealCalculator: CalculatorDefinition = {
  slug: "cheat-meal-calculator",
  title: "Cheat Meal Calculator",
  description: "Free cheat meal calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["cheat meal calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Cheat Meal",
      description: "Calculate cheat meal",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the cheat meal calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
