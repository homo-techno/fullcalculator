...
export const polynomialRootCalculator: CalculatorDefinition = {
  slug: "polynomial-root-calculator",
  title: "Polynomial Root Calculator",
  description: "Free polynomial root calculator. Solve polynomial root problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["polynomial root calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Polynomial Root",
      description: "Free polynomial root calculator. Solve polynomial root problems with step-by-ste",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Polynomial Root?",
      answer: "Polynomial Root is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
