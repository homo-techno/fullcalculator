...
export const cooperTestCalculator: CalculatorDefinition = {
  slug: "cooper-test-calculator",
  title: "Cooper Test Calculator",
  description: "Free cooper test calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["cooper test calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cooper Test",
      description: "Calculate cooper test",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the cooper test calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
