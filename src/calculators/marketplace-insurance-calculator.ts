...
export const marketplaceInsuranceCalculator: CalculatorDefinition = {
  slug: "marketplace-insurance-calculator",
  title: "Marketplace Insurance Calculator",
  description: "Free marketplace insurance calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["marketplace insurance calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
