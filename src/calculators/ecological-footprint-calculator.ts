...
export const ecologicalFootprintCalculator: CalculatorDefinition = {
  slug: "ecological-footprint-calculator",
  title: "Ecological Footprint Calculator",
  description: "Free ecological footprint calculator. Calculate ecological footprint values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["ecological footprint calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Ecological Footprint",
      description: "Free ecological footprint calculator. Calculate ecological footprint values for ",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      ...
      answer: "Ecological Footprint is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
