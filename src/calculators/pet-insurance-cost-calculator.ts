...
export const petInsuranceCostCalculator: CalculatorDefinition = {
  slug: "pet-insurance-cost-calculator",
  title: "Pet Insurance Cost Calculator",
  description: "Free pet insurance cost calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["pet insurance cost calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
    name: "Pet Insurance Cost",
