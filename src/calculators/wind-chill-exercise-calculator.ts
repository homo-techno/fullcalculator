...
export const windChillExerciseCalculator: CalculatorDefinition = {
  slug: "wind-chill-exercise-calculator",
  title: "Wind Chill Exercise Calculator",
  description: "Free wind chill exercise calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["wind chill exercise calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Wind Chill Exercise",
      description: "Free wind chill exercise calculator. Get personalized health insights based on y",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the wind chill exercise work?",
