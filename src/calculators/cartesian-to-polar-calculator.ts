...
export const cartesianToPolarCalculator: CalculatorDefinition = {
  slug: "cartesian-to-polar-calculator",
  title: "Cartesian To Polar Calculator",
  description: "Free cartesian to polar calculator. Solve cartesian to polar problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["cartesian to polar calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Cartesian To Polar",
      description: "Free cartesian to polar calculator. Solve cartesian to polar problems with step-",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Cartesian To Polar?",
      answer: "Cartesian To Polar is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
