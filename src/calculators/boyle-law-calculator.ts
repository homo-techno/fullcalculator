...
export const boyleLawCalculator: CalculatorDefinition = {
  slug: "boyle-law-calculator",
  title: "Boyle Law Calculator",
  description: "Free boyle law calculator. Calculate boyle law values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["boyle law calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Boyle Law",
  ...
  faq: [
    {
      question: "What is Boyle Law?",
      answer: "Boyle Law is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
