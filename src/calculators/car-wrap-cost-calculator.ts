...
export const carWrapCostCalculator: CalculatorDefinition = {
  slug: "car-wrap-cost-calculator",
  title: "Car Wrap Cost Calculator",
  description: "Free car wrap cost calculator. Quickly calculate and plan your car wrap cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["car wrap cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Car Wrap Cost",
      description: "Free car wrap cost calculator. Quickly calculate and plan your car wrap cost nee",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the car wrap cost work?",
