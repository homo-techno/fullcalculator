...
export const hexadecimalArithmeticCalculator: CalculatorDefinition = {
  slug: "hexadecimal-arithmetic-calculator",
  title: "Hexadecimal Arithmetic Calculator",
  description: "Free hexadecimal arithmetic calculator. Advanced math and computation tool.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["hexadecimal arithmetic calculator", "math calculator", "computation tool"],
  variants: [{
    id: "standard",
    name: "Hexadecimal Arithmetic",
    description: "",
    fields: [
  ...
  faq: [
    { question: "What is hexadecimal arithmetic?", answer: "A mathematical concept used in computation and analysis. This calculator helps you solve related problems." },
