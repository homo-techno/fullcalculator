...
export const centrifugalForceCalculator: CalculatorDefinition = {
  slug: "centrifugal-force-calculator",
  title: "Centrifugal Force Calculator",
  description: "Free centrifugal force calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["centrifugal force calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Centrifugal Force",
      description: "Calculate centrifugal force",
      fields: [
        {
          name: "v1",
          label: "Value 1",
  ...
  faq: [
    { question: "How does the centrifugal force calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
