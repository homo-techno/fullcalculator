...
export const freelanceIncomeTaxCalculator: CalculatorDefinition = {
  slug: "freelance-income-tax-calculator",
  title: "Freelance Income Tax Calculator",
  description: "Free freelance income tax calculator. Quickly calculate and plan your freelance income tax needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["freelance income tax calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Freelance Income Tax",
      description: "Free freelance income tax calculator. Quickly calculate and plan your freelance ",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the freelance income tax work?",
