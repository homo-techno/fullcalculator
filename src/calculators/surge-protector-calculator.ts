...
export const surgeProtectorCalculator: CalculatorDefinition = {
  slug: "surge-protector-calculator",
  title: "Surge Protector Calculator",
  description: "Free surge protector calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["surge protector calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate surge protector costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does surge protector cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
