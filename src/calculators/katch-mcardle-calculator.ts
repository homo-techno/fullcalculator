...
export const katchMcardleCalculator: CalculatorDefinition = {
  slug: "katch-mcardle-calculator",
  title: "Katch Mcardle Calculator",
  description: "Free katch mcardle calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["katch mcardle calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Katch Mcardle",
      description: "Calculate katch mcardle",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the katch mcardle calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
