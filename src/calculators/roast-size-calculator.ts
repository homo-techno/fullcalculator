...
export const roastSizeCalculator: CalculatorDefinition = {
  slug: "roast-size-calculator",
  title: "Roast Size Calculator",
  description: "Free roast size calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["roast size calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Roast Size",
      description: "Calculate roast size",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the roast size calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
