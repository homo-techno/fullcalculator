...
export const aquariumWaterVolumeCalculator: CalculatorDefinition = {
  slug: "aquarium-water-volume-calculator",
  title: "Aquarium Water Volume Calculator",
  description: "Free aquarium water volume calculator. Aquarium planning and maintenance calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["aquarium water volume calculator", "aquarium calculator", "fishkeeping tool"],
  variants: [{
    id: "standard",
    name: "Aquarium Water Volume",
