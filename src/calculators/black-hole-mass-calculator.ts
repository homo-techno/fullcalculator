...
export const blackHoleMassCalculator: CalculatorDefinition = {
  slug: "black-hole-mass-calculator",
  title: "Black Hole Mass Calculator",
  description: "Free black hole mass calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["black hole mass calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Black Hole Mass",
      description: "Calculate black hole mass",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the black hole mass calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
