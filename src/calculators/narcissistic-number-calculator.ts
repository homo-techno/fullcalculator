...
export const narcissisticNumberCalculator: CalculatorDefinition = {
  slug: "narcissistic-number-calculator",
  title: "Narcissistic Number Calculator",
  description: "Free narcissistic number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["narcissistic number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Narcissistic Number",
      description: "Calculate narcissistic number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the narcissistic number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
