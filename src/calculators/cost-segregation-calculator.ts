...
export const costSegregationCalculator: CalculatorDefinition = {
  slug: "cost-segregation-calculator",
  title: "Cost Segregation Calculator",
  description: "Free cost segregation calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["cost segregation calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cost Segregation",
      description: "Calculate cost segregation",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the cost segregation calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
