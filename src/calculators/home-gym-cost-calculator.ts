...
export const homeGymCostCalculator: CalculatorDefinition = {
  slug: "home-gym-cost-calculator",
  title: "Home Gym Cost Calculator",
  description: "Free home gym cost calculator. Quickly calculate and plan your home gym cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["home gym cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Home Gym Cost",
      description: "Free home gym cost calculator. Quickly calculate and plan your home gym cost nee",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the home gym cost work?",
