...
export const lucasNumberCalculator: CalculatorDefinition = {
  slug: "lucas-number-calculator",
  title: "Lucas Number Calculator",
  description: "Free lucas number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["lucas number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Lucas Number",
      description: "Calculate lucas number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the lucas number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
