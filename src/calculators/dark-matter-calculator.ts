...
export const darkMatterCalculator: CalculatorDefinition = {
  slug: "dark-matter-calculator",
  title: "Dark Matter Calculator",
  description: "Free dark matter calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["dark matter calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Dark Matter",
      description: "Calculate dark matter",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the dark matter calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
