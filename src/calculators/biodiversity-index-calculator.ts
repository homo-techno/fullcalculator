...
export const biodiversityIndexCalculator: CalculatorDefinition = {
  slug: "biodiversity-index-calculator",
  title: "Biodiversity Index Calculator",
  description: "Free biodiversity index calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["biodiversity index calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "What is biodiversity index?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
