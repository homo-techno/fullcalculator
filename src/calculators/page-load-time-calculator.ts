...
export const pageLoadTimeCalculator: CalculatorDefinition = {
  slug: "page-load-time-calculator",
  title: "Page Load Time Calculator",
  description: "Free page load time calculator. Quickly calculate and plan your page load time needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["page load time calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Page Load Time",
      description: "Free page load time calculator. Quickly calculate and plan your page load time n",
      fields: [
        {
          name: "duration",
  ...
  faq: [
    {
      question: "How does the page load time work?",
