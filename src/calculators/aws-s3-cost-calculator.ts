...
export const awsS3CostCalculator: CalculatorDefinition = {
  slug: "aws-s3-cost-calculator",
  title: "Aws S3 Cost Calculator",
  description: "Free aws s3 cost calculator. Quickly calculate and plan your aws s3 cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["aws s3 cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Aws S3 Cost",
  ...
  faq: [
    {
      question: "How does the aws s3 cost work?",
