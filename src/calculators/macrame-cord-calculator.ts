...
export const macrameCordCalculator: CalculatorDefinition = {
  slug: "macrame-cord-calculator",
  title: "Macrame Cord Calculator",
  description: "Free macrame cord calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["macrame cord calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Macrame Cord",
