...
export const boatTrailerCalculator: CalculatorDefinition = {
  slug: "boat-trailer-calculator",
  title: "Boat Trailer Calculator",
  description: "Free boat trailer calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["boat trailer calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Boat Trailer",
    description: "",
