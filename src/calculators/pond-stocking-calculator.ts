...
export const pondStockingCalculator: CalculatorDefinition = {
  slug: "pond-stocking-calculator",
  title: "Pond Stocking Calculator",
  description: "Free pond stocking calculator. Calculate fish stocking rates",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pond stocking calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Pond Stocking",
    description: "Calculate fish stocking rates",
    fields: [
