...
export const cattleWeightCalculator: CalculatorDefinition = {
  slug: "cattle-weight-calculator",
  title: "Cattle Weight Calculator",
  description: "Free cattle weight calculator. Estimate cattle weight by measurements",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cattle weight calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Cattle Weight",
    description: "Estimate cattle weight by measurements",
    fields: [
