...
export const plankTestCalculator: CalculatorDefinition = {
  slug: "plank-test-calculator",
  title: "Plank Test Calculator",
  description: "Free plank test calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["plank test calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Plank Test",
      description: "Calculate plank test",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the plank test calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
