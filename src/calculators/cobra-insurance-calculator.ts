...
export const cobraInsuranceCalculator: CalculatorDefinition = {
  slug: "cobra-insurance-calculator",
  title: "Cobra Insurance Calculator",
  description: "Free cobra insurance calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["cobra insurance calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
