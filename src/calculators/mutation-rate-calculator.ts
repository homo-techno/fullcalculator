...
export const mutationRateCalculator: CalculatorDefinition = {
  slug: "mutation-rate-calculator",
  title: "Mutation Rate Calculator",
  description: "Free mutation rate calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["mutation rate calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
    name: "Mutation Rate",
    description: "",
  ...
  faq: [
    { question: "What is mutation rate?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
