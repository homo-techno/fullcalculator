...
export const snowRemovalCostCalculator: CalculatorDefinition = {
  slug: "snow-removal-cost-calculator",
  title: "Snow Removal Cost Calculator",
  description: "Free snow removal cost calculator. Quickly calculate and plan your snow removal cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["snow removal cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Snow Removal Cost",
      description: "Free snow removal cost calculator. Quickly calculate and plan your snow removal ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the snow removal cost work?",
