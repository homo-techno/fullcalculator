...
export const uniformDistributionCalculator: CalculatorDefinition = {
  slug: "uniform-distribution-calculator",
  title: "Uniform Distribution Calculator",
  description: "Free uniform distribution calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["uniform distribution calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Uniform Distribution",
      description: "Calculate uniform distribution",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the uniform distribution calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
