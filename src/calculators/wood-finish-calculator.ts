...
export const woodFinishCalculator: CalculatorDefinition = {
  slug: "wood-finish-calculator",
  title: "Wood Finish Calculator",
  description: "Free wood finish calculator. Woodworking planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["wood finish calculator", "woodworking calculator", "carpentry tool"],
  variants: [{
    id: "standard",
    name: "Wood Finish",
