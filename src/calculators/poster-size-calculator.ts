...
export const posterSizeCalculator: CalculatorDefinition = {
  slug: "poster-size-calculator",
  title: "Poster Size Calculator",
  description: "Free poster size calculator. Convert and calculate poster size values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["poster size calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Poster Size",
  ...
  faq: [
    {
      question: "How does poster size conversion work?",
