...
export const eventBudgetCalculator: CalculatorDefinition = {
  slug: "event-budget-calculator",
  title: "Event Budget Calculator",
  description: "Free event budget calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["event budget calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate event budget costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does event budget cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
