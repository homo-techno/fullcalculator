...
export const paperUsageCalculator: CalculatorDefinition = {
  slug: "paper-usage-calculator",
  title: "Paper Usage Calculator",
  description: "Free paper usage calculator. Quickly calculate and plan your paper usage needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["paper usage calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Paper Usage",
  ...
  faq: [
    {
      question: "How does the paper usage work?",
