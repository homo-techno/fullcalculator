...
export const cosmicDistanceLadderCalculator: CalculatorDefinition = {
  slug: "cosmic-distance-ladder-calculator",
  title: "Cosmic Distance Ladder Calculator",
  description: "Free cosmic distance ladder calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["cosmic distance ladder calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cosmic Distance Ladder",
      description: "Calculate cosmic distance ladder",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the cosmic distance ladder calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
