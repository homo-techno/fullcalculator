...
export const catFoodCostCalculator: CalculatorDefinition = {
  slug: "cat-food-cost-calculator",
  title: "Cat Food Cost Calculator",
  description: "Free cat food cost calculator. Quickly calculate and plan your cat food cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cat food cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Cat Food Cost",
      description: "Free cat food cost calculator. Quickly calculate and plan your cat food cost nee",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the cat food cost work?",
