...
export const icosahedronCalculator: CalculatorDefinition = {
  slug: "icosahedron-calculator",
  title: "Icosahedron Calculator",
  description: "Free icosahedron calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["icosahedron calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Icosahedron",
      description: "Calculate icosahedron",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the icosahedron calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
