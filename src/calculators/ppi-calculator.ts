...
export const ppiCalculator: CalculatorDefinition = {
  slug: "ppi-calculator",
  title: "Ppi Calculator",
  description: "Free ppi calculator. Convert and calculate ppi values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["ppi calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Ppi",
  ...
  faq: [
    {
      question: "How does ppi conversion work?",
