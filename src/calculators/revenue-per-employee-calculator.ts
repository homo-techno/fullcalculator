...
export const revenuePerEmployeeCalculator: CalculatorDefinition = {
  slug: "revenue-per-employee-calculator",
  title: "Revenue Per Employee Calculator",
  description: "Free revenue per employee calculator. Quickly calculate and plan your revenue per employee needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["revenue per employee calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Revenue Per Employee",
      description: "Free revenue per employee calculator. Quickly calculate and plan your revenue pe",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the revenue per employee work?",
