...
export const windowCleaningCostCalculator: CalculatorDefinition = {
  slug: "window-cleaning-cost-calculator",
  title: "Window Cleaning Cost Calculator",
  description: "Free window cleaning cost calculator. Quickly calculate and plan your window cleaning cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["window cleaning cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Window Cleaning Cost",
      description: "Free window cleaning cost calculator. Quickly calculate and plan your window cle",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the window cleaning cost work?",
