...
export const fondantCalculator: CalculatorDefinition = {
  slug: "fondant-calculator",
  title: "Fondant Calculator",
  description: "Free fondant calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["fondant calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Fondant",
      description: "Calculate fondant",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the fondant calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
