...
export const djCostCalculator: CalculatorDefinition = {
  slug: "dj-cost-calculator",
  title: "Dj Cost Calculator",
  description: "Free dj cost calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["dj cost calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate dj cost costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does dj cost cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
