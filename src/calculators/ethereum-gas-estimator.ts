...
export const ethereumGasEstimatorCalculator: CalculatorDefinition = {
  slug: "ethereum-gas-estimator",
  title: "Ethereum Gas Estimator",
  description: "Free ethereum gas estimator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["ethereum gas estimator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Ethereum Gas Estimator",
      description: "Calculate ethereum gas estimator",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the ethereum gas estimator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
