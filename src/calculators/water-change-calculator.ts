...
export const waterChangeCalculator: CalculatorDefinition = {
  slug: "water-change-calculator",
  title: "Water Change Calculator",
  description: "Free water change calculator. Aquarium planning and maintenance calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["water change calculator", "aquarium calculator", "fishkeeping tool"],
  variants: [{
    id: "standard",
    name: "Water Change",
