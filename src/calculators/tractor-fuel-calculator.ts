...
export const tractorFuelCalculator: CalculatorDefinition = {
  slug: "tractor-fuel-calculator",
  title: "Tractor Fuel Calculator",
  description: "Free tractor fuel calculator. Calculate tractor fuel consumption",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tractor fuel calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Tractor Fuel",
    description: "Calculate tractor fuel consumption",
    fields: [
