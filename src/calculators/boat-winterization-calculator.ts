...
export const boatWinterizationCalculator: CalculatorDefinition = {
  slug: "boat-winterization-calculator",
  title: "Boat Winterization Calculator",
  description: "Free boat winterization calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["boat winterization calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
