...
export const carbonTaxCalculator: CalculatorDefinition = {
  slug: "carbon-tax-calculator",
  title: "Carbon Tax Calculator",
  description: "Free carbon tax calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["carbon tax calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Carbon Tax",
      description: "Calculate carbon tax",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the carbon tax calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
