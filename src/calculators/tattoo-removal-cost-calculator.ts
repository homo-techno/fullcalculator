...
export const tattooRemovalCostCalculator: CalculatorDefinition = {
  slug: "tattoo-removal-cost-calculator",
  title: "Tattoo Removal Cost Calculator",
  description: "Free tattoo removal cost calculator. Estimate laser removal costs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo removal cost calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Removal Cost",
    description: "Estimate laser removal costs",
    fields: [
