...
export const houseHackingCalculator: CalculatorDefinition = {
  slug: "house-hacking-calculator",
  title: "House Hacking Calculator",
  description: "Free house hacking calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["house hacking calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "House Hacking",
      description: "Free house hacking calculator. Plan your finances with accurate calculations and",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the House Hacking Calculator calculate?",
      answer: "This calculator helps you estimate house hacking based on your specific financial situation and inputs.",
    },
    {
