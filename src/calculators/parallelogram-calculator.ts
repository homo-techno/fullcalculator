...
export const parallelogramCalculator: CalculatorDefinition = {
  slug: "parallelogram-calculator",
  title: "Parallelogram Calculator",
  description: "Free parallelogram calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["parallelogram calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Parallelogram",
      description: "Calculate parallelogram",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the parallelogram calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
