...
export const decibelAdditionCalculator: CalculatorDefinition = {
  slug: "decibel-addition-calculator",
  title: "Decibel Addition Calculator",
  description: "Free decibel addition calculator. Add sound levels in decibels",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["decibel addition calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Decibel Addition",
    description: "Add sound levels in decibels",
    fields: [
