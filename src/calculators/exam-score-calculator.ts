...
export const examScoreCalculator: CalculatorDefinition = {
  slug: "exam-score-calculator",
  title: "Exam Score Calculator",
  description: "Free exam score calculator. Academic planning and education cost tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["exam score calculator", "education calculator", "student tool"],
  variants: [{
    id: "standard",
    name: "Exam Score",
    description: "",
