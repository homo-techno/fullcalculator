...
export const gamingChairSizeCalculator: CalculatorDefinition = {
  slug: "gaming-chair-size-calculator",
  title: "Gaming Chair Size Calculator",
  description: "Free gaming chair size calculator. Find your ideal gaming chair",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["gaming chair size calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "Gaming Chair Size",
    description: "Find your ideal gaming chair",
    fields: [
