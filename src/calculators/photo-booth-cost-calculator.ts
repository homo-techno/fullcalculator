...
export const photoBoothCostCalculator: CalculatorDefinition = {
  slug: "photo-booth-cost-calculator",
  title: "Photo Booth Cost Calculator",
  description: "Free photo booth cost calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["photo booth cost calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate photo booth cost costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does photo booth cost cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
