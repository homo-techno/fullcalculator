...
export const hypergeometricCalculator: CalculatorDefinition = {
  slug: "hypergeometric-calculator",
  title: "Hypergeometric Calculator",
  description: "Free hypergeometric calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["hypergeometric calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Hypergeometric",
      description: "Calculate hypergeometric",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the hypergeometric calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
