...
export const abundantNumberCalculator: CalculatorDefinition = {
  slug: "abundant-number-calculator",
  title: "Abundant Number Calculator",
  description: "Free abundant number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["abundant number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Abundant Number",
      description: "Calculate abundant number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the abundant number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
