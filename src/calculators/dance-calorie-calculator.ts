...
export const danceCalorieCalculator: CalculatorDefinition = {
  slug: "dance-calorie-calculator",
  title: "Dance Calorie Calculator",
  description: "Free dance calorie calculator. Calculate calories burned during dance based on your weight and duration.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["dance calorie calculator", "calories burned", "exercise calculator"],
  variants: [
    {
      id: "standard",
      name: "Calories Burned",
      description: "Calculate calories burned during dance",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How many calories does dance burn?",
      answer: "A 70kg person burns approximately 193 calories in 30 minutes of moderate dance.",
    },
    {
