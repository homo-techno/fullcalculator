...
export const sprayFoamCalculator: CalculatorDefinition = {
  slug: "spray-foam-calculator",
  title: "Spray Foam Calculator",
  description: "Free spray foam calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["spray foam calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate spray foam costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does spray foam cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
