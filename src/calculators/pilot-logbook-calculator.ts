...
export const pilotLogbookCalculator: CalculatorDefinition = {
  slug: "pilot-logbook-calculator",
  title: "Pilot Logbook Calculator",
  description: "Free pilot logbook calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["pilot logbook calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
    name: "Pilot Logbook",
