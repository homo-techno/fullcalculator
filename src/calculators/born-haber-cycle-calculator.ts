...
export const bornHaberCycleCalculator: CalculatorDefinition = {
  slug: "born-haber-cycle-calculator",
  title: "Born Haber Cycle Calculator",
  description: "Free born haber cycle calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["born haber cycle calculator", "chemistry calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Born Haber Cycle",
      description: "Calculate born haber cycle",
      fields: [
        {
          name: "mass",
          label: "Mass / Amount",
  ...
  faq: [
    { question: "How does the born haber cycle calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
