...
export const anovaCalculator: CalculatorDefinition = {
  slug: "anova-calculator",
  title: "Anova Calculator",
  description: "Free anova calculator. Solve anova problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["anova calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Anova",
  ...
  faq: [
    {
      ...
      answer: "Anova is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
