...
export const dataBreachRiskCalculator: CalculatorDefinition = {
  slug: "data-breach-risk-calculator",
  title: "Data Breach Risk Calculator",
  description: "Free data breach risk calculator. Quickly calculate and plan your data breach risk needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["data breach risk calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Data Breach Risk",
      description: "Free data breach risk calculator. Quickly calculate and plan your data breach ri",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the data breach risk work?",
