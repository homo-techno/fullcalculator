...
export const mriCostCalculator: CalculatorDefinition = {
  slug: "mri-cost-calculator",
  title: "Mri Cost Calculator",
  description: "Free mri cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["mri cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Mri Cost",
  ...
  faq: [
    { question: "How much does mri cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
