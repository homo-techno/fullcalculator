...
export const biotinCalculator: CalculatorDefinition = {
  slug: "biotin-calculator",
  title: "Biotin Calculator",
  description: "Free biotin calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["biotin calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Biotin",
      description: "Calculate biotin",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the biotin calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
