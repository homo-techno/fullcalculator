...
export const vennDiagramCalculator: CalculatorDefinition = {
  slug: "venn-diagram-calculator",
  title: "Venn Diagram Calculator",
  description: "Free venn diagram calculator. Advanced math and computation tool.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["venn diagram calculator", "math calculator", "computation tool"],
  variants: [{
    id: "standard",
    name: "Venn Diagram",
    description: "",
  ...
  faq: [
    { question: "What is venn diagram?", answer: "A mathematical concept used in computation and analysis. This calculator helps you solve related problems." },
