...
export const espressoDoseCalculator: CalculatorDefinition = {
  slug: "espresso-dose-calculator",
  title: "Espresso Dose Calculator",
  description: "Free espresso dose calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["espresso dose calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Espresso Dose",
      description: "Calculate espresso dose",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the espresso dose calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
