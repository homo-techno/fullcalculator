...
export const salaryNegotiationCalculator: CalculatorDefinition = {
  slug: "salary-negotiation-calculator",
  title: "Salary Negotiation Calculator",
  description: "Free salary negotiation calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["salary negotiation calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Salary Negotiation",
      description: "Free salary negotiation calculator. Plan your finances with accurate calculation",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Salary Negotiation Calculator calculate?",
      answer: "This calculator helps you estimate salary negotiation based on your specific financial situation and inputs.",
    },
    {
