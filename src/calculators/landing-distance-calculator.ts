...
export const landingDistanceCalculator: CalculatorDefinition = {
  slug: "landing-distance-calculator",
  title: "Landing Distance Calculator",
  description: "Free landing distance calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["landing distance calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
