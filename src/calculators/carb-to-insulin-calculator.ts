...
export const carbToInsulinCalculator: CalculatorDefinition = {
  slug: "carb-to-insulin-calculator",
  title: "Carb To Insulin Calculator",
  description: "Free carb to insulin calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["carb to insulin calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Carb To Insulin",
      description: "Free carb to insulin calculator. Get personalized health insights based on your ",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the carb to insulin work?",
