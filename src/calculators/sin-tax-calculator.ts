...
export const sinTaxCalculator: CalculatorDefinition = {
  slug: "sin-tax-calculator",
  title: "Sin Tax Calculator",
  description: "Free sin tax calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["sin tax calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Sin Tax",
      description: "Calculate sin tax",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the sin tax calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
