...
export const snowboardingCalorieCalculator: CalculatorDefinition = {
  slug: "snowboarding-calorie-calculator",
  title: "Snowboarding Calorie Calculator",
  description: "Free snowboarding calorie calculator. Calculate calories burned during snowboarding based on your weight and duration.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["snowboarding calorie calculator", "calories burned", "exercise calculator"],
  variants: [
    {
      id: "standard",
      name: "Calories Burned",
      description: "Calculate calories burned during snowboarding",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How many calories does snowboarding burn?",
      answer: "A 70kg person burns approximately 186 calories in 30 minutes of moderate snowboarding.",
    },
    {
