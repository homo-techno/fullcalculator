...
export const awsEc2CostCalculator: CalculatorDefinition = {
  slug: "aws-ec2-cost-calculator",
  title: "Aws Ec2 Cost Calculator",
  description: "Free aws ec2 cost calculator. Quickly calculate and plan your aws ec2 cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["aws ec2 cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Aws Ec2 Cost",
  ...
  faq: [
    {
      question: "How does the aws ec2 cost work?",
