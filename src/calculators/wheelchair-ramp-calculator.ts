...
export const wheelchairRampCalculator: CalculatorDefinition = {
  slug: "wheelchair-ramp-calculator",
  title: "Wheelchair Ramp Calculator",
  description: "Free wheelchair ramp calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["wheelchair ramp calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Wheelchair Ramp",
      description: "Free wheelchair ramp calculator. Get personalized health insights based on your ",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the wheelchair ramp work?",
