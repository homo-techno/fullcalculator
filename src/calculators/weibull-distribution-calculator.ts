...
export const weibullDistributionCalculator: CalculatorDefinition = {
  slug: "weibull-distribution-calculator",
  title: "Weibull Distribution Calculator",
  description: "Free weibull distribution calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["weibull distribution calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Weibull Distribution",
      description: "Calculate weibull distribution",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the weibull distribution calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
