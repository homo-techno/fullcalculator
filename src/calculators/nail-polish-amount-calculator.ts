...
export const nailPolishAmountCalculator: CalculatorDefinition = {
  slug: "nail-polish-amount-calculator",
  title: "Nail Polish Amount Calculator",
  description: "Free nail polish amount calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["nail polish amount calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
    name: "Nail Polish Amount",
    description: "",
    fields: [
  ...
  faq: [
    { question: "How much does nail polish amount cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
