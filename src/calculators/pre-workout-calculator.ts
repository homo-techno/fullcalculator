...
export const preWorkoutCalculator: CalculatorDefinition = {
  slug: "pre-workout-calculator",
  title: "Pre Workout Calculator",
  description: "Free pre workout calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["pre workout calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Pre Workout",
      description: "Calculate pre workout",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the pre workout calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
