...
export const stlScalingCalculator: CalculatorDefinition = {
  slug: "stl-scaling-calculator",
  title: "Stl Scaling Calculator",
  description: "Free stl scaling calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["stl scaling calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
    name: "Stl Scaling",
