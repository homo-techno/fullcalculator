...
export const waterFilterCalculator: CalculatorDefinition = {
  slug: "water-filter-calculator",
  title: "Water Filter Calculator",
  description: "Free water filter calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["water filter calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate water filter costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does water filter cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
