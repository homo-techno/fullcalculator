...
export const fishOilCalculator: CalculatorDefinition = {
  slug: "fish-oil-calculator",
  title: "Fish Oil Calculator",
  description: "Free fish oil calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["fish oil calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Fish Oil",
      description: "Calculate fish oil",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the fish oil calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
