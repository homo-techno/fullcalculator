...
export const marketShareCalculator: CalculatorDefinition = {
  slug: "market-share-calculator",
  title: "Market Share Calculator",
  description: "Free market share calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["market share calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Market Share",
  ...
  faq: [
    { question: "How does the market share calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
