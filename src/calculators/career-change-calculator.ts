...
export const careerChangeCalculator: CalculatorDefinition = {
  slug: "career-change-calculator",
  title: "Career Change Calculator",
  description: "Free career change calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["career change calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Career Change",
      description: "Calculate career change",
      fields: [
        {
          name: "salary",
          label: "Annual Salary",
  ...
  faq: [
    { question: "How does the career change calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
