...
export const discretionaryIncomeCalculator: CalculatorDefinition = {
  slug: "discretionary-income-calculator",
  title: "Discretionary Income Calculator",
  description: "Free discretionary income calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["discretionary income calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Discretionary Income",
      description: "Calculate discretionary income",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the discretionary income calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
