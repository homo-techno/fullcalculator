...
export const osmosisCalculator: CalculatorDefinition = {
  slug: "osmosis-calculator",
  title: "Osmosis Calculator",
  description: "Free osmosis calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["osmosis calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
    name: "Osmosis",
    description: "",
  ...
  faq: [
    { question: "What is osmosis?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
