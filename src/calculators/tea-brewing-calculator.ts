...
export const teaBrewingCalculator: CalculatorDefinition = {
  slug: "tea-brewing-calculator",
  title: "Tea Brewing Calculator",
  description: "Free tea brewing calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tea brewing calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Tea Brewing",
      description: "Calculate tea brewing",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the tea brewing calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
