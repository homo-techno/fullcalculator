...
export const hamSizeCalculator: CalculatorDefinition = {
  slug: "ham-size-calculator",
  title: "Ham Size Calculator",
  description: "Free ham size calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["ham size calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Ham Size",
      description: "Calculate ham size",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the ham size calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
