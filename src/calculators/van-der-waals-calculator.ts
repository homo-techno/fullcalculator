...
export const vanDerWaalsCalculator: CalculatorDefinition = {
  slug: "van-der-waals-calculator",
  title: "Van Der Waals Calculator",
  description: "Free van der waals calculator. Calculate van der waals values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["van der waals calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Van Der Waals",
      description: "Free van der waals calculator. Calculate van der waals values for research and e",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Van Der Waals?",
      answer: "Van Der Waals is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
