...
export const seatingArrangementCalculator: CalculatorDefinition = {
  slug: "seating-arrangement-calculator",
  title: "Seating Arrangement Calculator",
  description: "Free seating arrangement calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["seating arrangement calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate seating arrangement costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does seating arrangement cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
