...
export const postWorkoutNutritionCalculator: CalculatorDefinition = {
  slug: "post-workout-nutrition-calculator",
  title: "Post Workout Nutrition Calculator",
  description: "Free post workout nutrition calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["post workout nutrition calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Post Workout Nutrition",
      description: "Calculate post workout nutrition",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the post workout nutrition calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
