...
export const debtSnowballMethodCalculator: CalculatorDefinition = {
  slug: "debt-snowball-method-calculator",
  title: "Debt Snowball Method Calculator",
  description: "Free debt snowball method calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["debt snowball method calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Debt Snowball Method",
      description: "Calculate debt snowball method",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the debt snowball method calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
