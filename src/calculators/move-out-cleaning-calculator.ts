...
export const moveOutCleaningCalculator: CalculatorDefinition = {
  slug: "move-out-cleaning-calculator",
  title: "Move Out Cleaning Calculator",
  description: "Free move out cleaning calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["move out cleaning calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
