...
export const cleaningSupplyCalculator: CalculatorDefinition = {
  slug: "cleaning-supply-calculator",
  title: "Cleaning Supply Calculator",
  description: "Free cleaning supply calculator. Quickly calculate and plan your cleaning supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cleaning supply calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Cleaning Supply",
      description: "Free cleaning supply calculator. Quickly calculate and plan your cleaning supply",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the cleaning supply work?",
