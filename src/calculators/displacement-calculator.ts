...
export const displacementCalculator: CalculatorDefinition = {
  slug: "displacement-calculator",
  title: "Displacement Calculator",
  description: "Free displacement calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["displacement calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Displacement",
    description: "",
