...
export const officeCleaningCalculator: CalculatorDefinition = {
  slug: "office-cleaning-calculator",
  title: "Office Cleaning Calculator",
  description: "Free office cleaning calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["office cleaning calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
