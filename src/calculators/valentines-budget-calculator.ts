...
export const valentinesBudgetCalculator: CalculatorDefinition = {
  slug: "valentines-budget-calculator",
  title: "Valentines Budget Calculator",
  description: "Free valentines budget calculator. Quickly calculate and plan your valentines budget needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["valentines budget calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Valentines Budget",
      description: "Free valentines budget calculator. Quickly calculate and plan your valentines bu",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the valentines budget work?",
