...
export const shearStressCalculator: CalculatorDefinition = {
  slug: "shear-stress-calculator",
  title: "Shear Stress Calculator",
  description: "Free shear stress calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["shear stress calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Shear Stress",
  ...
  faq: [
    { question: "How does the shear stress calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
