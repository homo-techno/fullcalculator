...
export const benchPressMaxCalculator: CalculatorDefinition = {
  slug: "bench-press-max-calculator",
  title: "Bench Press Max Calculator",
  description: "Free bench press max calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["bench press max calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Bench Press Max",
      description: "Calculate bench press max",
      fields: [
        {
          name: "weight",
          label: "Weight Lifted",
  ...
  faq: [
    { question: "How does the bench press max calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
