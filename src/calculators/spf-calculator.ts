...
export const spfCalculator: CalculatorDefinition = {
  slug: "spf-calculator",
  title: "Spf Calculator",
  description: "Free spf calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["spf calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Spf",
  ...
  faq: [
    {
      question: "How does the spf work?",
