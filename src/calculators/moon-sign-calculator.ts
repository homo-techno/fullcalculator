...
export const moonSignCalculator: CalculatorDefinition = {
  slug: "moon-sign-calculator",
  title: "Moon Sign Calculator",
  description: "Free moon sign calculator. Determine your moon sign",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["moon sign calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Moon Sign",
    description: "Determine your moon sign",
    fields: [
