...
export const fuelInjectorSizeCalculator: CalculatorDefinition = {
  slug: "fuel-injector-size-calculator",
  title: "Fuel Injector Size Calculator",
  description: "Free fuel injector size calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["fuel injector size calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
    name: "Fuel Injector Size",
    description: "",
    fields: [
