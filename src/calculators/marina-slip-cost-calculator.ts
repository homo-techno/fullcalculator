...
export const marinaSlipCostCalculator: CalculatorDefinition = {
  slug: "marina-slip-cost-calculator",
  title: "Marina Slip Cost Calculator",
  description: "Free marina slip cost calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["marina slip cost calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Marina Slip Cost",
    description: "",
    fields: [
