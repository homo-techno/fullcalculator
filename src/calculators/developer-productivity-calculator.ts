...
export const developerProductivityCalculator: CalculatorDefinition = {
  slug: "developer-productivity-calculator",
  title: "Developer Productivity Calculator",
  description: "Free developer productivity calculator. Quickly calculate and plan your developer productivity needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["developer productivity calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Developer Productivity",
      description: "Free developer productivity calculator. Quickly calculate and plan your develope",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the developer productivity work?",
