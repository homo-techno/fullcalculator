...
export const holidayBudgetCalculator: CalculatorDefinition = {
  slug: "holiday-budget-calculator",
  title: "Holiday Budget Calculator",
  description: "Free holiday budget calculator. Quickly calculate and plan your holiday budget needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["holiday budget calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Holiday Budget",
      description: "Free holiday budget calculator. Quickly calculate and plan your holiday budget n",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the holiday budget work?",
