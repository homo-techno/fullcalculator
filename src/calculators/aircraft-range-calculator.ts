...
export const aircraftRangeCalculator: CalculatorDefinition = {
  slug: "aircraft-range-calculator",
  title: "Aircraft Range Calculator",
  description: "Free aircraft range calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["aircraft range calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
    name: "Aircraft Range",
