...
export const pentagonCalculator: CalculatorDefinition = {
  slug: "pentagon-calculator",
  title: "Pentagon Calculator",
  description: "Free pentagon calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["pentagon calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Pentagon",
      description: "Calculate pentagon",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the pentagon calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
