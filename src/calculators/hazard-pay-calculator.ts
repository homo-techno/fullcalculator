...
export const hazardPayCalculator: CalculatorDefinition = {
  slug: "hazard-pay-calculator",
  title: "Hazard Pay Calculator",
  description: "Free hazard pay calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hazard pay calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Hazard Pay",
      description: "Calculate hazard pay",
      fields: [
        {
          name: "salary",
          label: "Annual Salary",
  ...
  faq: [
    { question: "How does the hazard pay calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
