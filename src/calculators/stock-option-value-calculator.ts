...
export const stockOptionValueCalculator: CalculatorDefinition = {
  slug: "stock-option-value-calculator",
  title: "Stock Option Value Calculator",
  description: "Free stock option value calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["stock option value calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Stock Option Value",
      description: "Free stock option value calculator. Plan your finances with accurate calculation",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Stock Option Value Calculator calculate?",
      answer: "This calculator helps you estimate stock option value based on your specific financial situation and inputs.",
    },
    {
