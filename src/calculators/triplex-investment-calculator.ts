...
export const triplexInvestmentCalculator: CalculatorDefinition = {
  slug: "triplex-investment-calculator",
  title: "Triplex Investment Calculator",
  description: "Free triplex investment calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["triplex investment calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Triplex Investment",
      description: "Calculate triplex investment",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the triplex investment calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
