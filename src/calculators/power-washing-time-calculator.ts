...
export const powerWashingTimeCalculator: CalculatorDefinition = {
  slug: "power-washing-time-calculator",
  title: "Power Washing Time Calculator",
  description: "Free power washing time calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["power washing time calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
    name: "Power Washing Time",
    description: "",
    fields: [
