...
export const passportRenewalCalculator: CalculatorDefinition = {
  slug: "passport-renewal-calculator",
  title: "Passport Renewal Calculator",
  description: "Free passport renewal calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["passport renewal calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Passport Renewal",
      description: "Calculate passport renewal",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the passport renewal calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
