...
export const epoxyFloorCalculator: CalculatorDefinition = {
  slug: "epoxy-floor-calculator",
  title: "Epoxy Floor Calculator",
  description: "Free epoxy floor calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["epoxy floor calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate epoxy floor costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does epoxy floor cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
