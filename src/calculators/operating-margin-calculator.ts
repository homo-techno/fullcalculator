...
export const operatingMarginCalculator: CalculatorDefinition = {
  slug: "operating-margin-calculator",
  title: "Operating Margin Calculator",
  description: "Free operating margin calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["operating margin calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the operating margin calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
