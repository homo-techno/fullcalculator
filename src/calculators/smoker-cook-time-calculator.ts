...
export const smokerCookTimeCalculator: CalculatorDefinition = {
  slug: "smoker-cook-time-calculator",
  title: "Smoker Cook Time Calculator",
  description: "Free smoker cook time calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["smoker cook time calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Smoker Cook Time",
      description: "Calculate smoker cook time",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the smoker cook time calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
