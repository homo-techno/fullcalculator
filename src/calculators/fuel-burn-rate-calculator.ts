...
export const fuelBurnRateCalculator: CalculatorDefinition = {
  slug: "fuel-burn-rate-calculator",
  title: "Fuel Burn Rate Calculator",
  description: "Free fuel burn rate calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["fuel burn rate calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
    name: "Fuel Burn Rate",
