...
export const sumpPumpSizeCalculator: CalculatorDefinition = {
  slug: "sump-pump-size-calculator",
  title: "Sump Pump Size Calculator",
  description: "Free sump pump size calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["sump pump size calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate sump pump size costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does sump pump size cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
