...
export const franceVatCalculator: CalculatorDefinition = {
  slug: "france-vat-calculator",
  title: "France VAT Calculator",
  description: "Free France VAT calculator at 20%. Calculate VAT amount and total price including tax.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["france vat calculator", "france vat calculator", "france tax calculator"],
  variants: [{
    id: "standard",
    name: "France VAT",
    description: "Free France VAT calculator at 20%",
    fields: [
  ...
  faq: [
    { question: "What is the VAT rate in France?", answer: "The standard VAT rate in France is 20%." },
