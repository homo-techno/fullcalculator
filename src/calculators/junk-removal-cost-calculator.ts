...
export const junkRemovalCostCalculator: CalculatorDefinition = {
  slug: "junk-removal-cost-calculator",
  title: "Junk Removal Cost Calculator",
  description: "Free junk removal cost calculator. Quickly calculate and plan your junk removal cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["junk removal cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Junk Removal Cost",
      description: "Free junk removal cost calculator. Quickly calculate and plan your junk removal ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the junk removal cost work?",
