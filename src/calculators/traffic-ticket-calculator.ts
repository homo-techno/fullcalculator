...
export const trafficTicketCalculator: CalculatorDefinition = {
  slug: "traffic-ticket-calculator",
  title: "Traffic Ticket Calculator",
  description: "Free traffic ticket calculator. Estimate traffic violation fines",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["traffic ticket calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Traffic Ticket",
    description: "Estimate traffic violation fines",
    fields: [
