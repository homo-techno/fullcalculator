...
export const evVsGasCalculator: CalculatorDefinition = {
  slug: "ev-vs-gas-calculator",
  title: "Ev Vs Gas Calculator",
  description: "Free ev vs gas calculator. Calculate ev vs gas values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["ev vs gas calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Ev Vs Gas",
  ...
  faq: [
    {
      question: "What is Ev Vs Gas?",
      answer: "Ev Vs Gas is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
