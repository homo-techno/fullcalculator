...
export const dryCleaningCostCalculator: CalculatorDefinition = {
  slug: "dry-cleaning-cost-calculator",
  title: "Dry Cleaning Cost Calculator",
  description: "Free dry cleaning cost calculator. Quickly calculate and plan your dry cleaning cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["dry cleaning cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Dry Cleaning Cost",
      description: "Free dry cleaning cost calculator. Quickly calculate and plan your dry cleaning ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the dry cleaning cost work?",
