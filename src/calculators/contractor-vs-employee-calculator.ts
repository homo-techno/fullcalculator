...
export const contractorVsEmployeeCalculator: CalculatorDefinition = {
  ...
  description: "Free contractor vs employee calculator. Quickly calculate and plan your contractor vs employee needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["contractor vs employee calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Contractor Vs Employee",
      description: "Free contractor vs employee calculator. Quickly calculate and plan your contract",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the contractor vs employee work?",
