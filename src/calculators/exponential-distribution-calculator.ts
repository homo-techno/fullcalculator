...
export const exponentialDistributionCalculator: CalculatorDefinition = {
  slug: "exponential-distribution-calculator",
  title: "Exponential Distribution Calculator",
  description: "Free exponential distribution calculator. Solve exponential distribution problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["exponential distribution calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Exponential Distribution",
      description: "Free exponential distribution calculator. Solve exponential distribution problem",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Exponential Distribution?",
      answer: "Exponential Distribution is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
