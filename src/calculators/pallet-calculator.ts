...
export const palletCalculator: CalculatorDefinition = {
  slug: "pallet-calculator",
  title: "Pallet Calculator",
  description: "Free pallet calculator. Quickly calculate and plan your pallet needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pallet calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Pallet",
  ...
  faq: [
    {
      question: "How does the pallet work?",
