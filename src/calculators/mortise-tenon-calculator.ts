...
export const mortiseTenonCalculator: CalculatorDefinition = {
  slug: "mortise-tenon-calculator",
  title: "Mortise Tenon Calculator",
  description: "Free mortise tenon calculator. Woodworking planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["mortise tenon calculator", "woodworking calculator", "carpentry tool"],
  variants: [{
    id: "standard",
    name: "Mortise Tenon",
