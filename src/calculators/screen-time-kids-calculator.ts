...
export const screenTimeKidsCalculator: CalculatorDefinition = {
  slug: "screen-time-kids-calculator",
  title: "Screen Time Kids Calculator",
  description: "Free screen time kids calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["screen time kids calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Screen Time Kids",
      description: "Calculate screen time kids",
      fields: [
        {
          name: "size",
          label: "Size / Weight",
  ...
  faq: [
    { question: "How does the screen time kids calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
