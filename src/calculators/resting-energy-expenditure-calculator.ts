...
export const restingEnergyExpenditureCalculator: CalculatorDefinition = {
  slug: "resting-energy-expenditure-calculator",
  title: "Resting Energy Expenditure Calculator",
  description: "Free resting energy expenditure calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["resting energy expenditure calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Resting Energy Expenditure",
      description: "Calculate resting energy expenditure",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the resting energy expenditure calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
