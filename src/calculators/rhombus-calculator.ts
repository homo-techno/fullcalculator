...
export const rhombusCalculator: CalculatorDefinition = {
  slug: "rhombus-calculator",
  title: "Rhombus Calculator",
  description: "Free rhombus calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["rhombus calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Rhombus",
      description: "Calculate rhombus",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the rhombus calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
