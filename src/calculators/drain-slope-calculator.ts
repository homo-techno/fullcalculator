...
export const drainSlopeCalculator: CalculatorDefinition = {
  slug: "drain-slope-calculator",
  title: "Drain Slope Calculator",
  description: "Free drain slope calculator. Plumbing sizing and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["drain slope calculator", "plumbing calculator", "sizing tool"],
  variants: [{
    id: "standard",
    name: "Drain Slope",
    description: "",
