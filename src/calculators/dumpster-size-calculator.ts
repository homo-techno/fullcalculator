...
export const dumpsterSizeCalculator: CalculatorDefinition = {
  slug: "dumpster-size-calculator",
  title: "Dumpster Size Calculator",
  description: "Free dumpster size calculator. Quickly calculate and plan your dumpster size needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["dumpster size calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Dumpster Size",
      description: "Free dumpster size calculator. Quickly calculate and plan your dumpster size nee",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the dumpster size work?",
