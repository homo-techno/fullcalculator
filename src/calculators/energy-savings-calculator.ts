...
export const energySavingsCalculator: CalculatorDefinition = {
  slug: "energy-savings-calculator",
  title: "Energy Savings Calculator",
  description: "Free energy savings calculator. Calculate energy savings values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["energy savings calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Energy Savings",
      description: "Free energy savings calculator. Calculate energy savings values for research and",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Energy Savings?",
      answer: "Energy Savings is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
