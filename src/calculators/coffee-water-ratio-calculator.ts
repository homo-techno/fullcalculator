...
export const coffeeWaterRatioCalculator: CalculatorDefinition = {
  slug: "coffee-water-ratio-calculator",
  title: "Coffee Water Ratio Calculator",
  description: "Free coffee water ratio calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["coffee water ratio calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Coffee Water Ratio",
      description: "Calculate coffee water ratio",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the coffee water ratio calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
