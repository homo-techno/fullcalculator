...
export const cryptoArbitrageCalculator: CalculatorDefinition = {
  slug: "crypto-arbitrage-calculator",
  title: "Crypto Arbitrage Calculator",
  description: "Free crypto arbitrage calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["crypto arbitrage calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Crypto Arbitrage",
      description: "Calculate crypto arbitrage",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the crypto arbitrage calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
