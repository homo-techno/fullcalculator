...
export const hvacSizingCalculator: CalculatorDefinition = {
  slug: "hvac-sizing-calculator",
  title: "Hvac Sizing Calculator",
  description: "Free hvac sizing calculator. Calculate hvac sizing values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["hvac sizing calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Hvac Sizing",
      description: "Free hvac sizing calculator. Calculate hvac sizing values for research and educa",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Hvac Sizing?",
      answer: "Hvac Sizing is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
