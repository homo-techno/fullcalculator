...
export const twinPrimeCalculator: CalculatorDefinition = {
  slug: "twin-prime-calculator",
  title: "Twin Prime Calculator",
  description: "Free twin prime calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["twin prime calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Twin Prime",
      description: "Calculate twin prime",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the twin prime calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
