...
export const storageIopsCalculator: CalculatorDefinition = {
  slug: "storage-iops-calculator",
  title: "Storage Iops Calculator",
  description: "Free storage iops calculator. Quickly calculate and plan your storage iops needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["storage iops calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Storage Iops",
  ...
  faq: [
    {
      question: "How does the storage iops work?",
