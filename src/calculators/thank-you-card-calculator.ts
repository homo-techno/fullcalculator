...
export const thankYouCardCalculator: CalculatorDefinition = {
  slug: "thank-you-card-calculator",
  title: "Thank You Card Calculator",
  description: "Free thank you card calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["thank you card calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate thank you card costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does thank you card cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
