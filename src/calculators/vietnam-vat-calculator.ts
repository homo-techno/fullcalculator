...
export const vietnamVatCalculator: CalculatorDefinition = {
  slug: "vietnam-vat-calculator",
  title: "Vietnam VAT Calculator",
  description: "Free Vietnam VAT calculator at 10%. Calculate VAT amount and total price including tax.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["vietnam vat calculator", "vietnam vat calculator", "vietnam tax calculator"],
  variants: [{
    id: "standard",
    name: "Vietnam VAT",
    description: "Free Vietnam VAT calculator at 10%",
    fields: [
  ...
  faq: [
    { question: "What is the VAT rate in Vietnam?", answer: "The standard VAT rate in Vietnam is 10%." },
