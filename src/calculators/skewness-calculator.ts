...
export const skewnessCalculator: CalculatorDefinition = {
  slug: "skewness-calculator",
  title: "Skewness Calculator",
  description: "Free skewness calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["skewness calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Skewness",
  ...
  faq: [
    { question: "How does the skewness calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
