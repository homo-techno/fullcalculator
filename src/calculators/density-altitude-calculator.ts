...
export const densityAltitudeCalculator: CalculatorDefinition = {
  slug: "density-altitude-calculator",
  title: "Density Altitude Calculator",
  description: "Free density altitude calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["density altitude calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
