...
export const criticalIllnessInsuranceCalculator: CalculatorDefinition = {
  slug: "critical-illness-insurance-calculator",
  title: "Critical Illness Insurance Calculator",
  description: "Free critical illness insurance calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["critical illness insurance calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
