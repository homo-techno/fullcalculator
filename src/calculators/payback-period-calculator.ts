...
export const paybackPeriodCalculator: CalculatorDefinition = {
  slug: "payback-period-calculator",
  title: "Payback Period Calculator",
  description: "Free payback period calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["payback period calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Payback Period",
  ...
  faq: [
    { question: "How does the payback period calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
