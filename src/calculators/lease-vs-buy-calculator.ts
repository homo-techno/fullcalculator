...
export const leaseVsBuyCalculator: CalculatorDefinition = {
  slug: "lease-vs-buy-calculator",
  title: "Lease Vs Buy Calculator",
  description: "Free lease vs buy calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["lease vs buy calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Lease Vs Buy",
      description: "Calculate lease vs buy",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the lease vs buy calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
