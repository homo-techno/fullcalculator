...
export const braSizeConverterCalculator: CalculatorDefinition = {
  slug: "bra-size-converter-calculator",
  title: "Bra Size Converter Calculator",
  description: "Free bra size converter calculator. Convert and calculate bra size converter values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["bra size converter calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Bra Size Converter",
      description: "Free bra size converter calculator. Convert and calculate bra size converter val",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does bra size converter conversion work?",
