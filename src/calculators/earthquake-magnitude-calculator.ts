...
export const earthquakeMagnitudeCalculator: CalculatorDefinition = {
  slug: "earthquake-magnitude-calculator",
  title: "Earthquake Magnitude Calculator",
  description: "Free earthquake magnitude calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["earthquake magnitude calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Earthquake Magnitude",
      description: "Calculate earthquake magnitude",
      fields: [
        {
          name: "input1",
          label: "Primary Input",
  ...
  faq: [
    { question: "How does the earthquake magnitude calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
