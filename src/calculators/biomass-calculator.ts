...
export const biomassCalculator: CalculatorDefinition = {
  slug: "biomass-calculator",
  title: "Biomass Calculator",
  description: "Free biomass calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["biomass calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
    name: "Biomass",
    description: "",
  ...
  faq: [
    { question: "What is biomass?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
