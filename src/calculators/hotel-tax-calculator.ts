...
export const hotelTaxCalculator: CalculatorDefinition = {
  slug: "hotel-tax-calculator",
  title: "Hotel Tax Calculator",
  description: "Free hotel tax calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hotel tax calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Hotel Tax",
      description: "Calculate hotel tax",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the hotel tax calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
