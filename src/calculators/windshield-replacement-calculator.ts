...
export const windshieldReplacementCalculator: CalculatorDefinition = {
  slug: "windshield-replacement-calculator",
  title: "Windshield Replacement Calculator",
  description: "Free windshield replacement calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["windshield replacement calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
