...
export const jamSugarRatioCalculator: CalculatorDefinition = {
  slug: "jam-sugar-ratio-calculator",
  title: "Jam Sugar Ratio Calculator",
  description: "Free jam sugar ratio calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["jam sugar ratio calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Jam Sugar Ratio",
      description: "Calculate jam sugar ratio",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the jam sugar ratio calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
