...
export const jumpRopeCalorieCalculator: CalculatorDefinition = {
  slug: "jump-rope-calorie-calculator",
  title: "Jump Rope Calorie Calculator",
  description: "Free jump rope calorie calculator. Calculate calories burned during jump rope based on your weight and duration.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["jump rope calorie calculator", "calories burned", "exercise calculator"],
  variants: [
    {
      id: "standard",
      name: "Calories Burned",
      description: "Calculate calories burned during jump rope",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How many calories does jump rope burn?",
      answer: "A 70kg person burns approximately 431 calories in 30 minutes of moderate jump rope.",
    },
    {
