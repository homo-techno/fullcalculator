...
export const machNumberCalculator: CalculatorDefinition = {
  slug: "mach-number-calculator",
  title: "Mach Number Calculator",
  description: "Free mach number calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["mach number calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Mach Number",
  ...
  faq: [
    { question: "How does the mach number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
