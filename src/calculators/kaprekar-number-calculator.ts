...
export const kaprekarNumberCalculator: CalculatorDefinition = {
  slug: "kaprekar-number-calculator",
  title: "Kaprekar Number Calculator",
  description: "Free kaprekar number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["kaprekar number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Kaprekar Number",
      description: "Calculate kaprekar number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the kaprekar number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
