...
export const dermatologistCostCalculator: CalculatorDefinition = {
  slug: "dermatologist-cost-calculator",
  title: "Dermatologist Cost Calculator",
  description: "Free dermatologist cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["dermatologist cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Dermatologist Cost",
  ...
  faq: [
    { question: "How much does dermatologist cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
