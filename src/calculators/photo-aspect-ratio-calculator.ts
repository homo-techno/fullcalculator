...
export const photoAspectRatioCalculator: CalculatorDefinition = {
  slug: "photo-aspect-ratio-calculator",
  title: "Photo Aspect Ratio Calculator",
  description: "Free photo aspect ratio calculator. Photography exposure and settings calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["photo aspect ratio calculator", "photography calculator", "camera settings"],
  variants: [{
    id: "standard",
