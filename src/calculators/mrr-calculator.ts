...
export const mrrCalculator: CalculatorDefinition = {
  slug: "mrr-calculator",
  title: "Mrr Calculator",
  description: "Free mrr calculator. Quickly calculate and plan your mrr needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["mrr calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Mrr",
  ...
  faq: [
    {
      question: "How does the mrr work?",
