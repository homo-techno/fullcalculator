...
export const atticInsulationCalculator: CalculatorDefinition = {
  slug: "attic-insulation-calculator",
  title: "Attic Insulation Calculator",
  description: "Free attic insulation calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["attic insulation calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate attic insulation costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does attic insulation cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
