...
export const envelopeBudgetCalculator: CalculatorDefinition = {
  slug: "envelope-budget-calculator",
  title: "Envelope Budget Calculator",
  description: "Free envelope budget calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["envelope budget calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Envelope Budget",
      description: "Calculate envelope budget",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the envelope budget calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
