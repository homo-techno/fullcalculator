...
export const vitaminDDosageCalculator: CalculatorDefinition = {
  slug: "vitamin-d-dosage-calculator",
  title: "Vitamin D Dosage Calculator",
  description: "Free vitamin d dosage calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["vitamin d dosage calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Vitamin D Dosage",
      description: "Free vitamin d dosage calculator. Get personalized health insights based on your",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How does the vitamin d dosage work?",
