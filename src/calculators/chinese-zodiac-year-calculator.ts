...
export const chineseZodiacYearCalculator: CalculatorDefinition = {
  slug: "chinese-zodiac-year-calculator",
  title: "Chinese Zodiac Year Calculator",
  description: "Free chinese zodiac year calculator. Find your Chinese zodiac animal",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["chinese zodiac year calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Chinese Zodiac Year",
