...
function calcStateTax(annualIncome: number, status: string): number {
  const brackets = status === "married"
    ? [
        ...
        { min: 100000, max: Infinity, rate: 0.03688 },
      ]
    : [
        { min: 0, max: 26050, rate: 0.0 },
        { min: 26050, max: 100000, rate: 0.02765 },
...
export const ohioPaycheckCalculator: CalculatorDefinition = {
  slug: "ohio-paycheck-calculator",
  title: "Ohio Paycheck Calculator",
  description:
    "Free Ohio paycheck calculator. Estimate your take-home pay after federal taxes, Ohio state income tax, and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["ohio paycheck calculator", "ohio take home pay", "OH paycheck calculator", "ohio state tax", "ohio salary calculator", "ohio income tax calculator"],
  variants: [
    {
      id: "ohio-paycheck",
      name: "Ohio Paycheck Calculator",
      description: "Calculate your Ohio take-home pay after federal, state, and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        return {
          ...
          details: [
            ...
            { label: "Ohio State Tax", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["pennsylvania-paycheck-calculator", "michigan-paycheck-calculator", "indiana-paycheck-calculator"],
  faq: [
    {
      question: "What is the Ohio state income tax rate?",
      answer:
        "Ohio has progressive rates. Income up to 6,050 is tax-free, 6,050 to 00,000 is taxed at 2.765%, and above 00,000 at 3.688%.",
    },
    {
      question: "Does Ohio have local income taxes?",
      answer:
        "Yes. Many Ohio cities levy municipal income taxes of 1% to 3%. Columbus and Cleveland both charge 2.5%.",
    },
    {
      question: "Did Ohio recently change its tax rates?",
      answer:
        "Yes. Ohio has been gradually reducing its income tax rates, eliminating bottom brackets so income under 6,050 is now tax-free.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - Ohio State Tax - Social Security (6.2%) - Medicare (1.45%)",
};
