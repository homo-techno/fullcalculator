...
export const outlierCalculator: CalculatorDefinition = {
  slug: "outlier-calculator",
  title: "Outlier Calculator",
  description: "Free outlier calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["outlier calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Outlier",
  ...
  faq: [
    { question: "How does the outlier calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
