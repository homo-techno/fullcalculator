...
export const altcoinProfitCalculator: CalculatorDefinition = {
  slug: "altcoin-profit-calculator",
  title: "Altcoin Profit Calculator",
  description: "Free altcoin profit calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["altcoin profit calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Altcoin Profit",
      description: "Calculate altcoin profit",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the altcoin profit calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
