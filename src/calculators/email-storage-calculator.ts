...
export const emailStorageCalculator: CalculatorDefinition = {
  slug: "email-storage-calculator",
  title: "Email Storage Calculator",
  description: "Free email storage calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["email storage calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Email Storage",
      description: "Calculate email storage",
      fields: [
        {
          name: "value",
          label: "Primary Value",
  ...
  faq: [
    { question: "How does the email storage calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
