...
export const airbnbRevenueCalculator: CalculatorDefinition = {
  slug: "airbnb-revenue-calculator",
  title: "Airbnb Revenue Calculator",
  description: "Free airbnb revenue calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["airbnb revenue calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Airbnb Revenue",
      description: "Calculate airbnb revenue",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the airbnb revenue calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
