...
export const delayTimeCalculator: CalculatorDefinition = {
  slug: "delay-time-calculator",
  title: "Delay Time Calculator",
  description: "Free delay time calculator. Calculate delay times from BPM",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["delay time calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Delay Time",
