...
export const boatFuelConsumptionCalculator: CalculatorDefinition = {
  slug: "boat-fuel-consumption-calculator",
  title: "Boat Fuel Consumption Calculator",
  description: "Free boat fuel consumption calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["boat fuel consumption calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Boat Fuel Consumption",
    description: "",
    fields: [
