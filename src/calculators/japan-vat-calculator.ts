...
export const japanVatCalculator: CalculatorDefinition = {
  slug: "japan-vat-calculator",
  title: "Japan VAT Calculator",
  description: "Free Japan VAT calculator at 10%. Calculate VAT amount and total price including tax.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["japan vat calculator", "japan vat calculator", "japan tax calculator"],
  variants: [{
    id: "standard",
    name: "Japan VAT",
    description: "Free Japan VAT calculator at 10%",
    fields: [
    ...
    calculate: (inputs) => {
        ...
        if (mode === "add") {
          ...
          return {
            ...
            details: [
              { label: "VAT amount (10%)", value: "¥" + formatNumber(vat) },
  ...
  faq: [
    { question: "What is the VAT rate in Japan?", answer: "The standard VAT rate in Japan is 10%." },
