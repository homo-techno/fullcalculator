...
export const wholesaleDealCalculator: CalculatorDefinition = {
  slug: "wholesale-deal-calculator",
  title: "Wholesale Deal Calculator",
  description: "Free wholesale deal calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["wholesale deal calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Wholesale Deal",
      description: "Free wholesale deal calculator. Plan your finances with accurate calculations an",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Wholesale Deal Calculator calculate?",
      answer: "This calculator helps you estimate wholesale deal based on your specific financial situation and inputs.",
    },
    {
