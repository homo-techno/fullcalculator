...
export const newJerseyPaycheckCalculator: CalculatorDefinition = {
  slug: "new-jersey-paycheck-calculator",
  title: "New Jersey Paycheck Calculator",
  description:
    "Free New Jersey paycheck calculator. Estimate your take-home pay after federal taxes, New Jersey state income tax, and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["new jersey paycheck calculator", "new jersey take home pay", "NJ paycheck calculator", "new jersey state tax", "new jersey salary calculator", "NJ income tax calculator"],
  variants: [
    {
      id: "new-jersey-paycheck",
      name: "New Jersey Paycheck Calculator",
      description: "Calculate your New Jersey take-home pay after federal, state, and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        return {
          ...
          details: [
            ...
            { label: "New Jersey State Tax", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["new-york-paycheck-calculator", "pennsylvania-paycheck-calculator", "california-paycheck-calculator"],
  faq: [
    {
      question: "What is the New Jersey state income tax rate?",
      answer:
        "New Jersey has progressive rates from 1.4% to 10.75%. The top rate applies to income over  million.",
    },
    {
      question: "Does New Jersey have local income taxes?",
      answer:
        "No. However, property taxes in New Jersey are the highest in the nation, averaging over ,000 per year.",
    },
    {
      question: "How does New Jersey compare to New York for taxes?",
      answer:
        "Both have high tax burdens. New Jerseys top rate (10.75%) is close to New Yorks (10.9%), but NJ has no local income tax while NYC adds up to 3.876%.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - New Jersey State Tax - Social Security (6.2%) - Medicare (1.45%)",
};
