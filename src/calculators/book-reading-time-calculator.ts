...
export const bookReadingTimeCalculator: CalculatorDefinition = {
  slug: "book-reading-time-calculator",
  title: "Book Reading Time Calculator",
  description: "Free book reading time calculator. Quickly calculate and plan your book reading time needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["book reading time calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Book Reading Time",
      description: "Free book reading time calculator. Quickly calculate and plan your book reading ",
      fields: [
        {
          name: "duration",
  ...
  faq: [
    {
      question: "How does the book reading time work?",
