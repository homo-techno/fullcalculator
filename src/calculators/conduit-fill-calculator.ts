...
export const conduitFillCalculator: CalculatorDefinition = {
  slug: "conduit-fill-calculator",
  title: "Conduit Fill Calculator",
  description: "Free conduit fill calculator. Electrical sizing and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["conduit fill calculator", "electrical calculator", "sizing tool"],
  variants: [{
    id: "standard",
    name: "Conduit Fill",
    description: "",
