...
export const buyerClosingCostCalculator: CalculatorDefinition = {
  slug: "buyer-closing-cost-calculator",
  title: "Buyer Closing Cost Calculator",
  description: "Free buyer closing cost calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["buyer closing cost calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Buyer Closing Cost",
      description: "Free buyer closing cost calculator. Plan your finances with accurate calculation",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Buyer Closing Cost Calculator calculate?",
      answer: "This calculator helps you estimate buyer closing cost based on your specific financial situation and inputs.",
    },
    {
