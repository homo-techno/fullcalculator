...
export const cosmosStakingCalculator: CalculatorDefinition = {
  slug: "cosmos-staking-calculator",
  title: "Cosmos Staking Calculator",
  description: "Free cosmos staking calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["cosmos staking calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cosmos Staking",
      description: "Calculate cosmos staking",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the cosmos staking calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
