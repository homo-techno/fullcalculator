...
export const duiCostCalculator: CalculatorDefinition = {
  slug: "dui-cost-calculator",
  title: "DUI Cost Calculator",
  description: "Free dui cost calculator. Calculate total DUI related expenses",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["dui cost calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "DUI Cost",
    description: "Calculate total DUI related expenses",
    fields: [
