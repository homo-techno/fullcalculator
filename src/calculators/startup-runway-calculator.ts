...
export const startupRunwayCalculator: CalculatorDefinition = {
  ...
  description: "Free startup runway calculator. Quickly calculate and plan your startup runway needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["startup runway calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Startup Runway",
      description: "Free startup runway calculator. Quickly calculate and plan your startup runway n",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the startup runway work?",
