...
export const hookesLawCalculator: CalculatorDefinition = {
  slug: "hookes-law-calculator",
  title: "Hookes Law Calculator",
  description: "Free hookes law calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["hookes law calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Hookes Law",
      description: "Calculate hookes law",
      fields: [
        {
          name: "v1",
          label: "Value 1",
  ...
  faq: [
    { question: "How does the hookes law calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
