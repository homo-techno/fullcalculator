...
export const takeoffDistanceCalculator: CalculatorDefinition = {
  slug: "takeoff-distance-calculator",
  title: "Takeoff Distance Calculator",
  description: "Free takeoff distance calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["takeoff distance calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
