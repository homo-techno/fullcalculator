...
export const aquariumCostCalculator: CalculatorDefinition = {
  slug: "aquarium-cost-calculator",
  title: "Aquarium Cost Calculator",
  description: "Free aquarium cost calculator. Quickly calculate and plan your aquarium cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["aquarium cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Aquarium Cost",
      description: "Free aquarium cost calculator. Quickly calculate and plan your aquarium cost nee",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the aquarium cost work?",
