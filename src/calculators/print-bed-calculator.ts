...
export const printBedCalculator: CalculatorDefinition = {
  slug: "print-bed-calculator",
  title: "Print Bed Calculator",
  description: "Free print bed calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["print bed calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
    name: "Print Bed",
