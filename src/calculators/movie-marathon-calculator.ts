...
export const movieMarathonCalculator: CalculatorDefinition = {
  slug: "movie-marathon-calculator",
  title: "Movie Marathon Calculator",
  description: "Free movie marathon calculator. Quickly calculate and plan your movie marathon needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["movie marathon calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Movie Marathon",
      description: "Free movie marathon calculator. Quickly calculate and plan your movie marathon n",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the movie marathon work?",
