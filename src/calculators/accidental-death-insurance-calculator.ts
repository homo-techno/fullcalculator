...
export const accidentalDeathInsuranceCalculator: CalculatorDefinition = {
  slug: "accidental-death-insurance-calculator",
  title: "Accidental Death Insurance Calculator",
  description: "Free accidental death insurance calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["accidental death insurance calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
