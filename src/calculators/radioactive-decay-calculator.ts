...
export const radioactiveDecayCalculator: CalculatorDefinition = {
  slug: "radioactive-decay-calculator",
  title: "Radioactive Decay Calculator",
  description: "Free radioactive decay calculator. Calculate radioactive decay values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["radioactive decay calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Radioactive Decay",
      description: "Free radioactive decay calculator. Calculate radioactive decay values for resear",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      ...
      answer: "Radioactive Decay is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
