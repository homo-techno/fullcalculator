...
export const vacationRentalIncomeCalculator: CalculatorDefinition = {
  slug: "vacation-rental-income-calculator",
  title: "Vacation Rental Income Calculator",
  description: "Free vacation rental income calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["vacation rental income calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Vacation Rental Income",
      description: "Calculate vacation rental income",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the vacation rental income calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
