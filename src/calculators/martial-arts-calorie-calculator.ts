...
export const martialArtsCalorieCalculator: CalculatorDefinition = {
  slug: "martial-arts-calorie-calculator",
  title: "Martial Arts Calorie Calculator",
  description: "Free martial arts calorie calculator. Calculate calories burned during martial arts based on your weight and duration.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["martial arts calorie calculator", "calories burned", "exercise calculator"],
  variants: [
    {
      id: "standard",
      name: "Calories Burned",
      description: "Calculate calories burned during martial arts",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How many calories does martial arts burn?",
      answer: "A 70kg person burns approximately 361 calories in 30 minutes of moderate martial arts.",
    },
    {
