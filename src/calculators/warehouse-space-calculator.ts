...
export const warehouseSpaceCalculator: CalculatorDefinition = {
  slug: "warehouse-space-calculator",
  title: "Warehouse Space Calculator",
  description: "Free warehouse space calculator. Quickly calculate and plan your warehouse space needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["warehouse space calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Warehouse Space",
      description: "Free warehouse space calculator. Quickly calculate and plan your warehouse space",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the warehouse space work?",
