...
export const sprinklerHeadCalculator: CalculatorDefinition = {
  slug: "sprinkler-head-calculator",
  title: "Sprinkler Head Calculator",
  description: "Free sprinkler head calculator. Plumbing sizing and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["sprinkler head calculator", "plumbing calculator", "sizing tool"],
  variants: [{
    id: "standard",
    name: "Sprinkler Head",
    description: "",
