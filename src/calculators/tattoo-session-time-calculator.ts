...
export const tattooSessionTimeCalculator: CalculatorDefinition = {
  slug: "tattoo-session-time-calculator",
  title: "Tattoo Session Time Calculator",
  description: "Free tattoo session time calculator. Estimate tattoo session duration.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo session time calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Session Time",
    description: "Estimate tattoo session duration",
    fields: [
