...
export const fTestCalculator: CalculatorDefinition = {
  slug: "f-test-calculator",
  title: "F Test Calculator",
  description: "Free f test calculator. Solve f test problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["f test calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "F Test",
  ...
  faq: [
    {
      question: "What is F Test?",
      answer: "F Test is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
