...
export const cropInsuranceCalculator: CalculatorDefinition = {
  slug: "crop-insurance-calculator",
  title: "Crop Insurance Calculator",
  description: "Free crop insurance calculator. Estimate crop insurance costs",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["crop insurance calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Crop Insurance",
    description: "Estimate crop insurance costs",
    fields: [
