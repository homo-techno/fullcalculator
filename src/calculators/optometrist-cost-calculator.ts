...
export const optometristCostCalculator: CalculatorDefinition = {
  slug: "optometrist-cost-calculator",
  title: "Optometrist Cost Calculator",
  description: "Free optometrist cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["optometrist cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Optometrist Cost",
  ...
  faq: [
    { question: "How much does optometrist cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
