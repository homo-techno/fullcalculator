...
export const seriesIBondCalculator: CalculatorDefinition = {
  slug: "series-i-bond-calculator",
  title: "Series I Bond Calculator",
  description: "Free series i bond calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["series i bond calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Series I Bond",
      description: "Calculate series i bond",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the series i bond calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
