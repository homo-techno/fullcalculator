...
export const concurrentUsersCalculator: CalculatorDefinition = {
  slug: "concurrent-users-calculator",
  title: "Concurrent Users Calculator",
  description: "Free concurrent users calculator. Quickly calculate and plan your concurrent users needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["concurrent users calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Concurrent Users",
      description: "Free concurrent users calculator. Quickly calculate and plan your concurrent use",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the concurrent users work?",
