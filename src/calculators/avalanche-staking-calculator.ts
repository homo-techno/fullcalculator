...
export const avalancheStakingCalculator: CalculatorDefinition = {
  slug: "avalanche-staking-calculator",
  title: "Avalanche Staking Calculator",
  description: "Free avalanche staking calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["avalanche staking calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Avalanche Staking",
      description: "Calculate avalanche staking",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the avalanche staking calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
