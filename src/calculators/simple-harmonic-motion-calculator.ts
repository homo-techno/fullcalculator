...
export const simpleHarmonicMotionCalculator: CalculatorDefinition = {
  slug: "simple-harmonic-motion-calculator",
  title: "Simple Harmonic Motion Calculator",
  description: "Free simple harmonic motion calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["simple harmonic motion calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Simple Harmonic Motion",
      description: "Calculate simple harmonic motion",
      fields: [
        {
          name: "v1",
          label: "Value 1",
  ...
  faq: [
    { question: "How does the simple harmonic motion calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
