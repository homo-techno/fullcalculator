...
export const lunarEclipseCalculator: CalculatorDefinition = {
  slug: "lunar-eclipse-calculator",
  title: "Lunar Eclipse Calculator",
  description: "Free lunar eclipse calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["lunar eclipse calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Lunar Eclipse",
      description: "Calculate lunar eclipse",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the lunar eclipse calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
