...
export const coffeeCostCalculator: CalculatorDefinition = {
  slug: "coffee-cost-calculator",
  title: "Coffee Cost Calculator",
  description: "Free coffee cost calculator. Quickly calculate and plan your coffee cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["coffee cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Coffee Cost",
  ...
  faq: [
    {
      question: "How does the coffee cost work?",
