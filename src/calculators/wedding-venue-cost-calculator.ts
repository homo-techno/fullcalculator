...
export const weddingVenueCostCalculator: CalculatorDefinition = {
  slug: "wedding-venue-cost-calculator",
  title: "Wedding Venue Cost Calculator",
  description: "Free wedding venue cost calculator. Quickly calculate and plan your wedding venue cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["wedding venue cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Wedding Venue Cost",
      description: "Free wedding venue cost calculator. Quickly calculate and plan your wedding venu",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the wedding venue cost work?",
