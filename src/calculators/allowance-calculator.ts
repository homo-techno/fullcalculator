...
export const allowanceCalculator: CalculatorDefinition = {
  slug: "allowance-calculator",
  title: "Allowance Calculator",
  description: "Free allowance calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["allowance calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Allowance",
  ...
  faq: [
    { question: "How does the allowance calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
