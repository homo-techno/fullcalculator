...
export const filamentDryingCalculator: CalculatorDefinition = {
  slug: "filament-drying-calculator",
  title: "Filament Drying Calculator",
  description: "Free filament drying calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["filament drying calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
