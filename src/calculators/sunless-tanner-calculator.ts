...
export const sunlessTannerCalculator: CalculatorDefinition = {
  slug: "sunless-tanner-calculator",
  title: "Sunless Tanner Calculator",
  description: "Free sunless tanner calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["sunless tanner calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
    name: "Sunless Tanner",
    description: "",
  ...
  faq: [
    { question: "How much does sunless tanner cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
