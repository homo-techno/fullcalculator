...
export const solarWaterHeaterCalculator: CalculatorDefinition = {
  slug: "solar-water-heater-calculator",
  title: "Solar Water Heater Calculator",
  description: "Free solar water heater calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["solar water heater calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate solar water heater costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does solar water heater cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
