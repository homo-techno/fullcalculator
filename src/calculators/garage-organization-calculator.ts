...
export const garageOrganizationCalculator: CalculatorDefinition = {
  slug: "garage-organization-calculator",
  title: "Garage Organization Calculator",
  description: "Free garage organization calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["garage organization calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
