...
export const seamAllowanceCalculator: CalculatorDefinition = {
  slug: "seam-allowance-calculator",
  title: "Seam Allowance Calculator",
  description: "Free seam allowance calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["seam allowance calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Seam Allowance",
