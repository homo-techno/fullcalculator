...
export const ebitdaCalculator: CalculatorDefinition = {
  slug: "ebitda-calculator",
  title: "Ebitda Calculator",
  description: "Free ebitda calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["ebitda calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Ebitda",
  ...
  faq: [
    { question: "How does the ebitda calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
