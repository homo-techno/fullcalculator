...
export const podcastListeningCalculator: CalculatorDefinition = {
  slug: "podcast-listening-calculator",
  title: "Podcast Listening Calculator",
  description: "Free podcast listening calculator. Quickly calculate and plan your podcast listening needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["podcast listening calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Podcast Listening",
      description: "Free podcast listening calculator. Quickly calculate and plan your podcast liste",
      fields: [
        {
          name: "duration",
  ...
  faq: [
    {
      question: "How does the podcast listening work?",
