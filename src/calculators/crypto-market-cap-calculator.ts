...
export const cryptoMarketCapCalculator: CalculatorDefinition = {
  slug: "crypto-market-cap-calculator",
  title: "Crypto Market Cap Calculator",
  description: "Free crypto market cap calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["crypto market cap calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the crypto market cap calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
