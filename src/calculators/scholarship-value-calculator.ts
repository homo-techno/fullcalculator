...
export const scholarshipValueCalculator: CalculatorDefinition = {
  slug: "scholarship-value-calculator",
  title: "Scholarship Value Calculator",
  description: "Free scholarship value calculator. Academic planning and education cost tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["scholarship value calculator", "education calculator", "student tool"],
  variants: [{
    id: "standard",
