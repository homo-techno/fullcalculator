...
export const contributionMarginCalculator: CalculatorDefinition = {
  slug: "contribution-margin-calculator",
  title: "Contribution Margin Calculator",
  description: "Free contribution margin calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["contribution margin calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Contribution Margin",
      description: "Calculate contribution margin",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    { question: "How does the contribution margin calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
