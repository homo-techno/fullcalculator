...
export const stellarRadiusCalculator: CalculatorDefinition = {
  slug: "stellar-radius-calculator",
  title: "Stellar Radius Calculator",
  description: "Free stellar radius calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["stellar radius calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Stellar Radius",
      description: "Calculate stellar radius",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the stellar radius calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
