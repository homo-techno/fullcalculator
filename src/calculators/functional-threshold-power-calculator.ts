...
export const functionalThresholdPowerCalculator: CalculatorDefinition = {
  slug: "functional-threshold-power-calculator",
  title: "Functional Threshold Power Calculator",
  description: "Free functional threshold power calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["functional threshold power calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Functional Threshold Power",
      description: "Calculate functional threshold power",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the functional threshold power calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
