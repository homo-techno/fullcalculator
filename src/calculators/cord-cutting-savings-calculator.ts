...
export const cordCuttingSavingsCalculator: CalculatorDefinition = {
  slug: "cord-cutting-savings-calculator",
  title: "Cord Cutting Savings Calculator",
  description: "Free cord cutting savings calculator. Quickly calculate and plan your cord cutting savings needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cord cutting savings calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Cord Cutting Savings",
      description: "Free cord cutting savings calculator. Quickly calculate and plan your cord cutti",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the cord cutting savings work?",
