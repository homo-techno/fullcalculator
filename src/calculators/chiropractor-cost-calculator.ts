...
export const chiropractorCostCalculator: CalculatorDefinition = {
  slug: "chiropractor-cost-calculator",
  title: "Chiropractor Cost Calculator",
  description: "Free chiropractor cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["chiropractor cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Chiropractor Cost",
  ...
  faq: [
    { question: "How much does chiropractor cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
