...
export const babysitterPayCalculator: CalculatorDefinition = {
  slug: "babysitter-pay-calculator",
  title: "Babysitter Pay Calculator",
  description: "Free babysitter pay calculator. Quickly calculate and plan your babysitter pay needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["babysitter pay calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Babysitter Pay",
      description: "Free babysitter pay calculator. Quickly calculate and plan your babysitter pay n",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the babysitter pay work?",
