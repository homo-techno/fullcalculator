...
export const chickenCoopCalculator: CalculatorDefinition = {
  slug: "chicken-coop-calculator",
  title: "Chicken Coop Calculator",
  description: "Free chicken coop calculator. Size your chicken coop properly",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["chicken coop calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Chicken Coop",
    description: "Size your chicken coop properly",
    fields: [
