...
export const parkingCostCalculator: CalculatorDefinition = {
  slug: "parking-cost-calculator",
  title: "Parking Cost Calculator",
  description: "Free parking cost calculator. Quickly calculate and plan your parking cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["parking cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Parking Cost",
  ...
  faq: [
    {
      question: "How does the parking cost work?",
