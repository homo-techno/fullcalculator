...
export const betaDistributionCalculator: CalculatorDefinition = {
  slug: "beta-distribution-calculator",
  title: "Beta Distribution Calculator",
  description: "Free beta distribution calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["beta distribution calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Beta Distribution",
      description: "Calculate beta distribution",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the beta distribution calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
