...
export const kitchenDeepCleanCalculator: CalculatorDefinition = {
  slug: "kitchen-deep-clean-calculator",
  title: "Kitchen Deep Clean Calculator",
  description: "Free kitchen deep clean calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["kitchen deep clean calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
