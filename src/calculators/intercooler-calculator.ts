...
export const intercoolerCalculator: CalculatorDefinition = {
  slug: "intercooler-calculator",
  title: "Intercooler Calculator",
  description: "Free intercooler calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["intercooler calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
    name: "Intercooler",
    description: "",
