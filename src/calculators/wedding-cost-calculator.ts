...
export const weddingCostCalculator: CalculatorDefinition = {
  slug: "wedding-cost-calculator",
  title: "Wedding Cost Calculator",
  description: "Free wedding cost calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["wedding cost calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Wedding Cost",
      description: "Free wedding cost calculator. Plan your finances with accurate calculations and ",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Wedding Cost Calculator calculate?",
      answer: "This calculator helps you estimate wedding cost based on your specific financial situation and inputs.",
    },
    {
