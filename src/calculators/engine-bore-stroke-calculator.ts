...
export const engineBoreStrokeCalculator: CalculatorDefinition = {
  slug: "engine-bore-stroke-calculator",
  title: "Engine Bore Stroke Calculator",
  description: "Free engine bore stroke calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["engine bore stroke calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
