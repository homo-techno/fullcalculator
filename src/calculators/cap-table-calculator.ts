...
export const capTableCalculator: CalculatorDefinition = {
  slug: "cap-table-calculator",
  title: "Cap Table Calculator",
  description: "Free cap table calculator. Quickly calculate and plan your cap table needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cap table calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Cap Table",
  ...
  faq: [
    {
      question: "How does the cap table work?",
