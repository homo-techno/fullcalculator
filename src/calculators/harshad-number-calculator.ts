...
export const harshadNumberCalculator: CalculatorDefinition = {
  slug: "harshad-number-calculator",
  title: "Harshad Number Calculator",
  description: "Free harshad number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["harshad number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Harshad Number",
      description: "Calculate harshad number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the harshad number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
