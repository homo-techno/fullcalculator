...
export const neutronStarCalculator: CalculatorDefinition = {
  slug: "neutron-star-calculator",
  title: "Neutron Star Calculator",
  description: "Free neutron star calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["neutron star calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Neutron Star",
      description: "Calculate neutron star",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the neutron star calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
