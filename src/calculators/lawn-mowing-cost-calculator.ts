...
export const lawnMowingCostCalculator: CalculatorDefinition = {
  slug: "lawn-mowing-cost-calculator",
  title: "Lawn Mowing Cost Calculator",
  description: "Free lawn mowing cost calculator. Quickly calculate and plan your lawn mowing cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["lawn mowing cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Lawn Mowing Cost",
      description: "Free lawn mowing cost calculator. Quickly calculate and plan your lawn mowing co",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the lawn mowing cost work?",
