...
export const stellarLuminosityCalculator: CalculatorDefinition = {
  slug: "stellar-luminosity-calculator",
  title: "Stellar Luminosity Calculator",
  description: "Free stellar luminosity calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["stellar luminosity calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the stellar luminosity calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
