...
export const dotsScoreCalculator: CalculatorDefinition = {
  slug: "dots-score-calculator",
  title: "Dots Score Calculator",
  description: "Free dots score calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["dots score calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Dots Score",
      description: "Free dots score calculator. Get personalized health insights based on your profi",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the dots score work?",
