...
export const molecularWeightCalculator: CalculatorDefinition = {
  slug: "molecular-weight-calculator",
  title: "Molecular Weight Calculator",
  description: "Free molecular weight calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["molecular weight calculator", "chemistry calculator", "science tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the molecular weight calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
