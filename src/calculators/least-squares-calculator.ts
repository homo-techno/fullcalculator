...
export const leastSquaresCalculator: CalculatorDefinition = {
  slug: "least-squares-calculator",
  title: "Least Squares Calculator",
  description: "Free least squares calculator. Solve least squares problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["least squares calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Least Squares",
      description: "Free least squares calculator. Solve least squares problems with step-by-step ca",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      ...
      answer: "Least Squares is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
