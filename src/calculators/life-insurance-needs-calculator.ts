...
export const lifeInsuranceNeedsCalculator: CalculatorDefinition = {
  slug: "life-insurance-needs-calculator",
  title: "Life Insurance Needs Calculator",
  description: "Free life insurance needs calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["life insurance needs calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
