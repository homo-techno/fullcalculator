...
export const anesthesiaDosageCalculator: CalculatorDefinition = {
  slug: "anesthesia-dosage-calculator",
  title: "Anesthesia Dosage Calculator",
  description: "Free anesthesia dosage calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["anesthesia dosage calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Anesthesia Dosage",
      description: "Free anesthesia dosage calculator. Get personalized health insights based on you",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How does the anesthesia dosage work?",
