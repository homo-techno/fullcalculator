...
export const sideHustleIncomeCalculator: CalculatorDefinition = {
  slug: "side-hustle-income-calculator",
  title: "Side Hustle Income Calculator",
  description: "Free side hustle income calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["side hustle income calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Side Hustle Income",
      description: "Free side hustle income calculator. Plan your finances with accurate calculation",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Side Hustle Income Calculator calculate?",
      answer: "This calculator helps you estimate side hustle income based on your specific financial situation and inputs.",
    },
    {
