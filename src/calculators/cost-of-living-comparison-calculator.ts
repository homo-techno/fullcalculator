...
export const costOfLivingComparisonCalculator: CalculatorDefinition = {
  slug: "cost-of-living-comparison-calculator",
  title: "Cost of Living Comparison Calculator",
  description: "Free cost of living comparison calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["cost of living comparison calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Cost of Living Comparison",
      description: "Free cost of living comparison calculator. Plan your finances with accurate calc",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Cost of Living Comparison Calculator calculate?",
      answer: "This calculator helps you estimate cost of living comparison based on your specific financial situation and inputs.",
    },
    {
