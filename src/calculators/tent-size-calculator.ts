...
export const tentSizeCalculator: CalculatorDefinition = {
  slug: "tent-size-calculator",
  title: "Tent Size Calculator",
  description: "Free tent size calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tent size calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate tent size costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does tent size cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
