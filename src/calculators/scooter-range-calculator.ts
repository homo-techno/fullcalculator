...
export const scooterRangeCalculator: CalculatorDefinition = {
  slug: "scooter-range-calculator",
  title: "Scooter Range Calculator",
  description: "Free scooter range calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["scooter range calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Scooter Range",
      description: "Calculate scooter range",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the scooter range calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
