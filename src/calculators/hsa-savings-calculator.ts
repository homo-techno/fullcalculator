...
export const hsaSavingsCalculator: CalculatorDefinition = {
  slug: "hsa-savings-calculator",
  title: "HSA Savings Calculator",
  description: "Free hsa savings calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["hsa savings calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "HSA Savings",
      description: "Free hsa savings calculator. Plan your finances with accurate calculations and p",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the HSA Savings Calculator calculate?",
      answer: "This calculator helps you estimate hsa savings based on your specific financial situation and inputs.",
    },
    {
