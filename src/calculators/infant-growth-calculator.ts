...
export const infantGrowthCalculator: CalculatorDefinition = {
  slug: "infant-growth-calculator",
  title: "Infant Growth Calculator",
  description: "Free infant growth calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["infant growth calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Infant Growth",
      description: "Free infant growth calculator. Get personalized health insights based on your pr",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the infant growth work?",
