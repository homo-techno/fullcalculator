...
export const cryptoPortfolioCalculator: CalculatorDefinition = {
  slug: "crypto-portfolio-calculator",
  title: "Crypto Portfolio Calculator",
  description: "Free crypto portfolio calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["crypto portfolio calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Crypto Portfolio",
      description: "Calculate crypto portfolio",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the crypto portfolio calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
