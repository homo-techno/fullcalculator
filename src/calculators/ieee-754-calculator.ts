...
export const ieee754Calculator: CalculatorDefinition = {
  slug: "ieee-754-calculator",
  title: "Ieee 754 Calculator",
  description: "Free ieee 754 calculator. Advanced math and computation tool.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["ieee 754 calculator", "math calculator", "computation tool"],
  variants: [{
    id: "standard",
    name: "Ieee 754",
    description: "",
  ...
  faq: [
    { question: "What is ieee 754?", answer: "A mathematical concept used in computation and analysis. This calculator helps you solve related problems." },
