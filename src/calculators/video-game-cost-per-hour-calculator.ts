...
export const videoGameCostPerHourCalculator: CalculatorDefinition = {
  slug: "video-game-cost-per-hour-calculator",
  title: "Video Game Cost Per Hour Calculator",
  description: "Free video game cost per hour calculator. Quickly calculate and plan your video game cost per hour needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["video game cost per hour calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Video Game Cost Per Hour",
      description: "Free video game cost per hour calculator. Quickly calculate and plan your video ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the video game cost per hour work?",
