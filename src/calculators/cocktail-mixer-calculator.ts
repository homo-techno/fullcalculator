...
export const cocktailMixerCalculator: CalculatorDefinition = {
  slug: "cocktail-mixer-calculator",
  title: "Cocktail Mixer Calculator",
  description: "Free cocktail mixer calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cocktail mixer calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Cocktail Mixer",
      description: "Calculate cocktail mixer",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the cocktail mixer calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
