...
export const mifflinStJeorCalculator: CalculatorDefinition = {
  slug: "mifflin-st-jeor-calculator",
  title: "Mifflin St Jeor Calculator",
  description: "Free mifflin st jeor calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["mifflin st jeor calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Mifflin St Jeor",
      description: "Calculate mifflin st jeor",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the mifflin st jeor calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
