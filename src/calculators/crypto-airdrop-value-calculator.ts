...
export const cryptoAirdropValueCalculator: CalculatorDefinition = {
  slug: "crypto-airdrop-value-calculator",
  title: "Crypto Airdrop Value Calculator",
  description: "Free crypto airdrop value calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["crypto airdrop value calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Crypto Airdrop Value",
      description: "Calculate crypto airdrop value",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the crypto airdrop value calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
