...
export const vpnSpeedCalculator: CalculatorDefinition = {
  slug: "vpn-speed-calculator",
  title: "Vpn Speed Calculator",
  description: "Free vpn speed calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["vpn speed calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Vpn Speed",
      description: "Calculate vpn speed",
      fields: [
        {
          name: "value",
          label: "Primary Value",
  ...
  faq: [
    { question: "How does the vpn speed calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
