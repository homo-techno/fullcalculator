...
export const bachelorPartyCalculator: CalculatorDefinition = {
  slug: "bachelor-party-calculator",
  title: "Bachelor Party Calculator",
  description: "Free bachelor party calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bachelor party calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate bachelor party costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does bachelor party cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
