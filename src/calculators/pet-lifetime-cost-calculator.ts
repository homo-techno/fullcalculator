...
export const petLifetimeCostCalculator: CalculatorDefinition = {
  slug: "pet-lifetime-cost-calculator",
  title: "Pet Lifetime Cost Calculator",
  description: "Free pet lifetime cost calculator. Quickly calculate and plan your pet lifetime cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pet lifetime cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Pet Lifetime Cost",
      description: "Free pet lifetime cost calculator. Quickly calculate and plan your pet lifetime ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the pet lifetime cost work?",
