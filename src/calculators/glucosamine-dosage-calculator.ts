...
export const glucosamineDosageCalculator: CalculatorDefinition = {
  slug: "glucosamine-dosage-calculator",
  title: "Glucosamine Dosage Calculator",
  description: "Free glucosamine dosage calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["glucosamine dosage calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Glucosamine Dosage",
      description: "Calculate glucosamine dosage",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the glucosamine dosage calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
