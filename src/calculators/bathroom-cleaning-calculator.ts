...
export const bathroomCleaningCalculator: CalculatorDefinition = {
  slug: "bathroom-cleaning-calculator",
  title: "Bathroom Cleaning Calculator",
  description: "Free bathroom cleaning calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bathroom cleaning calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
