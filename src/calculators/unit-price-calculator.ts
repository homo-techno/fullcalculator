...
export const unitPriceCalculator: CalculatorDefinition = {
  slug: "unit-price-calculator",
  title: "Unit Price Calculator",
  description: "Free unit price calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["unit price calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Unit Price",
  ...
  faq: [
    { question: "How does the unit price calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
