...
export const serverUptimeCalculator: CalculatorDefinition = {
  slug: "server-uptime-calculator",
  title: "Server Uptime Calculator",
  description: "Free server uptime calculator. Quickly calculate and plan your server uptime needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["server uptime calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Server Uptime",
      description: "Free server uptime calculator. Quickly calculate and plan your server uptime nee",
      fields: [
        {
          name: "duration",
  ...
  faq: [
    {
      question: "How does the server uptime work?",
