...
export const windowWashingCalculator: CalculatorDefinition = {
  slug: "window-washing-calculator",
  title: "Window Washing Calculator",
  description: "Free window washing calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["window washing calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
    name: "Window Washing",
    description: "",
