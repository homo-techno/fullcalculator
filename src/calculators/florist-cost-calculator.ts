...
export const floristCostCalculator: CalculatorDefinition = {
  slug: "florist-cost-calculator",
  title: "Florist Cost Calculator",
  description: "Free florist cost calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["florist cost calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate florist cost costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does florist cost cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
