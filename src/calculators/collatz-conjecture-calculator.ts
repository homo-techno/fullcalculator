...
export const collatzConjectureCalculator: CalculatorDefinition = {
  slug: "collatz-conjecture-calculator",
  title: "Collatz Conjecture Calculator",
  description: "Free collatz conjecture calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["collatz conjecture calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Collatz Conjecture",
      description: "Calculate collatz conjecture",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the collatz conjecture calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
