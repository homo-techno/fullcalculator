...
export const foodWebCalculator: CalculatorDefinition = {
  slug: "food-web-calculator",
  title: "Food Web Calculator",
  description: "Free food web calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["food web calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
    name: "Food Web",
    description: "",
  ...
  faq: [
    { question: "What is food web?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
