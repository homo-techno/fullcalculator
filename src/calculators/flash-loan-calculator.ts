...
export const flashLoanCalculator: CalculatorDefinition = {
  slug: "flash-loan-calculator",
  title: "Flash Loan Calculator",
  description: "Free flash loan calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["flash loan calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Flash Loan",
      description: "Calculate flash loan",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the flash loan calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
