...
export const birthdayAgeCalculator: CalculatorDefinition = {
  slug: "birthday-age-calculator",
  title: "Birthday Age Calculator",
  description: "Free birthday age calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["birthday age calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Birthday Age",
      description: "Calculate birthday age",
      fields: [
        {
          name: "size",
          label: "Size / Weight",
  ...
  faq: [
    { question: "How does the birthday age calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
