...
export const destinyNumberCalculator: CalculatorDefinition = {
  slug: "destiny-number-calculator",
  title: "Destiny Number Calculator",
  description: "Free destiny number calculator. Calculate expression/destiny number",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["destiny number calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Destiny Number",
    description: "Calculate expression/destiny number",
    fields: [
