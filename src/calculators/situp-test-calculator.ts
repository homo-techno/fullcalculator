...
export const situpTestCalculator: CalculatorDefinition = {
  slug: "situp-test-calculator",
  title: "Situp Test Calculator",
  description: "Free situp test calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["situp test calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Situp Test",
      description: "Calculate situp test",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the situp test calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
