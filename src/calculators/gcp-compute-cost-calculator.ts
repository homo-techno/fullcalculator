...
export const gcpComputeCostCalculator: CalculatorDefinition = {
  slug: "gcp-compute-cost-calculator",
  title: "Gcp Compute Cost Calculator",
  description: "Free gcp compute cost calculator. Quickly calculate and plan your gcp compute cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["gcp compute cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Gcp Compute Cost",
      description: "Free gcp compute cost calculator. Quickly calculate and plan your gcp compute co",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the gcp compute cost work?",
