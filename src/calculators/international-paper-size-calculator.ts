...
export const internationalPaperSizeCalculator: CalculatorDefinition = {
  slug: "international-paper-size-calculator",
  title: "International Paper Size Calculator",
  description: "Free international paper size calculator. Convert and calculate international paper size values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["international paper size calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "International Paper Size",
      description: "Free international paper size calculator. Convert and calculate international pa",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does international paper size conversion work?",
