...
export const infillCalculator: CalculatorDefinition = {
  slug: "infill-calculator",
  title: "Infill Calculator",
  description: "Free infill calculator. 3D printing planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["infill calculator", "3d printing calculator", "filament calculator"],
  variants: [{
    id: "standard",
    name: "Infill",
