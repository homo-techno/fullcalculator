...
export const a1cToGlucoseCalculator: CalculatorDefinition = {
  slug: "a1c-to-glucose-calculator",
  title: "A1c To Glucose Calculator",
  description: "Free a1c to glucose calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["a1c to glucose calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "A1c To Glucose",
      description: "Free a1c to glucose calculator. Get personalized health insights based on your p",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the a1c to glucose work?",
