...
export const percentileCalculator: CalculatorDefinition = {
  ...
  description: "Free percentile calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["percentile calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Percentile",
  ...
  faq: [
    { question: "How does the percentile calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
