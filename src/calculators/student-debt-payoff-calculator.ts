...
export const studentDebtPayoffCalculator: CalculatorDefinition = {
  slug: "student-debt-payoff-calculator",
  title: "Student Debt Payoff Calculator",
  description: "Free student debt payoff calculator. Academic planning and education cost tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["student debt payoff calculator", "education calculator", "student tool"],
  variants: [{
    id: "standard",
