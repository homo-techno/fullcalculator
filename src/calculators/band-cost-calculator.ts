...
export const bandCostCalculator: CalculatorDefinition = {
  slug: "band-cost-calculator",
  title: "Band Cost Calculator",
  description: "Free band cost calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["band cost calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate band cost costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does band cost cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
