...
export const songLengthCalculator: CalculatorDefinition = {
  slug: "song-length-calculator",
  title: "Song Length Calculator",
  description: "Free song length calculator. Calculate album and playlist duration",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["song length calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Song Length",
    description: "Calculate album and playlist duration",
    fields: [
