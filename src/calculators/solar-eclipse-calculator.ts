...
export const solarEclipseCalculator: CalculatorDefinition = {
  slug: "solar-eclipse-calculator",
  title: "Solar Eclipse Calculator",
  description: "Free solar eclipse calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["solar eclipse calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Solar Eclipse",
      description: "Calculate solar eclipse",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the solar eclipse calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
