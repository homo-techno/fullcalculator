...
export const eulerFormulaCalculator: CalculatorDefinition = {
  slug: "euler-formula-calculator",
  title: "Euler Formula Calculator",
  description: "Free euler formula calculator. Solve euler formula problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["euler formula calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Euler Formula",
      description: "Free euler formula calculator. Solve euler formula problems with step-by-step ca",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Euler Formula?",
      answer: "Euler Formula is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
