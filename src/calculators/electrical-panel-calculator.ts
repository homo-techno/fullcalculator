...
export const electricalPanelCalculator: CalculatorDefinition = {
  slug: "electrical-panel-calculator",
  title: "Electrical Panel Calculator",
  description: "Free electrical panel calculator. Electrical sizing and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["electrical panel calculator", "electrical calculator", "sizing tool"],
  variants: [{
    id: "standard",
