...
export const torusCalculator: CalculatorDefinition = {
  slug: "torus-calculator",
  title: "Torus Calculator",
  description: "Free torus calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["torus calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Torus",
      description: "Calculate torus",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the torus calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
