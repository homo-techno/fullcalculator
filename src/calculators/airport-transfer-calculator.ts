...
export const airportTransferCalculator: CalculatorDefinition = {
  slug: "airport-transfer-calculator",
  title: "Airport Transfer Calculator",
  description: "Free airport transfer calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["airport transfer calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Airport Transfer",
      description: "Calculate airport transfer",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the airport transfer calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
