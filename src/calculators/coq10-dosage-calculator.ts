...
export const coq10DosageCalculator: CalculatorDefinition = {
  slug: "coq10-dosage-calculator",
  title: "Coq10 Dosage Calculator",
  description: "Free coq10 dosage calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["coq10 dosage calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Coq10 Dosage",
      description: "Calculate coq10 dosage",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the coq10 dosage calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
