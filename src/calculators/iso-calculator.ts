...
export const isoCalculator: CalculatorDefinition = {
  slug: "iso-calculator",
  title: "Iso Calculator",
  description: "Free iso calculator. Photography exposure and settings calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["iso calculator", "photography calculator", "camera settings"],
  variants: [{
    id: "standard",
    name: "Iso",
