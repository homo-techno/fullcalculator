...
export const breadFlourCalculator: CalculatorDefinition = {
  slug: "bread-flour-calculator",
  title: "Bread Flour Calculator",
  description: "Free bread flour calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bread flour calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Bread Flour",
      description: "Calculate bread flour",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the bread flour calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
