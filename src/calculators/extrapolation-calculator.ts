...
export const extrapolationCalculator: CalculatorDefinition = {
  slug: "extrapolation-calculator",
  title: "Extrapolation Calculator",
  description: "Free extrapolation calculator. Advanced math and computation tool.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["extrapolation calculator", "math calculator", "computation tool"],
  variants: [{
    id: "standard",
    name: "Extrapolation",
    description: "",
  ...
  faq: [
    { question: "What is extrapolation?", answer: "A mathematical concept used in computation and analysis. This calculator helps you solve related problems." },
