...
export const ellipticalCalorieCalculator: CalculatorDefinition = {
  slug: "elliptical-calorie-calculator",
  title: "Elliptical Calorie Calculator",
  description: "Free elliptical calorie calculator. Calculate calories burned during elliptical based on your weight and duration.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["elliptical calorie calculator", "calories burned", "exercise calculator"],
  variants: [
    {
      id: "standard",
      name: "Calories Burned",
      description: "Calculate calories burned during elliptical",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How many calories does elliptical burn?",
      answer: "A 70kg person burns approximately 175 calories in 30 minutes of moderate elliptical.",
    },
    {
