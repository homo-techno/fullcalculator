...
export const springCleaningCalculator: CalculatorDefinition = {
  slug: "spring-cleaning-calculator",
  title: "Spring Cleaning Calculator",
  description: "Free spring cleaning calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["spring cleaning calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
