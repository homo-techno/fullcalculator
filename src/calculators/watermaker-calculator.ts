...
export const watermakerCalculator: CalculatorDefinition = {
  slug: "watermaker-calculator",
  title: "Watermaker Calculator",
  description: "Free watermaker calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["watermaker calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Watermaker",
    description: "",
