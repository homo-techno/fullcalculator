...
export const woodStainCalculator: CalculatorDefinition = {
  slug: "wood-stain-calculator",
  title: "Wood Stain Calculator",
  description: "Free wood stain calculator. Woodworking planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["wood stain calculator", "woodworking calculator", "carpentry tool"],
  variants: [{
    id: "standard",
    name: "Wood Stain",
