...
export const certificateOfDepositCalculator: CalculatorDefinition = {
  slug: "certificate-of-deposit-calculator",
  title: "Certificate Of Deposit Calculator",
  description: "Free certificate of deposit calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["certificate of deposit calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Certificate Of Deposit",
      description: "Calculate certificate of deposit",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the certificate of deposit calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
