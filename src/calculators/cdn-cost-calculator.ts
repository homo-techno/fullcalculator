...
export const cdnCostCalculator: CalculatorDefinition = {
  slug: "cdn-cost-calculator",
  title: "Cdn Cost Calculator",
  description: "Free cdn cost calculator. Quickly calculate and plan your cdn cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cdn cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Cdn Cost",
  ...
  faq: [
    {
      question: "How does the cdn cost work?",
