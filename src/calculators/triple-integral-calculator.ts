...
export const tripleIntegralCalculator: CalculatorDefinition = {
  slug: "triple-integral-calculator",
  title: "Triple Integral Calculator",
  description: "Free triple integral calculator. Solve triple integral problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["triple integral calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Triple Integral",
      description: "Free triple integral calculator. Solve triple integral problems with step-by-ste",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Triple Integral?",
      answer: "Triple Integral is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
