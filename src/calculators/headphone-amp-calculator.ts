...
export const headphoneAmpCalculator: CalculatorDefinition = {
  slug: "headphone-amp-calculator",
  title: "Headphone Amp Calculator",
  description: "Free headphone amp calculator. Calculate headphone amplifier needs",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["headphone amp calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Headphone Amp",
    description: "Calculate headphone amplifier needs",
    fields: [
