...
export const insulationRValueCalculator: CalculatorDefinition = {
  slug: "insulation-r-value-calculator",
  title: "Insulation R Value Calculator",
  description: "Free insulation r value calculator. Calculate insulation r value values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["insulation r value calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Insulation R Value",
      description: "Free insulation r value calculator. Calculate insulation r value values for rese",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Insulation R Value?",
      answer: "Insulation R Value is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
