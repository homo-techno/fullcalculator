...
export const canningJarCalculator: CalculatorDefinition = {
  slug: "canning-jar-calculator",
  title: "Canning Jar Calculator",
  description: "Free canning jar calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["canning jar calculator", "cooking calculator", "recipe calculator"],
  variants: [
    {
      id: "standard",
      name: "Canning Jar",
      description: "Calculate canning jar",
      fields: [
        {
          name: "servings",
  ...
  faq: [
    { question: "How does the canning jar calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
