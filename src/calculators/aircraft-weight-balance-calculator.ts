...
export const aircraftWeightBalanceCalculator: CalculatorDefinition = {
  slug: "aircraft-weight-balance-calculator",
  title: "Aircraft Weight Balance Calculator",
  description: "Free aircraft weight balance calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["aircraft weight balance calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
    name: "Aircraft Weight Balance",
