...
export const supplementalInsuranceCalculator: CalculatorDefinition = {
  slug: "supplemental-insurance-calculator",
  title: "Supplemental Insurance Calculator",
  description: "Free supplemental insurance calculator. Estimate insurance premiums and coverage needs.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["supplemental insurance calculator", "insurance calculator", "premium estimator"],
  variants: [{
    id: "standard",
