...
export const petFoodAmountCalculator: CalculatorDefinition = {
  slug: "pet-food-amount-calculator",
  title: "Pet Food Amount Calculator",
  description: "Free pet food amount calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pet food amount calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Pet Food Amount",
      description: "Calculate pet food amount",
      fields: [
        {
          name: "size",
          label: "Size / Weight",
  ...
  faq: [
    { question: "How does the pet food amount calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
