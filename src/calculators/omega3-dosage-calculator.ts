...
export const omega3DosageCalculator: CalculatorDefinition = {
  slug: "omega3-dosage-calculator",
  title: "Omega3 Dosage Calculator",
  description: "Free omega3 dosage calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["omega3 dosage calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Omega3 Dosage",
      description: "Free omega3 dosage calculator. Get personalized health insights based on your pr",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How does the omega3 dosage work?",
