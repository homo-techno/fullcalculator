...
export const altitudeAdjustmentCalculator: CalculatorDefinition = {
  slug: "altitude-adjustment-calculator",
  title: "Altitude Adjustment Calculator",
  description: "Free altitude adjustment calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["altitude adjustment calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Altitude Adjustment",
      description: "Free altitude adjustment calculator. Get personalized health insights based on y",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
