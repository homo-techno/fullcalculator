...
export const karmicDebtCalculator: CalculatorDefinition = {
  slug: "karmic-debt-calculator",
  title: "Karmic Debt Calculator",
  description: "Free karmic debt calculator. Check for karmic debt numbers",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["karmic debt calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Karmic Debt",
    description: "Check for karmic debt numbers",
    fields: [
