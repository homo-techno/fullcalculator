...
export const bailAmountCalculator: CalculatorDefinition = {
  slug: "bail-amount-calculator",
  title: "Bail Amount Calculator",
  description: "Free bail amount calculator. Estimate bail by offense type",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["bail amount calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Bail Amount",
    description: "Estimate bail by offense type",
    fields: [
