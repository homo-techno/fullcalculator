...
export const crosswindComponentCalculator: CalculatorDefinition = {
  slug: "crosswind-component-calculator",
  title: "Crosswind Component Calculator",
  description: "Free crosswind component calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["crosswind component calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
