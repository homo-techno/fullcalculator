...
export const bedsheetSizeCalculator: CalculatorDefinition = {
  slug: "bedsheet-size-calculator",
  title: "Bedsheet Size Calculator",
  description: "Free bedsheet size calculator. Convert and calculate bedsheet size values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["bedsheet size calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Bedsheet Size",
      description: "Free bedsheet size calculator. Convert and calculate bedsheet size values instan",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does bedsheet size conversion work?",
