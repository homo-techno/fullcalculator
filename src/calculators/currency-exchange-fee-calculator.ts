...
export const currencyExchangeFeeCalculator: CalculatorDefinition = {
  slug: "currency-exchange-fee-calculator",
  title: "Currency Exchange Fee Calculator",
  description: "Free currency exchange fee calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["currency exchange fee calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Currency Exchange Fee",
      description: "Calculate currency exchange fee",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the currency exchange fee calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
