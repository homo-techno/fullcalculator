...
export const musicStreamingRoyaltyCalculator: CalculatorDefinition = {
  slug: "music-streaming-royalty-calculator",
  title: "Music Streaming Royalty Calculator",
  description: "Free music streaming royalty calculator. Estimate streaming revenue",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["music streaming royalty calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Music Streaming Royalty",
    description: "Estimate streaming revenue",
    fields: [
