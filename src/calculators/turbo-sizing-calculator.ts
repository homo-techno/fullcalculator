...
export const turboSizingCalculator: CalculatorDefinition = {
  slug: "turbo-sizing-calculator",
  title: "Turbo Sizing Calculator",
  description: "Free turbo sizing calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["turbo sizing calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
    name: "Turbo Sizing",
    description: "",
