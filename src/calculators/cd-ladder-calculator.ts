...
export const cdLadderCalculator: CalculatorDefinition = {
  slug: "cd-ladder-calculator",
  title: "Cd Ladder Calculator",
  description: "Free cd ladder calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["cd ladder calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cd Ladder",
      description: "Calculate cd ladder",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the cd ladder calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
