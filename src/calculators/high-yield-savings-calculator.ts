...
export const highYieldSavingsCalculator: CalculatorDefinition = {
  slug: "high-yield-savings-calculator",
  title: "High Yield Savings Calculator",
  description: "Free high yield savings calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["high yield savings calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "High Yield Savings",
      description: "Calculate high yield savings",
      fields: [
        {
          name: "income",
  ...
  faq: [
    { question: "How does the high yield savings calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
