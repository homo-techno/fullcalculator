...
export const smokingCostCalculator: CalculatorDefinition = {
  slug: "smoking-cost-calculator",
  title: "Smoking Cost Calculator",
  description: "Free smoking cost calculator. Quickly calculate and plan your smoking cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["smoking cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Smoking Cost",
  ...
  faq: [
    {
      question: "How does the smoking cost work?",
