...
export const rpgStatCalculator: CalculatorDefinition = {
  slug: "rpg-stat-calculator",
  title: "RPG Stat Calculator",
  description: "Free rpg stat calculator. Optimize RPG character stats",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["rpg stat calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "RPG Stat",
    description: "Optimize RPG character stats",
    fields: [
