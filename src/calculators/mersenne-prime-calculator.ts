...
export const mersennePrimeCalculator: CalculatorDefinition = {
  slug: "mersenne-prime-calculator",
  title: "Mersenne Prime Calculator",
  description: "Free mersenne prime calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["mersenne prime calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Mersenne Prime",
      description: "Calculate mersenne prime",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the mersenne prime calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
