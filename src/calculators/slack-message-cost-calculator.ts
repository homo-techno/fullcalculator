...
export const slackMessageCostCalculator: CalculatorDefinition = {
  slug: "slack-message-cost-calculator",
  title: "Slack Message Cost Calculator",
  description: "Free slack message cost calculator. Quickly calculate and plan your slack message cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["slack message cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Slack Message Cost",
      description: "Free slack message cost calculator. Quickly calculate and plan your slack messag",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the slack message cost work?",
