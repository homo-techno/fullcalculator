...
export const homeStagingCostCalculator: CalculatorDefinition = {
  slug: "home-staging-cost-calculator",
  title: "Home Staging Cost Calculator",
  description: "Free home staging cost calculator. Quickly calculate and plan your home staging cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["home staging cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Home Staging Cost",
      description: "Free home staging cost calculator. Quickly calculate and plan your home staging ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the home staging cost work?",
