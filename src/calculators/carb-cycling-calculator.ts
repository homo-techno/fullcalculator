...
export const carbCyclingCalculator: CalculatorDefinition = {
  slug: "carb-cycling-calculator",
  title: "Carb Cycling Calculator",
  description: "Free carb cycling calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["carb cycling calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Carb Cycling",
      description: "Free carb cycling calculator. Get personalized health insights based on your pro",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the carb cycling work?",
