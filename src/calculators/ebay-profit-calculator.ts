...
export const ebayProfitCalculator: CalculatorDefinition = {
  slug: "ebay-profit-calculator",
  title: "eBay Profit Calculator",
  description: "Free ebay profit calculator. Calculate your eBay selling profit after fees, shipping, and cost of goods.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["ebay profit", "ebay fees", "ebay calculator", "profit calculator"],
  variants: [
    {
      id: "standard",
      name: "eBay Profit",
      description: "Free ebay profit calculator. Calculate your eBay selling profit after fees, ship",
      fields: [
        {
          name: "salePrice",
          label: "Sale Price",
      ...
      calculate: (inputs) => {
        ...
        const platformFee = revenue * 0.1289;
        const ccFee = revenue * 0 + 0;
  ...
  faq: [
    {
      question: "How are eBay fees calculated?",
      answer: "eBay charges approximately 12.9% in seller fees plus payment processing fees. The exact structure may vary.",
    },
    {
      question: "What is a good profit margin on eBay?",
      answer: "A healthy profit margin on eBay is typically 30-50% after all fees. Margins below 20% may not be sustainable long-term.",
    }
  ],
