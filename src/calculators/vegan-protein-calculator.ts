...
export const veganProteinCalculator: CalculatorDefinition = {
  slug: "vegan-protein-calculator",
  title: "Vegan Protein Calculator",
  description: "Free vegan protein calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["vegan protein calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Vegan Protein",
      description: "Free vegan protein calculator. Get personalized health insights based on your pr",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the vegan protein work?",
