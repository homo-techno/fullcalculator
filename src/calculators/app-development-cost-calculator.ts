...
export const appDevelopmentCostCalculator: CalculatorDefinition = {
  slug: "app-development-cost-calculator",
  title: "App Development Cost Calculator",
  description: "Free app development cost calculator. Quickly calculate and plan your app development cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["app development cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "App Development Cost",
      description: "Free app development cost calculator. Quickly calculate and plan your app develo",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the app development cost work?",
