...
export const cableVsStreamingCalculator: CalculatorDefinition = {
  slug: "cable-vs-streaming-calculator",
  title: "Cable Vs Streaming Calculator",
  description: "Free cable vs streaming calculator. Quickly calculate and plan your cable vs streaming needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["cable vs streaming calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Cable Vs Streaming",
      description: "Free cable vs streaming calculator. Quickly calculate and plan your cable vs str",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the cable vs streaming work?",
