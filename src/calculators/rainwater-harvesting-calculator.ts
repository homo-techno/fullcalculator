...
export const rainwaterHarvestingCalculator: CalculatorDefinition = {
  slug: "rainwater-harvesting-calculator",
  title: "Rainwater Harvesting Calculator",
  description: "Free rainwater harvesting calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["rainwater harvesting calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Rainwater Harvesting",
      description: "Calculate rainwater harvesting",
      fields: [
        {
          name: "input1",
          label: "Primary Input",
  ...
  faq: [
    { question: "How does the rainwater harvesting calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
