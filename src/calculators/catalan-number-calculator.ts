...
export const catalanNumberCalculator: CalculatorDefinition = {
  slug: "catalan-number-calculator",
  title: "Catalan Number Calculator",
  description: "Free catalan number calculator. Solve catalan number problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["catalan number calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Catalan Number",
      description: "Free catalan number calculator. Solve catalan number problems with step-by-step ",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Catalan Number?",
      answer: "Catalan Number is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
