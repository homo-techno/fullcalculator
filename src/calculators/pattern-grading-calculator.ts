...
export const patternGradingCalculator: CalculatorDefinition = {
  slug: "pattern-grading-calculator",
  title: "Pattern Grading Calculator",
  description: "Free pattern grading calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pattern grading calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
