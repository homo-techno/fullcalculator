...
export const skiingCalorieCalculator: CalculatorDefinition = {
  slug: "skiing-calorie-calculator",
  title: "Skiing Calorie Calculator",
  description: "Free skiing calorie calculator. Calculate calories burned during skiing based on your weight and duration.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["skiing calorie calculator", "calories burned", "exercise calculator"],
  variants: [
    {
      id: "standard",
      name: "Calories Burned",
      description: "Calculate calories burned during skiing",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How many calories does skiing burn?",
      answer: "A 70kg person burns approximately 245 calories in 30 minutes of moderate skiing.",
    },
    {
