...
export const websiteHostingCostCalculator: CalculatorDefinition = {
  slug: "website-hosting-cost-calculator",
  title: "Website Hosting Cost Calculator",
  description: "Free website hosting cost calculator. Quickly calculate and plan your website hosting cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["website hosting cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Website Hosting Cost",
      description: "Free website hosting cost calculator. Quickly calculate and plan your website ho",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the website hosting cost work?",
