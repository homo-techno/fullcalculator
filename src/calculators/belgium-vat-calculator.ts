...
export const belgiumVatCalculator: CalculatorDefinition = {
  slug: "belgium-vat-calculator",
  title: "Belgium VAT Calculator",
  description: "Free Belgium VAT calculator at 21%. Calculate VAT amount and total price including tax.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["belgium vat calculator", "belgium vat calculator", "belgium tax calculator"],
  variants: [{
    id: "standard",
    name: "Belgium VAT",
    description: "Free Belgium VAT calculator at 21%",
    fields: [
  ...
  faq: [
    { question: "What is the VAT rate in Belgium?", answer: "The standard VAT rate in Belgium is 21%." },
