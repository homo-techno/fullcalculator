...
export const pmiRemovalCalculator: CalculatorDefinition = {
  slug: "pmi-removal-calculator",
  title: "PMI Removal Calculator",
  description: "Free pmi removal calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["pmi removal calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "PMI Removal",
      description: "Free pmi removal calculator. Plan your finances with accurate calculations and p",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the PMI Removal Calculator calculate?",
      answer: "This calculator helps you estimate pmi removal based on your specific financial situation and inputs.",
    },
    {
