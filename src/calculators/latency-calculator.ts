...
export const latencyCalculator: CalculatorDefinition = {
  slug: "latency-calculator",
  title: "Latency Calculator",
  description: "Free latency calculator. Quickly calculate and plan your latency needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["latency calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Latency",
  ...
  faq: [
    {
      question: "How does the latency work?",
