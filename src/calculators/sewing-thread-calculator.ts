...
export const sewingThreadCalculator: CalculatorDefinition = {
  slug: "sewing-thread-calculator",
  title: "Sewing Thread Calculator",
  description: "Free sewing thread calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["sewing thread calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Sewing Thread",
