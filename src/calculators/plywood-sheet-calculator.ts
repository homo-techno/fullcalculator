...
export const plywoodSheetCalculator: CalculatorDefinition = {
  slug: "plywood-sheet-calculator",
  title: "Plywood Sheet Calculator",
  description: "Free plywood sheet calculator. Woodworking planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["plywood sheet calculator", "woodworking calculator", "carpentry tool"],
  variants: [{
    id: "standard",
    name: "Plywood Sheet",
