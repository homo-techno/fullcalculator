...
export const orthodontistCostCalculator: CalculatorDefinition = {
  slug: "orthodontist-cost-calculator",
  title: "Orthodontist Cost Calculator",
  description: "Free orthodontist cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["orthodontist cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Orthodontist Cost",
  ...
  faq: [
    { question: "How much does orthodontist cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
