...
export const calciumNeedsCalculator: CalculatorDefinition = {
  slug: "calcium-needs-calculator",
  title: "Calcium Needs Calculator",
  description: "Free calcium needs calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["calcium needs calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Calcium Needs",
      description: "Free calcium needs calculator. Get personalized health insights based on your pr",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How does the calcium needs work?",
