...
export const fpsCalculator: CalculatorDefinition = {
  slug: "fps-calculator",
  title: "FPS Calculator",
  description: "Free fps calculator. Estimate frames per second",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["fps calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "FPS",
    description: "Estimate frames per second",
    fields: [
