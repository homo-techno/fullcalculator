...
export const galaxyRecessionVelocityCalculator: CalculatorDefinition = {
  slug: "galaxy-recession-velocity-calculator",
  title: "Galaxy Recession Velocity Calculator",
  description: "Free galaxy recession velocity calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["galaxy recession velocity calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Galaxy Recession Velocity",
      description: "Calculate galaxy recession velocity",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the galaxy recession velocity calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
