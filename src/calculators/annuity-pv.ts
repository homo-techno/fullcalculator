...
export const annuityPvCalculator: CalculatorDefinition = {
  slug: "annuity-pv",
  title: "Annuity Present Value Calculator",
  description: "Free annuity present value calculator. Get accurate results instantly.",
  category: "Finance",
  ...
  faq: [
    { question: "How to calculate annuity present value?", answer: "Enter your values and get instant results." },
