...
export const carDetailingCostCalculator: CalculatorDefinition = {
  slug: "car-detailing-cost-calculator",
  title: "Car Detailing Cost Calculator",
  description: "Free car detailing cost calculator. Quickly calculate and plan your car detailing cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["car detailing cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Car Detailing Cost",
      description: "Free car detailing cost calculator. Quickly calculate and plan your car detailin",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the car detailing cost work?",
