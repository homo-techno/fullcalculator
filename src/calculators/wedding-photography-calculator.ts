...
export const weddingPhotographyCalculator: CalculatorDefinition = {
  slug: "wedding-photography-calculator",
  title: "Wedding Photography Calculator",
  description: "Free wedding photography calculator. Quickly calculate and plan your wedding photography needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["wedding photography calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Wedding Photography",
      description: "Free wedding photography calculator. Quickly calculate and plan your wedding pho",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the wedding photography work?",
