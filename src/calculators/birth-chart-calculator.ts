...
export const birthChartCalculator: CalculatorDefinition = {
  slug: "birth-chart-calculator",
  title: "Birth Chart Calculator",
  description: "Free birth chart calculator. Generate basic natal chart info",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["birth chart calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Birth Chart",
    description: "Generate basic natal chart info",
    fields: [
