...
export const equityCompensationCalculator: CalculatorDefinition = {
  slug: "equity-compensation-calculator",
  title: "Equity Compensation Calculator",
  description: "Free equity compensation calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["equity compensation calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Equity Compensation",
      description: "Free equity compensation calculator. Plan your finances with accurate calculatio",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Equity Compensation Calculator calculate?",
      answer: "This calculator helps you estimate equity compensation based on your specific financial situation and inputs.",
    },
    {
