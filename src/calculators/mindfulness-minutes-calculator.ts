...
export const mindfulnessMinutesCalculator: CalculatorDefinition = {
  slug: "mindfulness-minutes-calculator",
  title: "Mindfulness Minutes Calculator",
  description: "Free mindfulness minutes calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["mindfulness minutes calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Mindfulness Minutes",
      description: "Free mindfulness minutes calculator. Get personalized health insights based on y",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the mindfulness minutes work?",
