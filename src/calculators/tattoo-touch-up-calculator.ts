...
export const tattooTouchUpCalculator: CalculatorDefinition = {
  slug: "tattoo-touch-up-calculator",
  title: "Tattoo Touch Up Calculator",
  description: "Free tattoo touch up calculator. Estimate touch-up session needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo touch up calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Touch Up",
    description: "Estimate touch-up session needs",
    fields: [
