...
export const zipperLengthCalculator: CalculatorDefinition = {
  slug: "zipper-length-calculator",
  title: "Zipper Length Calculator",
  description: "Free zipper length calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["zipper length calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Zipper Length",
