...
export const qualifiedOpportunityZoneCalculator: CalculatorDefinition = {
  slug: "qualified-opportunity-zone-calculator",
  title: "Qualified Opportunity Zone Calculator",
  description: "Free qualified opportunity zone calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["qualified opportunity zone calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Qualified Opportunity Zone",
      description: "Calculate qualified opportunity zone",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the qualified opportunity zone calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
