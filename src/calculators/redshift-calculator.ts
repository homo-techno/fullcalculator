...
export const redshiftCalculator: CalculatorDefinition = {
  ...
  description: "Free redshift calculator. Calculate redshift values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["redshift calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Redshift",
  ...
  faq: [
    {
      ...
      answer: "Redshift is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
