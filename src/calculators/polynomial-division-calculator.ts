...
export const polynomialDivisionCalculator: CalculatorDefinition = {
  slug: "polynomial-division-calculator",
  title: "Polynomial Division Calculator",
  description: "Free polynomial division calculator. Solve polynomial division problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["polynomial division calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Polynomial Division",
      description: "Free polynomial division calculator. Solve polynomial division problems with ste",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Polynomial Division?",
      answer: "Polynomial Division is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
