...
export const deBroglieWavelengthCalculator: CalculatorDefinition = {
  slug: "de-broglie-wavelength-calculator",
  title: "De Broglie Wavelength Calculator",
  description: "Free de broglie wavelength calculator. Calculate de broglie wavelength values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["de broglie wavelength calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "De Broglie Wavelength",
      description: "Free de broglie wavelength calculator. Calculate de broglie wavelength values fo",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      ...
      answer: "De Broglie Wavelength is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
