...
export const octagonCalculator: CalculatorDefinition = {
  slug: "octagon-calculator",
  title: "Octagon Calculator",
  description: "Free octagon calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["octagon calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Octagon",
      description: "Calculate octagon",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the octagon calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
