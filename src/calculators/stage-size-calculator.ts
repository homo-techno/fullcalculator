...
export const stageSizeCalculator: CalculatorDefinition = {
  slug: "stage-size-calculator",
  title: "Stage Size Calculator",
  description: "Free stage size calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["stage size calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate stage size costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does stage size cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
