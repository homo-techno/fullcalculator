...
export const pressureWashingCostCalculator: CalculatorDefinition = {
  slug: "pressure-washing-cost-calculator",
  title: "Pressure Washing Cost Calculator",
  description: "Free pressure washing cost calculator. Quickly calculate and plan your pressure washing cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pressure washing cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Pressure Washing Cost",
      description: "Free pressure washing cost calculator. Quickly calculate and plan your pressure ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the pressure washing cost work?",
