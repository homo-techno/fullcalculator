...
export const starMagnitudeCalculator: CalculatorDefinition = {
  slug: "star-magnitude-calculator",
  title: "Star Magnitude Calculator",
  description: "Free star magnitude calculator. Calculate star magnitude values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["star magnitude calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Star Magnitude",
      description: "Free star magnitude calculator. Calculate star magnitude values for research and",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Star Magnitude?",
      answer: "Star Magnitude is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
