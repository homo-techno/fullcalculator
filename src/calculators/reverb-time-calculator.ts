...
export const reverbTimeCalculator: CalculatorDefinition = {
  slug: "reverb-time-calculator",
  title: "Reverb Time Calculator",
  description: "Free reverb time calculator. Calculate RT60 reverb decay time",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["reverb time calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Reverb Time",
    description: "Calculate RT60 reverb decay time",
    fields: [
