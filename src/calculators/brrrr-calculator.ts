...
export const brrrrCalculator: CalculatorDefinition = {
  slug: "brrrr-calculator",
  title: "BRRRR Calculator",
  description: "Free brrrr calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["brrrr calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "BRRRR",
      description: "Free brrrr calculator. Plan your finances with accurate calculations and project",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the BRRRR Calculator calculate?",
      answer: "This calculator helps you estimate brrrr based on your specific financial situation and inputs.",
    },
    {
