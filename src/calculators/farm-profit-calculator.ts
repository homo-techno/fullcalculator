...
export const farmProfitCalculator: CalculatorDefinition = {
  slug: "farm-profit-calculator",
  title: "Farm Profit Calculator",
  description: "Free farm profit calculator. Estimate farming operation profitability",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["farm profit calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Farm Profit",
    description: "Estimate farming operation profitability",
    fields: [
