...
export const uploadSpeedCalculator: CalculatorDefinition = {
  slug: "upload-speed-calculator",
  title: "Upload Speed Calculator",
  description: "Free upload speed calculator. Convert and calculate upload speed values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["upload speed calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Upload Speed",
      description: "Free upload speed calculator. Convert and calculate upload speed values instantl",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does upload speed conversion work?",
