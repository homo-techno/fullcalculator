...
export const resortFeeCalculator: CalculatorDefinition = {
  slug: "resort-fee-calculator",
  title: "Resort Fee Calculator",
  description: "Free resort fee calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["resort fee calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Resort Fee",
      description: "Calculate resort fee",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the resort fee calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
