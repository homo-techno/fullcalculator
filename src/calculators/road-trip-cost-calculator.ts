...
export const roadTripCostCalculator: CalculatorDefinition = {
  slug: "road-trip-cost-calculator",
  title: "Road Trip Cost Calculator",
  description: "Free road trip cost calculator. Quickly calculate and plan your road trip cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["road trip cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Road Trip Cost",
      description: "Free road trip cost calculator. Quickly calculate and plan your road trip cost n",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the road trip cost work?",
