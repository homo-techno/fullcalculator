...
export const risingSignCalculator: CalculatorDefinition = {
  slug: "rising-sign-calculator",
  title: "Rising Sign Calculator",
  description: "Free rising sign calculator. Calculate your ascendant sign",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["rising sign calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Rising Sign",
    description: "Calculate your ascendant sign",
    fields: [
