...
export const probioticsCalculator: CalculatorDefinition = {
  slug: "probiotics-calculator",
  title: "Probiotics Calculator",
  description: "Free probiotics calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["probiotics calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Probiotics",
      description: "Calculate probiotics",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the probiotics calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
