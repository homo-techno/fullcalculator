...
export const courtCostCalculator: CalculatorDefinition = {
  slug: "court-cost-calculator",
  title: "Court Cost Calculator",
  description: "Free court cost calculator. Calculate court filing and related fees",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["court cost calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Court Cost",
    description: "Calculate court filing and related fees",
    fields: [
