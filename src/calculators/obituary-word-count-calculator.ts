...
export const obituaryWordCountCalculator: CalculatorDefinition = {
  slug: "obituary-word-count-calculator",
  title: "Obituary Word Count Calculator",
  description: "Free obituary word count calculator. Quickly calculate and plan your obituary word count needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["obituary word count calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Obituary Word Count",
      description: "Free obituary word count calculator. Quickly calculate and plan your obituary wo",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the obituary word count work?",
