...
export const vinylRecordCalculator: CalculatorDefinition = {
  slug: "vinyl-record-calculator",
  title: "Vinyl Record Calculator",
  description: "Free vinyl record calculator. Calculate vinyl record playing time",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["vinyl record calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Vinyl Record",
    description: "Calculate vinyl record playing time",
    fields: [
