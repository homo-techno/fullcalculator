...
export const retirementPartyCalculator: CalculatorDefinition = {
  slug: "retirement-party-calculator",
  title: "Retirement Party Calculator",
  description: "Free retirement party calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["retirement party calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate retirement party costs",
      fields: [
        {
          name: "guests",
  ...
  faq: [
    { question: "How much does retirement party cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
