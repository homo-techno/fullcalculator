...
export const pantryOrganizationCalculator: CalculatorDefinition = {
  slug: "pantry-organization-calculator",
  title: "Pantry Organization Calculator",
  description: "Free pantry organization calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["pantry organization calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
