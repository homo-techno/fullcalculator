...
export const envelopeSizeCalculator: CalculatorDefinition = {
  slug: "envelope-size-calculator",
  title: "Envelope Size Calculator",
  description: "Free envelope size calculator. Quickly calculate and plan your envelope size needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["envelope size calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Envelope Size",
      description: "Free envelope size calculator. Quickly calculate and plan your envelope size nee",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the envelope size work?",
