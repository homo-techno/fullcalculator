...
export const errorPropagationCalculator: CalculatorDefinition = {
  slug: "error-propagation-calculator",
  title: "Error Propagation Calculator",
  description: "Free error propagation calculator. Advanced math and computation tool.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["error propagation calculator", "math calculator", "computation tool"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "What is error propagation?", answer: "A mathematical concept used in computation and analysis. This calculator helps you solve related problems." },
