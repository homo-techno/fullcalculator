...
export const dndDamageCalculator: CalculatorDefinition = {
  slug: "dnd-damage-calculator",
  title: "DnD Damage Calculator",
  description: "Free dnd damage calculator. Calculate D&D attack damage",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["dnd damage calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "DnD Damage",
    description: "Calculate D&D attack damage",
    fields: [
