...
export const dietBreakCalculator: CalculatorDefinition = {
  slug: "diet-break-calculator",
  title: "Diet Break Calculator",
  description: "Free diet break calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["diet break calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Diet Break",
      description: "Calculate diet break",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the diet break calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
