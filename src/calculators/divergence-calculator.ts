...
export const divergenceCalculator: CalculatorDefinition = {
  slug: "divergence-calculator",
  title: "Divergence Calculator",
  description: "Free divergence calculator. Solve divergence problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["divergence calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Divergence",
      description: "Free divergence calculator. Solve divergence problems with step-by-step calculat",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      ...
      answer: "Divergence is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
