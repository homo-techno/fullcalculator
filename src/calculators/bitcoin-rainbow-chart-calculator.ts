...
export const bitcoinRainbowChartCalculator: CalculatorDefinition = {
  slug: "bitcoin-rainbow-chart-calculator",
  title: "Bitcoin Rainbow Chart Calculator",
  description: "Free bitcoin rainbow chart calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["bitcoin rainbow chart calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Bitcoin Rainbow Chart",
      description: "Calculate bitcoin rainbow chart",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the bitcoin rainbow chart calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
