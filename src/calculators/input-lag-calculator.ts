...
export const inputLagCalculator: CalculatorDefinition = {
  slug: "input-lag-calculator",
  title: "Input Lag Calculator",
  description: "Free input lag calculator. Calculate total input delay",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["input lag calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "Input Lag",
    description: "Calculate total input delay",
    fields: [
