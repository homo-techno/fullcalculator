...
export const cashOutRefiCalculator: CalculatorDefinition = {
  slug: "cash-out-refi-calculator",
  title: "Cash Out Refinance Calculator",
  description: "Free cash out refinance calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["cash out refinance calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Cash Out Refinance",
      description: "Free cash out refinance calculator. Plan your finances with accurate calculation",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Cash Out Refinance Calculator calculate?",
      answer: "This calculator helps you estimate cash out refinance based on your specific financial situation and inputs.",
    },
    {
