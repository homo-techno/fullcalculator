...
export const liverFunctionCalculator: CalculatorDefinition = {
  slug: "liver-function-calculator",
  title: "Liver Function Calculator",
  description: "Free liver function calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["liver function calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Liver Function",
      description: "Free liver function calculator. Get personalized health insights based on your p",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the liver function work?",
