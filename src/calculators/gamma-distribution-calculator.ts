...
export const gammaDistributionCalculator: CalculatorDefinition = {
  slug: "gamma-distribution-calculator",
  title: "Gamma Distribution Calculator",
  description: "Free gamma distribution calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["gamma distribution calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Gamma Distribution",
      description: "Calculate gamma distribution",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the gamma distribution calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
