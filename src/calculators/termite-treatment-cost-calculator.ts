...
export const termiteTreatmentCostCalculator: CalculatorDefinition = {
  slug: "termite-treatment-cost-calculator",
  title: "Termite Treatment Cost Calculator",
  description: "Free termite treatment cost calculator. Quickly calculate and plan your termite treatment cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["termite treatment cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Termite Treatment Cost",
      description: "Free termite treatment cost calculator. Quickly calculate and plan your termite ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the termite treatment cost work?",
