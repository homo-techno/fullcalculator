...
export const smithNumberCalculator: CalculatorDefinition = {
  slug: "smith-number-calculator",
  title: "Smith Number Calculator",
  description: "Free smith number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["smith number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Smith Number",
      description: "Calculate smith number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the smith number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
