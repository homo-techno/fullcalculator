...
export const geneticDistanceCalculator: CalculatorDefinition = {
  slug: "genetic-distance-calculator",
  title: "Genetic Distance Calculator",
  description: "Free genetic distance calculator. Biology and environmental science calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["genetic distance calculator", "biology calculator", "science tool"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "What is genetic distance?", answer: "This is a concept in biology/environmental science. The calculator helps you compute related values for study or research." },
