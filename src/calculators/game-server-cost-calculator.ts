...
export const gameServerCostCalculator: CalculatorDefinition = {
  slug: "game-server-cost-calculator",
  title: "Game Server Cost Calculator",
  description: "Free game server cost calculator. Estimate game hosting costs",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["game server cost calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "Game Server Cost",
    description: "Estimate game hosting costs",
    fields: [
