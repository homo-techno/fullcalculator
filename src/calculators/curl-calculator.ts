...
export const curlCalculator: CalculatorDefinition = {
  slug: "curl-calculator",
  title: "Curl Calculator",
  description: "Free curl calculator. Solve curl problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["curl calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Curl",
  ...
  faq: [
    {
      ...
      answer: "Curl is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
