...
export const cardanoStakingCalculator: CalculatorDefinition = {
  slug: "cardano-staking-calculator",
  title: "Cardano Staking Calculator",
  description: "Free cardano staking calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["cardano staking calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Cardano Staking",
      description: "Calculate cardano staking",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the cardano staking calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
