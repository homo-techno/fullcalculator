...
export const zodiacCompatibilityCalculator: CalculatorDefinition = {
  slug: "zodiac-compatibility-calculator",
  title: "Zodiac Compatibility Calculator",
  description: "Free zodiac compatibility calculator. Check zodiac sign compatibility",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["zodiac compatibility calculator", "astrology calculator", "numerology"],
  variants: [{
    id: "standard",
    name: "Zodiac Compatibility",
    description: "Check zodiac sign compatibility",
    fields: [
