...
export const vehicleRegistrationCalculator: CalculatorDefinition = {
  slug: "vehicle-registration-calculator",
  title: "Vehicle Registration Calculator",
  description: "Free vehicle registration calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["vehicle registration calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
