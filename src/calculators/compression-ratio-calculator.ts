...
export const compressionRatioCalculator: CalculatorDefinition = {
  slug: "compression-ratio-calculator",
  title: "Compression Ratio Calculator",
  description: "Free compression ratio calculator. Automotive calculation and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["compression ratio calculator", "auto calculator", "car tool"],
  variants: [{
    id: "standard",
