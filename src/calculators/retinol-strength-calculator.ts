...
export const retinolStrengthCalculator: CalculatorDefinition = {
  slug: "retinol-strength-calculator",
  title: "Retinol Strength Calculator",
  description: "Free retinol strength calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["retinol strength calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Retinol Strength",
      description: "Free retinol strength calculator. Get personalized health insights based on your",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the retinol strength work?",
