...
export const tattooPlacementCalculator: CalculatorDefinition = {
  slug: "tattoo-placement-calculator",
  title: "Tattoo Placement Calculator",
  description: "Free tattoo placement calculator. Find ideal tattoo placement by size.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo placement calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Placement",
    description: "Find ideal tattoo placement by size",
    fields: [
