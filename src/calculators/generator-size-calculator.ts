...
export const generatorSizeCalculator: CalculatorDefinition = {
  slug: "generator-size-calculator",
  title: "Generator Size Calculator",
  description: "Free generator size calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["generator size calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate generator size costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does generator size cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
