...
export const centralAngleCalculator: CalculatorDefinition = {
  slug: "central-angle-calculator",
  title: "Central Angle Calculator",
  description: "Free central angle calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["central angle calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Central Angle",
      description: "Calculate central angle",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the central angle calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
