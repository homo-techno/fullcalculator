...
export const resaleProfitCalculator: CalculatorDefinition = {
  slug: "resale-profit-calculator",
  title: "Resale Profit Calculator",
  description: "Free resale profit calculator. Calculate your Resale selling profit after fees, shipping, and cost of goods.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["resale profit", "resale fees", "resale calculator", "profit calculator"],
  variants: [
    {
      id: "standard",
      name: "Resale Profit",
      description: "Free resale profit calculator. Calculate your Resale selling profit after fees, ",
      fields: [
        {
          name: "salePrice",
          label: "Sale Price",
  ...
  faq: [
    {
      question: "How are Resale fees calculated?",
      answer: "Resale charges approximately 0.0% in seller fees plus payment processing fees. The exact structure may vary.",
    },
    {
      question: "What is a good profit margin on Resale?",
      answer: "A healthy profit margin on Resale is typically 30-50% after all fees. Margins below 20% may not be sustainable long-term.",
    }
  ],
