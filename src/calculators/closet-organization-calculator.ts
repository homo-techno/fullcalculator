...
export const closetOrganizationCalculator: CalculatorDefinition = {
  slug: "closet-organization-calculator",
  title: "Closet Organization Calculator",
  description: "Free closet organization calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["closet organization calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
