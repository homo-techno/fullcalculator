...
export const fourplexInvestmentCalculator: CalculatorDefinition = {
  slug: "fourplex-investment-calculator",
  title: "Fourplex Investment Calculator",
  description: "Free fourplex investment calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["fourplex investment calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Fourplex Investment",
      description: "Calculate fourplex investment",
      fields: [
        {
          name: "amount",
  ...
  faq: [
    { question: "How does the fourplex investment calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
