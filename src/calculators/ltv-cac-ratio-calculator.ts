...
export const ltvCacRatioCalculator: CalculatorDefinition = {
  slug: "ltv-cac-ratio-calculator",
  title: "Ltv Cac Ratio Calculator",
  description: "Free ltv cac ratio calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["ltv cac ratio calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Ltv Cac Ratio",
  ...
  faq: [
    { question: "How does the ltv cac ratio calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
