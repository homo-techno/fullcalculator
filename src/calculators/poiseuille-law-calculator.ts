...
export const poiseuilleLawCalculator: CalculatorDefinition = {
  slug: "poiseuille-law-calculator",
  title: "Poiseuille Law Calculator",
  description: "Free poiseuille law calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["poiseuille law calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Poiseuille Law",
      description: "Calculate poiseuille law",
      fields: [
        {
          name: "v1",
          label: "Value 1",
  ...
  faq: [
    { question: "How does the poiseuille law calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
