...
export const gamingPcBottleneckCalculator: CalculatorDefinition = {
  slug: "gaming-pc-bottleneck-calculator",
  title: "Gaming PC Bottleneck Calculator",
  description: "Free gaming pc bottleneck calculator. Check CPU/GPU bottleneck",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["gaming pc bottleneck calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "Gaming PC Bottleneck",
    description: "Check CPU/GPU bottleneck",
    fields: [
