...
export const tokenomicsCalculator: CalculatorDefinition = {
  slug: "tokenomics-calculator",
  title: "Tokenomics Calculator",
  description: "Free tokenomics calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["tokenomics calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Tokenomics",
      description: "Calculate tokenomics",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the tokenomics calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
