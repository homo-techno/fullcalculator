...
export const formulaFeedingCalculator: CalculatorDefinition = {
  slug: "formula-feeding-calculator",
  title: "Formula Feeding Calculator",
  description: "Free formula feeding calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["formula feeding calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Formula Feeding",
      description: "Free formula feeding calculator. Get personalized health insights based on your ",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the formula feeding work?",
