...
export const physicalTherapyCostCalculator: CalculatorDefinition = {
  slug: "physical-therapy-cost-calculator",
  title: "Physical Therapy Cost Calculator",
  description: "Free physical therapy cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["physical therapy cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Physical Therapy Cost",
  ...
  faq: [
    { question: "How much does physical therapy cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
