...
export const vitaminCCalculator: CalculatorDefinition = {
  slug: "vitamin-c-calculator",
  title: "Vitamin C Calculator",
  description: "Free vitamin c calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["vitamin c calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Vitamin C",
      description: "Calculate vitamin c",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the vitamin c calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
