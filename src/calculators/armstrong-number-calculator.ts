...
export const armstrongNumberCalculator: CalculatorDefinition = {
  slug: "armstrong-number-calculator",
  title: "Armstrong Number Calculator",
  description: "Free armstrong number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["armstrong number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Armstrong Number",
      description: "Calculate armstrong number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the armstrong number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
