...
export const projectorThrowCalculator: CalculatorDefinition = {
  slug: "projector-throw-calculator",
  title: "Projector Throw Calculator",
  description: "Free projector throw calculator. Convert and calculate projector throw values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["projector throw calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Projector Throw",
      description: "Free projector throw calculator. Convert and calculate projector throw values in",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does projector throw conversion work?",
