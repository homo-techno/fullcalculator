...
export const richterScaleCalculator: CalculatorDefinition = {
  slug: "richter-scale-calculator",
  title: "Richter Scale Calculator",
  description: "Free richter scale calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["richter scale calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Richter Scale",
      description: "Calculate richter scale",
      fields: [
        {
          name: "input1",
          label: "Primary Input",
  ...
  faq: [
    { question: "How does the richter scale calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
