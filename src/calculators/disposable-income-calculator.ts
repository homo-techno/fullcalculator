...
export const disposableIncomeCalculator: CalculatorDefinition = {
  slug: "disposable-income-calculator",
  title: "Disposable Income Calculator",
  description: "Free disposable income calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["disposable income calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the disposable income calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
