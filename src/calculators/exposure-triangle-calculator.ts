...
export const exposureTriangleCalculator: CalculatorDefinition = {
  slug: "exposure-triangle-calculator",
  title: "Exposure Triangle Calculator",
  description: "Free exposure triangle calculator. Photography exposure and settings calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["exposure triangle calculator", "photography calculator", "camera settings"],
  variants: [{
    id: "standard",
