...
export const bulkModulusCalculator: CalculatorDefinition = {
  slug: "bulk-modulus-calculator",
  title: "Bulk Modulus Calculator",
  description: "Free bulk modulus calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["bulk modulus calculator", "physics calculator", "science tool"],
  variants: [
    {
      id: "standard",
      name: "Bulk Modulus",
      description: "Calculate bulk modulus",
      fields: [
        {
          name: "v1",
          label: "Value 1",
  ...
  faq: [
    { question: "How does the bulk modulus calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
