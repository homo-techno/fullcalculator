...
export const visaCostCalculator: CalculatorDefinition = {
  slug: "visa-cost-calculator",
  title: "Visa Cost Calculator",
  description: "Free visa cost calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["visa cost calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Visa Cost",
      description: "Calculate visa cost",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the visa cost calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
