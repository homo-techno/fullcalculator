...
export const priceElasticityCalculator: CalculatorDefinition = {
  slug: "price-elasticity-calculator",
  title: "Price Elasticity Calculator",
  description: "Free price elasticity calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["price elasticity calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the price elasticity calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
