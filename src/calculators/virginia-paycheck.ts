...
export const virginiaPaycheckCalculator: CalculatorDefinition = {
  slug: "virginia-paycheck-calculator",
  title: "Virginia Paycheck Calculator",
  description:
    "Free Virginia paycheck calculator. Estimate your take-home pay after federal taxes, Virginia state income tax, and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["virginia paycheck calculator", "virginia take home pay", "VA paycheck calculator", "virginia state tax", "virginia salary calculator", "virginia income tax calculator"],
  variants: [
    {
      id: "virginia-paycheck",
      name: "Virginia Paycheck Calculator",
      description: "Calculate your Virginia take-home pay after federal, state, and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        return {
          ...
          details: [
            ...
            { label: "Virginia State Tax", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["maryland-paycheck-calculator", "north-carolina-paycheck-calculator", "pennsylvania-paycheck-calculator"],
  faq: [
    {
      question: "What is the Virginia state income tax rate?",
      answer:
        "Virginia has progressive rates: 2% on the first ,000, 3% on ,001-,000, 5% on ,001-7,000, and 5.75% on income above 7,000.",
    },
    {
      question: "Does Virginia have local income taxes?",
      answer:
        "No direct local income taxes. Northern Virginia residents face high property taxes and cost of living.",
    },
    {
      question: "How does Virginia compare to Maryland?",
      answer:
        "Virginias top rate of 5.75% is similar to Marylands, but Maryland adds local taxes up to 3.2%. Virginias top bracket starts at just 7,000.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - Virginia State Tax - Social Security (6.2%) - Medicare (1.45%)",
};
