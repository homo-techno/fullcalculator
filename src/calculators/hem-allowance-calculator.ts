...
export const hemAllowanceCalculator: CalculatorDefinition = {
  slug: "hem-allowance-calculator",
  title: "Hem Allowance Calculator",
  description: "Free hem allowance calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hem allowance calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Hem Allowance",
