...
export const georgiaPaycheckCalculator: CalculatorDefinition = {
  slug: "georgia-paycheck-calculator",
  title: "Georgia Paycheck Calculator",
  description:
    "Free Georgia paycheck calculator. Estimate your take-home pay after federal taxes, Georgia flat state income tax (5.49%), and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["georgia paycheck calculator", "georgia take home pay", "GA paycheck calculator", "georgia state tax", "georgia salary calculator", "georgia income tax calculator"],
  variants: [
    {
      id: "georgia-paycheck",
      name: "Georgia Paycheck Calculator",
      description: "Calculate your Georgia take-home pay after federal, state (5.49% flat), and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        const stateTaxAnnual = annualIncome * 0.0549;
        ...
        return {
          ...
          details: [
            ...
            { label: "Georgia State Tax (5.49%)", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["florida-paycheck-calculator", "north-carolina-paycheck-calculator", "south-carolina-paycheck-calculator"],
  faq: [
    {
      question: "What is the Georgia state income tax rate?",
      answer:
        "Georgia transitioned to a flat income tax rate of 5.49% starting in 2024, down from a progressive system with rates up to 5.75%.",
    },
    {
      question: "Does Georgia have local income taxes?",
      answer:
        "No. Georgia does not have local income taxes. Local sales taxes vary by county.",
    },
    {
      question: "How does Georgias tax rate compare to neighboring states?",
      answer:
        "Georgias 5.49% flat rate is moderate. Florida and Tennessee have no state income tax, while North Carolina has a 4.5% flat rate.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - Georgia Flat Tax (5.49%) - Social Security (6.2%) - Medicare (1.45%)",
};
