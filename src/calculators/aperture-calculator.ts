...
export const apertureCalculator: CalculatorDefinition = {
  slug: "aperture-calculator",
  title: "Aperture Calculator",
  description: "Free aperture calculator. Photography exposure and settings calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["aperture calculator", "photography calculator", "camera settings"],
  variants: [{
    id: "standard",
    name: "Aperture",
