...
export const carpetCleaningCostCalculator: CalculatorDefinition = {
  slug: "carpet-cleaning-cost-calculator",
  title: "Carpet Cleaning Cost Calculator",
  description: "Free carpet cleaning cost calculator. Quickly calculate and plan your carpet cleaning cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["carpet cleaning cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Carpet Cleaning Cost",
      description: "Free carpet cleaning cost calculator. Quickly calculate and plan your carpet cle",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the carpet cleaning cost work?",
