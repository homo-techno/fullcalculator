...
export const identityTheftCostCalculator: CalculatorDefinition = {
  slug: "identity-theft-cost-calculator",
  title: "Identity Theft Cost Calculator",
  description: "Free identity theft cost calculator. Quickly calculate and plan your identity theft cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["identity theft cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Identity Theft Cost",
      description: "Free identity theft cost calculator. Quickly calculate and plan your identity th",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the identity theft cost work?",
