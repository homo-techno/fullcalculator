...
export const illinoisSalesTaxCalculator: CalculatorDefinition = {
  slug: "illinois-sales-tax-calculator",
  title: "Illinois Sales Tax Calculator",
  description: "Free Illinois sales tax calculator. Calculate Illinois sales tax on any purchase with state rate of 6.25% plus optional local taxes.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["illinois sales tax", "illinois tax calculator", "illinois sales tax rate", "IL sales tax"],
  variants: [{
    id: "calc",
    name: "Calculate Illinois Sales Tax",
    fields: [
  ...
  faq: [
    { question: "What is the Illinois sales tax rate?", answer: "The Illinois state sales tax rate is 6.25%. Local jurisdictions may add additional taxes." },
  ],
  formula: "Illinois Sales Tax = Purchase Amount × (State Rate + Local Rate)",
};
