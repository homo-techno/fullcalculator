...
export const illinoisPaycheckCalculator: CalculatorDefinition = {
  slug: "illinois-paycheck-calculator",
  title: "Illinois Paycheck Calculator",
  description:
    "Free Illinois paycheck calculator. Estimate your take-home pay after federal taxes, Illinois flat state income tax (4.95%), and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["illinois paycheck calculator", "illinois take home pay", "IL paycheck calculator", "illinois state tax", "illinois salary calculator", "illinois flat tax"],
  variants: [
    {
      id: "illinois-paycheck",
      name: "Illinois Paycheck Calculator",
      description: "Calculate your Illinois take-home pay after federal, state (4.95% flat), and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        const stateTaxAnnual = annualIncome * 0.0495;
        ...
        return {
          ...
          details: [
            ...
            { label: "Illinois State Tax (4.95%)", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["indiana-paycheck-calculator", "michigan-paycheck-calculator", "wisconsin-paycheck-calculator"],
  faq: [
    {
      question: "What is the Illinois state income tax rate?",
      answer:
        "Illinois has a flat state income tax rate of 4.95% on all taxable income regardless of income level.",
    },
    {
      question: "Does Illinois have any local income taxes?",
      answer:
        "No. Illinois does not allow municipalities to levy local income taxes.",
    },
    {
      question: "How does Illinois flat tax compare to progressive state taxes?",
      answer:
        "Illinois flat 4.95% rate means high earners pay a lower effective state rate compared to progressive-tax states like California or New York.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - Illinois Flat Tax (4.95%) - Social Security (6.2%) - Medicare (1.45%)",
};
