...
export const lipFillerCostCalculator: CalculatorDefinition = {
  slug: "lip-filler-cost-calculator",
  title: "Lip Filler Cost Calculator",
  description: "Free lip filler cost calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["lip filler cost calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
    name: "Lip Filler Cost",
    description: "",
    fields: [
  ...
  faq: [
    { question: "How much does lip filler cost cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
