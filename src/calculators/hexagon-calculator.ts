...
export const hexagonCalculator: CalculatorDefinition = {
  slug: "hexagon-calculator",
  title: "Hexagon Calculator",
  description: "Free hexagon calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["hexagon calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Hexagon",
      description: "Calculate hexagon",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the hexagon calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
