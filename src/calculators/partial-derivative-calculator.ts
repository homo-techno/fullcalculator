...
export const partialDerivativeCalculator: CalculatorDefinition = {
  slug: "partial-derivative-calculator",
  title: "Partial Derivative Calculator",
  description: "Free partial derivative calculator. Solve partial derivative problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["partial derivative calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Partial Derivative",
      description: "Free partial derivative calculator. Solve partial derivative problems with step-",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Partial Derivative?",
      answer: "Partial Derivative is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
