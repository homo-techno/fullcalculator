...
export const psychiatristCostCalculator: CalculatorDefinition = {
  slug: "psychiatrist-cost-calculator",
  title: "Psychiatrist Cost Calculator",
  description: "Free psychiatrist cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["psychiatrist cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Psychiatrist Cost",
  ...
  faq: [
    { question: "How much does psychiatrist cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
