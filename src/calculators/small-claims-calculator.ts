...
export const smallClaimsCalculator: CalculatorDefinition = {
  slug: "small-claims-calculator",
  title: "Small Claims Calculator",
  description: "Free small claims calculator. Check small claims court limits",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["small claims calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Small Claims",
    description: "Check small claims court limits",
    fields: [
