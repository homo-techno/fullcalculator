...
export const matrixMultiplicationCalculator: CalculatorDefinition = {
  slug: "matrix-multiplication-calculator",
  title: "Matrix Multiplication Calculator",
  description: "Free matrix multiplication calculator. Solve matrix multiplication problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["matrix multiplication calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Matrix Multiplication",
      description: "Free matrix multiplication calculator. Solve matrix multiplication problems with",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      ...
      answer: "Matrix Multiplication is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
