...
export const trueAirspeedCalculator: CalculatorDefinition = {
  slug: "true-airspeed-calculator",
  title: "True Airspeed Calculator",
  description: "Free true airspeed calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["true airspeed calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
    name: "True Airspeed",
