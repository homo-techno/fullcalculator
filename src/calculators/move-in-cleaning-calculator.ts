...
export const moveInCleaningCalculator: CalculatorDefinition = {
  slug: "move-in-cleaning-calculator",
  title: "Move In Cleaning Calculator",
  description: "Free move in cleaning calculator. Estimate cleaning time and supply needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["move in cleaning calculator", "cleaning calculator", "organization tool"],
  variants: [{
    id: "standard",
