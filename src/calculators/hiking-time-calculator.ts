...
export const hikingTimeCalculator: CalculatorDefinition = {
  slug: "hiking-time-calculator",
  title: "Hiking Time Calculator",
  description: "Free hiking time calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hiking time calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Hiking Time",
      description: "Calculate hiking time",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the hiking time calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
