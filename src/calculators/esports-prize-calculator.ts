...
export const esportsPrizeCalculator: CalculatorDefinition = {
  slug: "esports-prize-calculator",
  title: "Esports Prize Calculator",
  description: "Free esports prize calculator. Calculate tournament earnings split",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["esports prize calculator", "gaming calculator", "game tool"],
  variants: [{
    id: "standard",
    name: "Esports Prize",
    description: "Calculate tournament earnings split",
    fields: [
