...
export const co2InjectionCalculator: CalculatorDefinition = {
  slug: "co2-injection-calculator",
  title: "Co2 Injection Calculator",
  description: "Free co2 injection calculator. Aquarium planning and maintenance calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["co2 injection calculator", "aquarium calculator", "fishkeeping tool"],
  variants: [{
    id: "standard",
    name: "Co2 Injection",
