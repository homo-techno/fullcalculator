...
export const solarPanelSavingsCalculator: CalculatorDefinition = {
  slug: "solar-panel-savings-calculator",
  title: "Solar Panel Savings Calculator",
  description: "Free solar panel savings calculator. Calculate solar panel savings values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["solar panel savings calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Solar Panel Savings",
      description: "Free solar panel savings calculator. Calculate solar panel savings values for re",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      question: "What is Solar Panel Savings?",
      answer: "Solar Panel Savings is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
