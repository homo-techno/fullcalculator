...
export const groceryBudgetCalculator: CalculatorDefinition = {
  slug: "grocery-budget-calculator",
  title: "Grocery Budget Calculator",
  description: "Free grocery budget calculator. Quickly calculate and plan your grocery budget needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["grocery budget calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Grocery Budget",
      description: "Free grocery budget calculator. Quickly calculate and plan your grocery budget n",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the grocery budget work?",
