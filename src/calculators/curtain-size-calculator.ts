...
export const curtainSizeCalculator: CalculatorDefinition = {
  slug: "curtain-size-calculator",
  title: "Curtain Size Calculator",
  description: "Free curtain size calculator. Convert and calculate curtain size values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["curtain size calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Curtain Size",
      description: "Free curtain size calculator. Convert and calculate curtain size values instantl",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does curtain size conversion work?",
