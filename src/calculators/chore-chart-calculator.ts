...
export const choreChartCalculator: CalculatorDefinition = {
  slug: "chore-chart-calculator",
  title: "Chore Chart Calculator",
  description: "Free chore chart calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["chore chart calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Chore Chart",
      description: "Calculate chore chart",
      fields: [
        {
          name: "size",
          label: "Size / Weight",
  ...
  faq: [
    { question: "How does the chore chart calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
