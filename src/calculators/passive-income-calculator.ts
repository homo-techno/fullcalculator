...
export const passiveIncomeCalculator: CalculatorDefinition = {
  slug: "passive-income-calculator",
  title: "Passive Income Calculator",
  description: "Free passive income calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["passive income calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Passive Income",
      description: "Free passive income calculator. Plan your finances with accurate calculations an",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Passive Income Calculator calculate?",
      answer: "This calculator helps you estimate passive income based on your specific financial situation and inputs.",
    },
    {
