...
export const fishStockingCalculator: CalculatorDefinition = {
  slug: "fish-stocking-calculator",
  title: "Fish Stocking Calculator",
  description: "Free fish stocking calculator. Aquarium planning and maintenance calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["fish stocking calculator", "aquarium calculator", "fishkeeping tool"],
  variants: [{
    id: "standard",
    name: "Fish Stocking",
