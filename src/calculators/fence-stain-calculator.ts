...
export const fenceStainCalculator: CalculatorDefinition = {
  slug: "fence-stain-calculator",
  title: "Fence Stain Calculator",
  description: "Free fence stain calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["fence stain calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate fence stain costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does fence stain cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
