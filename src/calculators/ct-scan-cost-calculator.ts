...
export const ctScanCostCalculator: CalculatorDefinition = {
  slug: "ct-scan-cost-calculator",
  title: "Ct Scan Cost Calculator",
  description: "Free ct scan cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["ct scan cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Ct Scan Cost",
  ...
  faq: [
    { question: "How much does ct scan cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
