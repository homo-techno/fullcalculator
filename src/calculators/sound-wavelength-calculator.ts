...
export const soundWavelengthCalculator: CalculatorDefinition = {
  slug: "sound-wavelength-calculator",
  title: "Sound Wavelength Calculator",
  description: "Free sound wavelength calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["sound wavelength calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Sound Wavelength",
      description: "Calculate sound wavelength",
      fields: [
        {
          name: "input1",
          label: "Primary Input",
  ...
  faq: [
    { question: "How does the sound wavelength calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
