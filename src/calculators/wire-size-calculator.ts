...
export const wireSizeCalculator: CalculatorDefinition = {
  slug: "wire-size-calculator",
  title: "Wire Size Calculator",
  description: "Free wire size calculator. Electrical sizing and planning tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["wire size calculator", "electrical calculator", "sizing tool"],
  variants: [{
    id: "standard",
    name: "Wire Size",
    description: "",
