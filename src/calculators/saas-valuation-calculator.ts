...
export const saasValuationCalculator: CalculatorDefinition = {
  slug: "saas-valuation-calculator",
  title: "Saas Valuation Calculator",
  description: "Free saas valuation calculator. Quickly calculate and plan your saas valuation needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["saas valuation calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Saas Valuation",
      description: "Free saas valuation calculator. Quickly calculate and plan your saas valuation n",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the saas valuation work?",
