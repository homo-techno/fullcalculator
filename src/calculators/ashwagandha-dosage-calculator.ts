...
export const ashwagandhaDosageCalculator: CalculatorDefinition = {
  slug: "ashwagandha-dosage-calculator",
  title: "Ashwagandha Dosage Calculator",
  description: "Free ashwagandha dosage calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["ashwagandha dosage calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Ashwagandha Dosage",
      description: "Calculate ashwagandha dosage",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the ashwagandha dosage calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
