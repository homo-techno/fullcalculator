...
export const hardwoodCostCalculator: CalculatorDefinition = {
  slug: "hardwood-cost-calculator",
  title: "Hardwood Cost Calculator",
  description: "Free hardwood cost calculator. Woodworking planning and estimation tool.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hardwood cost calculator", "woodworking calculator", "carpentry tool"],
  variants: [{
    id: "standard",
    name: "Hardwood Cost",
