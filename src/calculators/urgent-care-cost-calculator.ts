...
export const urgentCareCostCalculator: CalculatorDefinition = {
  slug: "urgent-care-cost-calculator",
  title: "Urgent Care Cost Calculator",
  description: "Free urgent care cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["urgent care cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Urgent Care Cost",
  ...
  faq: [
    { question: "How much does urgent care cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
