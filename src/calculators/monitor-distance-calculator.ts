...
export const monitorDistanceCalculator: CalculatorDefinition = {
  slug: "monitor-distance-calculator",
  title: "Monitor Distance Calculator",
  description: "Free monitor distance calculator. Convert and calculate monitor distance values instantly.",
  category: "Conversion",
  categorySlug: "conversion",
  icon: "R",
  keywords: ["monitor distance calculator", "converter", "conversion calculator"],
  variants: [
    {
      id: "standard",
      name: "Monitor Distance",
      description: "Free monitor distance calculator. Convert and calculate monitor distance values ",
      fields: [
        {
          name: "inputValue",
          label: "Input Value",
  ...
  faq: [
    {
      question: "How does monitor distance conversion work?",
