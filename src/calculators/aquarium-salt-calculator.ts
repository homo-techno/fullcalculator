...
export const aquariumSaltCalculator: CalculatorDefinition = {
  slug: "aquarium-salt-calculator",
  title: "Aquarium Salt Calculator",
  description: "Free aquarium salt calculator. Aquarium planning and maintenance calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["aquarium salt calculator", "aquarium calculator", "fishkeeping tool"],
  variants: [{
    id: "standard",
    name: "Aquarium Salt",
