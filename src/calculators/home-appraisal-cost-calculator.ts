...
export const homeAppraisalCostCalculator: CalculatorDefinition = {
  slug: "home-appraisal-cost-calculator",
  title: "Home Appraisal Cost Calculator",
  description: "Free home appraisal cost calculator. Quickly calculate and plan your home appraisal cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["home appraisal cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Home Appraisal Cost",
      description: "Free home appraisal cost calculator. Quickly calculate and plan your home apprai",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the home appraisal cost work?",
