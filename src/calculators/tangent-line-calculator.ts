...
export const tangentLineCalculator: CalculatorDefinition = {
  slug: "tangent-line-calculator",
  title: "Tangent Line Calculator",
  description: "Free tangent line calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["tangent line calculator", "geometry calculator", "area calculator", "math tool"],
  variants: [
    {
      id: "standard",
      name: "Tangent Line",
      description: "Calculate tangent line",
      fields: [
        {
          name: "side",
  ...
  faq: [
    { question: "How does the tangent line calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
