...
export const refeedDayCalculator: CalculatorDefinition = {
  slug: "refeed-day-calculator",
  title: "Refeed Day Calculator",
  description: "Free refeed day calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["refeed day calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Refeed Day",
      description: "Calculate refeed day",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the refeed day calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
