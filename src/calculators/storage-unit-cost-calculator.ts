...
export const storageUnitCostCalculator: CalculatorDefinition = {
  slug: "storage-unit-cost-calculator",
  title: "Storage Unit Cost Calculator",
  description: "Free storage unit cost calculator. Quickly calculate and plan your storage unit cost needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["storage unit cost calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Storage Unit Cost",
      description: "Free storage unit cost calculator. Quickly calculate and plan your storage unit ",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the storage unit cost work?",
