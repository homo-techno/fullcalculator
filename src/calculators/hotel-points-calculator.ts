...
export const hotelPointsCalculator: CalculatorDefinition = {
  slug: "hotel-points-calculator",
  title: "Hotel Points Calculator",
  description: "Free hotel points calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["hotel points calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Hotel Points",
      description: "Calculate hotel points",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    { question: "How does the hotel points calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
