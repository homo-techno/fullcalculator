...
export const vectorDotProductCalculator: CalculatorDefinition = {
  slug: "vector-dot-product-calculator",
  title: "Vector Dot Product Calculator",
  description: "Free vector dot product calculator. Solve vector dot product problems with step-by-step calculations.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["vector dot product calculator", "math calculator", "algebra calculator", "math solver"],
  variants: [
    {
      id: "standard",
      name: "Vector Dot Product",
      description: "Free vector dot product calculator. Solve vector dot product problems with step-",
      fields: [
        {
          name: "a",
          label: "Value A",
  ...
  faq: [
    {
      question: "What is Vector Dot Product?",
      answer: "Vector Dot Product is a mathematical concept used in algebra, calculus, or statistics. This calculator helps you compute results quickly.",
    },
    {
