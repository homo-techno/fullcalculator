...
export const gapInsuranceCalculator: CalculatorDefinition = {
  slug: "gap-insurance-calculator",
  title: "Gap Insurance Calculator",
  description: "Free gap insurance calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["gap insurance calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Gap Insurance",
      description: "Free gap insurance calculator. Plan your finances with accurate calculations and",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Gap Insurance Calculator calculate?",
      answer: "This calculator helps you estimate gap insurance based on your specific financial situation and inputs.",
    },
    {
