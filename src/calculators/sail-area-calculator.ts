...
export const sailAreaCalculator: CalculatorDefinition = {
  slug: "sail-area-calculator",
  title: "Sail Area Calculator",
  description: "Free sail area calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["sail area calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Sail Area",
    description: "",
