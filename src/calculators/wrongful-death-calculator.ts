...
export const wrongfulDeathCalculator: CalculatorDefinition = {
  slug: "wrongful-death-calculator",
  title: "Wrongful Death Calculator",
  description: "Free wrongful death calculator. Estimate wrongful death claim value",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["wrongful death calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Wrongful Death",
    description: "Estimate wrongful death claim value",
    fields: [
