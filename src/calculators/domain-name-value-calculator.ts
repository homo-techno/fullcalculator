...
export const domainNameValueCalculator: CalculatorDefinition = {
  slug: "domain-name-value-calculator",
  title: "Domain Name Value Calculator",
  description: "Free domain name value calculator. Quickly calculate and plan your domain name value needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["domain name value calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Domain Name Value",
      description: "Free domain name value calculator. Quickly calculate and plan your domain name v",
      fields: [
        {
          name: "value1",
          label: "Primary Value",
  ...
  faq: [
    {
      question: "How does the domain name value work?",
