...
export const bloodTestCostCalculator: CalculatorDefinition = {
  slug: "blood-test-cost-calculator",
  title: "Blood Test Cost Calculator",
  description: "Free blood test cost calculator. Estimate medical and healthcare costs.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["blood test cost calculator", "medical cost", "healthcare calculator"],
  variants: [{
    id: "standard",
    name: "Blood Test Cost",
  ...
  faq: [
    { question: "How much does blood test cost?", answer: "Costs vary significantly by location, provider, and insurance. This provides average estimates for planning." },
