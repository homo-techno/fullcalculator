...
export const dutyFreeSavingsCalculator: CalculatorDefinition = {
  slug: "duty-free-savings-calculator",
  title: "Duty Free Savings Calculator",
  description: "Free duty free savings calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["duty free savings calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Duty Free Savings",
      description: "Calculate duty free savings",
      fields: [
        {
          name: "distance",
  ...
  faq: [
    { question: "How does the duty free savings calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
