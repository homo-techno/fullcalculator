...
export const palindromeNumberCalculator: CalculatorDefinition = {
  slug: "palindrome-number-calculator",
  title: "Palindrome Number Calculator",
  description: "Free palindrome number calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["palindrome number calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Palindrome Number",
      description: "Calculate palindrome number",
      fields: [
        {
          name: "number",
          label: "Number",
  ...
  faq: [
    { question: "How does the palindrome number calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
