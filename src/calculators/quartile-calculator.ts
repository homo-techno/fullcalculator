...
export const quartileCalculator: CalculatorDefinition = {
  ...
  description: "Free quartile calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["quartile calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Quartile",
      description: "Calculate quartile",
      fields: [
        {
          name: "mean",
          label: "Mean",
  ...
  faq: [
    { question: "How does the quartile calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
