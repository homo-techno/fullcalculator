...
export const elasticCalculator: CalculatorDefinition = {
  slug: "elastic-calculator",
  title: "Elastic Calculator",
  description: "Free elastic calculator. Sewing and crafting material calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["elastic calculator", "sewing calculator", "craft tool"],
  variants: [{
    id: "standard",
    name: "Elastic",
