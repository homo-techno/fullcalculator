...
export const certificationRoiCalculator: CalculatorDefinition = {
  slug: "certification-roi-calculator",
  title: "Certification Roi Calculator",
  description: "Free certification roi calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["certification roi calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
  ...
  faq: [
    { question: "How does the certification roi calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
