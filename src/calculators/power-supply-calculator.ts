...
export const powerSupplyCalculator: CalculatorDefinition = {
  slug: "power-supply-calculator",
  title: "Power Supply Calculator",
  description: "Free power supply calculator. Get instant results with our easy-to-use calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["power supply calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Power Supply",
      description: "Calculate power supply",
      fields: [
        {
          name: "value",
          label: "Primary Value",
  ...
  faq: [
    { question: "How does the power supply calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
