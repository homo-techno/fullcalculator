...
export const foundationShadeCalculator: CalculatorDefinition = {
  slug: "foundation-shade-calculator",
  title: "Foundation Shade Calculator",
  description: "Free foundation shade calculator. Get personalized beauty and cosmetics estimates.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["foundation shade calculator", "beauty calculator", "cosmetics tool"],
  variants: [{
    id: "standard",
  ...
  faq: [
    { question: "How much does foundation shade cost?", answer: "Costs vary widely based on location, provider, and quality. Use our calculator for a personalized estimate." },
