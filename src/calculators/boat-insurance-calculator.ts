...
export const boatInsuranceCalculator: CalculatorDefinition = {
  slug: "boat-insurance-calculator",
  title: "Boat Insurance Calculator",
  description: "Free boat insurance calculator. Boating and marine planning calculator.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["boat insurance calculator", "boating calculator", "marine tool"],
  variants: [{
    id: "standard",
    name: "Boat Insurance",
    description: "",
