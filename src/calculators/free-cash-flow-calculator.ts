...
export const freeCashFlowCalculator: CalculatorDefinition = {
  slug: "free-cash-flow-calculator",
  title: "Free Cash Flow Calculator",
  description: "Free free cash flow calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["free cash flow calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Free Cash Flow",
  ...
  faq: [
    { question: "How does the free cash flow calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
