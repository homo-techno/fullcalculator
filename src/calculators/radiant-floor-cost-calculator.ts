...
export const radiantFloorCostCalculator: CalculatorDefinition = {
  slug: "radiant-floor-cost-calculator",
  title: "Radiant Floor Cost Calculator",
  description: "Free radiant floor cost calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["radiant floor cost calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate radiant floor cost costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does radiant floor cost cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
