...
export const alcoholSpendingCalculator: CalculatorDefinition = {
  slug: "alcohol-spending-calculator",
  title: "Alcohol Spending Calculator",
  description: "Free alcohol spending calculator. Quickly calculate and plan your alcohol spending needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["alcohol spending calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Alcohol Spending",
      description: "Free alcohol spending calculator. Quickly calculate and plan your alcohol spendi",
      fields: [
        {
          name: "unitCost",
          label: "Unit Cost",
  ...
  faq: [
    {
      question: "How does the alcohol spending work?",
