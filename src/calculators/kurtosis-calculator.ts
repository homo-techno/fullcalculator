...
export const kurtosisCalculator: CalculatorDefinition = {
  slug: "kurtosis-calculator",
  title: "Kurtosis Calculator",
  description: "Free kurtosis calculator. Get instant results with our easy-to-use calculator.",
  category: "Math",
  categorySlug: "math",
  icon: "+",
  keywords: ["kurtosis calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Kurtosis",
  ...
  faq: [
    { question: "How does the kurtosis calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
