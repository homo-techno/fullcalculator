...
export const grainBinCalculator: CalculatorDefinition = {
  slug: "grain-bin-calculator",
  title: "Grain Bin Calculator",
  description: "Free grain bin calculator. Calculate grain storage capacity",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["grain bin calculator", "farming calculator", "agriculture tool"],
  variants: [{
    id: "standard",
    name: "Grain Bin",
    description: "Calculate grain storage capacity",
    fields: [
