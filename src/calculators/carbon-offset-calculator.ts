...
export const carbonOffsetCalculator: CalculatorDefinition = {
  slug: "carbon-offset-calculator",
  title: "Carbon Offset Calculator",
  description: "Free carbon offset calculator. Calculate carbon offset values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["carbon offset calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Carbon Offset",
      description: "Free carbon offset calculator. Calculate carbon offset values for research and e",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      ...
      answer: "Carbon Offset is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
