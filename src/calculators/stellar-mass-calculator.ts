...
export const stellarMassCalculator: CalculatorDefinition = {
  slug: "stellar-mass-calculator",
  title: "Stellar Mass Calculator",
  description: "Free stellar mass calculator. Get instant results with our easy-to-use calculator.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["stellar mass calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Stellar Mass",
      description: "Calculate stellar mass",
      fields: [
        {
          name: "mass",
  ...
  faq: [
    { question: "How does the stellar mass calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
