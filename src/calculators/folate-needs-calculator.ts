...
export const folateNeedsCalculator: CalculatorDefinition = {
  slug: "folate-needs-calculator",
  title: "Folate Needs Calculator",
  description: "Free folate needs calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["folate needs calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Folate Needs",
      description: "Calculate folate needs",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the folate needs calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
