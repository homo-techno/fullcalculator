...
export const rentalRoiCalculator: CalculatorDefinition = {
  slug: "rental-roi-calculator",
  title: "Rental ROI Calculator",
  description: "Free rental roi calculator. Plan your finances with accurate calculations and projections.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["rental roi calculator", "financial calculator", "money calculator", "finance tool"],
  variants: [
    {
      id: "standard",
      name: "Rental ROI",
      description: "Free rental roi calculator. Plan your finances with accurate calculations and pr",
      fields: [
        {
          name: "amount",
          label: "Amount",
  ...
  faq: [
    {
      question: "What does the Rental ROI Calculator calculate?",
      answer: "This calculator helps you estimate rental roi based on your specific financial situation and inputs.",
    },
    {
