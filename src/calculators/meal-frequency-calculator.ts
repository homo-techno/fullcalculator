...
export const mealFrequencyCalculator: CalculatorDefinition = {
  slug: "meal-frequency-calculator",
  title: "Meal Frequency Calculator",
  description: "Free meal frequency calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["meal frequency calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Meal Frequency",
      description: "Calculate meal frequency",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the meal frequency calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
