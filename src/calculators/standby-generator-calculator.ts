...
export const standbyGeneratorCalculator: CalculatorDefinition = {
  slug: "standby-generator-calculator",
  title: "Standby Generator Calculator",
  description: "Free standby generator calculator. Estimate costs and plan your budget.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["standby generator calculator", "cost calculator", "budget planner"],
  variants: [
    {
      id: "estimate",
      name: "Cost Estimate",
      description: "Estimate standby generator costs",
      fields: [
        {
          name: "area",
          label: "Area / Size",
  ...
  faq: [
    { question: "How much does standby generator cost?", answer: "Costs vary by location, quality, and requirements. Use our calculator for a personalized estimate." },
