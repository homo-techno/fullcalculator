...
export const turmericDosageCalculator: CalculatorDefinition = {
  slug: "turmeric-dosage-calculator",
  title: "Turmeric Dosage Calculator",
  description: "Free turmeric dosage calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["turmeric dosage calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Turmeric Dosage",
      description: "Calculate turmeric dosage",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the turmeric dosage calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
