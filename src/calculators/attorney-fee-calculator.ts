...
export const attorneyFeeCalculator: CalculatorDefinition = {
  slug: "attorney-fee-calculator",
  title: "Attorney Fee Calculator",
  description: "Free attorney fee calculator. Estimate legal representation costs",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["attorney fee calculator", "legal calculator", "law calculator"],
  variants: [{
    id: "standard",
    name: "Attorney Fee",
    description: "Estimate legal representation costs",
    fields: [
