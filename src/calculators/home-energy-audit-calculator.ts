...
export const homeEnergyAuditCalculator: CalculatorDefinition = {
  slug: "home-energy-audit-calculator",
  title: "Home Energy Audit Calculator",
  description: "Free home energy audit calculator. Calculate home energy audit values for research and education.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["home energy audit calculator", "science calculator", "physics calculator", "chemistry calculator"],
  variants: [
    {
      id: "standard",
      name: "Home Energy Audit",
      description: "Free home energy audit calculator. Calculate home energy audit values for resear",
      fields: [
        {
          name: "input1",
          label: "Input Value 1",
  ...
  faq: [
    {
      ...
      answer: "Home Energy Audit is a scientific concept. This calculator helps you compute related values for research, homework, or professional use.",
    },
    {
