...
export const windCorrectionAngleCalculator: CalculatorDefinition = {
  slug: "wind-correction-angle-calculator",
  title: "Wind Correction Angle Calculator",
  description: "Free wind correction angle calculator. Aviation planning and flight calculation tool.",
  category: "Science",
  categorySlug: "science",
  icon: "A",
  keywords: ["wind correction angle calculator", "aviation calculator", "pilot tool", "flight calculator"],
  variants: [{
    id: "standard",
