...
export const magnesiumNeedsCalculator: CalculatorDefinition = {
  slug: "magnesium-needs-calculator",
  title: "Magnesium Needs Calculator",
  description: "Free magnesium needs calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["magnesium needs calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Magnesium Needs",
      description: "Free magnesium needs calculator. Get personalized health insights based on your ",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    {
      question: "How does the magnesium needs work?",
