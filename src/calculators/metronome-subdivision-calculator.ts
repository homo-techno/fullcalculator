...
export const metronomeSubdivisionCalculator: CalculatorDefinition = {
  slug: "metronome-subdivision-calculator",
  title: "Metronome Subdivision Calculator",
  description: "Free metronome subdivision calculator. Calculate beat subdivisions",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["metronome subdivision calculator", "music calculator", "audio tool"],
  variants: [{
    id: "standard",
    name: "Metronome Subdivision",
    description: "Calculate beat subdivisions",
    fields: [
