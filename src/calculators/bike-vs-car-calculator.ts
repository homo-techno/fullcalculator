...
export const bikeVsCarCalculator: CalculatorDefinition = {
  slug: "bike-vs-car-calculator",
  title: "Bike Vs Car Calculator",
  description: "Free bike vs car calculator. Quickly calculate and plan your bike vs car needs.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["bike vs car calculator", "calculator", "planning tool"],
  variants: [
    {
      id: "standard",
      name: "Bike Vs Car",
  ...
  faq: [
    {
      question: "How does the bike vs car work?",
