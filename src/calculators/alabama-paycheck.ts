...
export const alabamaPaycheckCalculator: CalculatorDefinition = {
  slug: "alabama-paycheck-calculator",
  title: "Alabama Paycheck Calculator",
  description:
    "Free Alabama paycheck calculator. Estimate your take-home pay after federal taxes, Alabama state income tax, and FICA deductions for 2024.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["alabama paycheck calculator", "alabama take home pay", "AL paycheck calculator", "alabama state tax", "alabama salary calculator", "alabama income tax calculator"],
  variants: [
    {
      id: "alabama-paycheck",
      name: "Alabama Paycheck Calculator",
      description: "Calculate your Alabama take-home pay after federal, state, and FICA taxes.",
      fields: [
      ...
      calculate: (inputs) => {
        ...
        return {
          ...
          details: [
            ...
            { label: "Alabama State Tax", value: `-$${formatNumber(stateTax, 2)}` },
  ...
  relatedSlugs: ["georgia-paycheck-calculator", "tennessee-paycheck-calculator", "louisiana-paycheck-calculator"],
  faq: [
    {
      question: "What is the Alabama state income tax rate?",
      answer:
        "Alabama has three brackets: 2% on the first 00 (,000 married), 4% on the next ,500 (,000 married), and 5% on income above ,000 (,000 married).",
    },
    {
      question: "Does Alabama have local income taxes?",
      answer:
        "Yes. Many Alabama cities and counties levy occupational taxes. Birmingham charges a 1% occupational tax.",
    },
    {
      question: "Does Alabama allow a federal tax deduction?",
      answer:
        "Yes. Alabama is one of a few states allowing taxpayers to deduct federal income tax paid from state taxable income, effectively lowering the state tax burden.",
    },
  ],
  formula:
    "Net Pay = Gross Pay - Federal Tax - Alabama State Tax - Social Security (6.2%) - Medicare (1.45%)",
};
