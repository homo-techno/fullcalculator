...
export const tattooSizeCalculator: CalculatorDefinition = {
  slug: "tattoo-size-calculator",
  title: "Tattoo Size Calculator",
  description: "Free tattoo size calculator. Plan your tattoo dimensions.",
  category: "Everyday",
  categorySlug: "everyday",
  icon: "~",
  keywords: ["tattoo size calculator", "tattoo calculator", "tattoo cost"],
  variants: [{
    id: "standard",
    name: "Tattoo Size",
    description: "Plan your tattoo dimensions",
    fields: [
