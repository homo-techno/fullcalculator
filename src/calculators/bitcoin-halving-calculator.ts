...
export const bitcoinHalvingCalculator: CalculatorDefinition = {
  slug: "bitcoin-halving-calculator",
  title: "Bitcoin Halving Calculator",
  description: "Free bitcoin halving calculator. Get instant results with our easy-to-use calculator.",
  category: "Finance",
  categorySlug: "finance",
  icon: "$",
  keywords: ["bitcoin halving calculator", "calculator", "online tool"],
  variants: [
    {
      id: "standard",
      name: "Bitcoin Halving",
      description: "Calculate bitcoin halving",
      fields: [
        {
          name: "amount",
          label: "Token Amount",
  ...
  faq: [
    { question: "How does the bitcoin halving calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
