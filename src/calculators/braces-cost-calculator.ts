...
export const bracesCostCalculator: CalculatorDefinition = {
  slug: "braces-cost-calculator",
  title: "Braces Cost Calculator",
  description: "Free braces cost calculator. Get personalized health insights based on your profile.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["braces cost calculator", "health calculator", "medical calculator"],
  variants: [
    {
      id: "standard",
      name: "Braces Cost",
      description: "Free braces cost calculator. Get personalized health insights based on your prof",
      fields: [
        {
          name: "baseCost",
          label: "Base Cost",
  ...
  faq: [
    {
      question: "How does the braces cost work?",
