...
export const vitaminB12Calculator: CalculatorDefinition = {
  slug: "vitamin-b12-calculator",
  title: "Vitamin B12 Calculator",
  description: "Free vitamin b12 calculator. Get instant results with our easy-to-use calculator.",
  category: "Health",
  categorySlug: "health",
  icon: "H",
  keywords: ["vitamin b12 calculator", "nutrition calculator", "health tool"],
  variants: [
    {
      id: "standard",
      name: "Vitamin B12",
      description: "Calculate vitamin b12",
      fields: [
        {
          name: "weight",
          label: "Body Weight",
  ...
  faq: [
    { question: "How does the vitamin b12 calculator work?", answer: "Enter your values and the calculator instantly computes the result using standard formulas." },
